...
public class Modeldragonite<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dragonite"), "main");
	private final ModelPart body;
	private final ModelPart head;
	private final ModelPart wings;
	private final ModelPart wing1right;
	private final ModelPart wing2right;
	private final ModelPart wing1left;
	private final ModelPart wing2left;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(24, 2)
				.addBox(-7.5F, -8.25F, -11.0F, 15.0F, 11.0F, 30.0F, new CubeDeformation(0.5F)).texOffs(52, 29)
		...
		PartDefinition underspike_6_r1 = body.addOrReplaceChild("underspike_6_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.5F, 0.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.5F)),
		...
		PartDefinition underspike_1_r1 = body.addOrReplaceChild("underspike_1_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, 0.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.5F)),
		...
		PartDefinition tailtop = body.addOrReplaceChild("tailtop",
				CubeListBuilder.create().texOffs(84, 0)
						.addBox(-6.5F, -5.0F, -1.0F, 13.0F, 9.0F, 14.0F, new CubeDeformation(0.5F)).texOffs(50, 43)
						.addBox(-7.0F, -4.0F, -0.99F, 14.0F, 7.0F, 14.0F, new CubeDeformation(0.5F)),
		...
		PartDefinition tailmid = tailtop.addOrReplaceChild("tailmid",
				CubeListBuilder.create().texOffs(138, 0)
						.addBox(-5.5F, -4.5F, -1.0F, 11.0F, 8.0F, 14.0F, new CubeDeformation(0.5F)).texOffs(138, 0)
						.addBox(-6.0F, -4.0F, -0.99F, 12.0F, 7.0F, 14.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 0.0F, 13.0F));

		PartDefinition backspike_14_r1 = tailmid.addOrReplaceChild("backspike_14_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.75F, -2.75F, -2.5F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.5F)),
		...
		PartDefinition backspike_13_r1 = tailmid.addOrReplaceChild("backspike_13_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.25F, -2.75F, -2.5F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(7.75F, -4.25F, 7.0F, -1.6144F, 0.48F, -0.6981F));
		...
		PartDefinition tailend = tailmid.addOrReplaceChild("tailend",
				CubeListBuilder.create().texOffs(116, 23)
						.addBox(-4.5F, -3.5F, -1.0F, 9.0F, 6.0F, 9.0F, new CubeDeformation(0.5F)).texOffs(116, 23)
						.addBox(-5.0F, -3.0F, -0.99F, 10.0F, 5.0F, 9.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 0.0F, 13.0F));
		...
		PartDefinition tailbit = tailend.addOrReplaceChild("tailbit", CubeListBuilder.create().texOffs(119, 24).addBox(
				-4.0F, -2.5F, -7.0F, 8.0F, 5.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, -0.5F, 15.0F));

		PartDefinition backspike_20_r1 = tailbit.addOrReplaceChild("backspike_20_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(0.0F, -4.5F, -1.5F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.5F)),
		...
		PartDefinition backspike_19_r2 = tailbit.addOrReplaceChild("backspike_19_r2",
				CubeListBuilder.create().texOffs(0, 7).addBox(-3.0F, -4.5F, -1.5F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.5F)),
		...
		PartDefinition wing1left = wings.addOrReplaceChild("wing1left", CubeListBuilder.create(),
				PartPose.offset(8.0F, 0.0F, 2.0F));

		PartDefinition wing12lleft_r1 = wing1left.addOrReplaceChild("wing12lleft_r1",
				CubeListBuilder.create().texOffs(156, 239).addBox(15.0F, -3.0F, 0.0F, 42.0F, -6.0F, 8.0F,
		...
		PartDefinition wing11lleft_r1 = wing1left.addOrReplaceChild("wing11lleft_r1",
				CubeListBuilder.create().texOffs(156, 218).addBox(0.0F, 0.0F, -3.0F, 40.0F, 0.0F, 8.0F,
		...
		PartDefinition wing2left = wings.addOrReplaceChild("wing2left",
				CubeListBuilder.create().texOffs(156, 227)
						.addBox(-1.0F, 0.0F, 0.0F, 40.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 248)
		...
		PartDefinition wing1right = wings.addOrReplaceChild("wing1right", CubeListBuilder.create(),
				PartPose.offset(-8.0F, 0.0F, 2.0F));

		PartDefinition wiing12right_r1 = wing1right.addOrReplaceChild("wiing12right_r1",
				CubeListBuilder.create().texOffs(0, 239).addBox(-71.0F, -2.0F, 0.0F, 42.0F, -6.0F, 8.0F,
						new CubeDeformation(3.0F)),
				PartPose.offsetAndRotation(15.0F, -2.0F, 1.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition wiing11right_r1 = wing1right.addOrReplaceChild(
				"wiing11right_r1", CubeListBuilder.create().texOffs(0, 227).addBox(-54.0F, 1.0F, -3.0F, 40.0F, 0.0F,
		...
		PartDefinition wing2right = wings.addOrReplaceChild("wing2right",
				CubeListBuilder.create().texOffs(0, 217)
						.addBox(-39.0F, 0.0F, -10.0F, 40.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(156, 248)
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(207, 0)
						.addBox(-6.5F, -1.0F, -9.5F, 13.0F, 5.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(207, 38)
		...
		PartDefinition hornleft_r1 = head.addOrReplaceChild("hornleft_r1",
				CubeListBuilder.create().texOffs(224, 92).addBox(-1.5F, -9.0F, -1.0F, 5.0F, 12.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -7.0F, -15.0F, -1.4835F, -0.3491F, 2.0508F));

		PartDefinition hornright_r1 = head.addOrReplaceChild("hornright_r1",
				CubeListBuilder.create().texOffs(224, 91).mirror()
						.addBox(-3.5F, -10.0F, -1.0F, 5.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-5.0F, -7.0F, -15.0F, -1.4835F, 0.3491F, -2.0508F));

		PartDefinition rim_4_r1 = head.addOrReplaceChild("rim_4_r1",
				CubeListBuilder.create().texOffs(212, 60).mirror()
		...
		PartDefinition rim_3_r1 = head.addOrReplaceChild("rim_3_r1",
				CubeListBuilder.create().texOffs(212, 60).addBox(-2.5F, -2.0F, -6.0F, 3.0F, 3.0F, 18.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -5.0F, -7.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition rim_2_r1 = head.addOrReplaceChild("rim_2_r1",
				CubeListBuilder.create().texOffs(212, 60).mirror()
		...
		PartDefinition rim_1_r1 = head.addOrReplaceChild("rim_1_r1",
				CubeListBuilder.create().texOffs(212, 60).addBox(-2.5F, -2.0F, -8.0F, 3.0F, 3.0F, 18.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -3.0F, -7.0F, 0.0F, -0.1309F, -0.5236F));

		PartDefinition headtop_r1 = head.addOrReplaceChild("headtop_r1",
				CubeListBuilder.create().texOffs(200, 36).addBox(-5.0F, -3.5F, -14.9F, 10.0F, 3.0F, 18.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition mouth2_r1 = head.addOrReplaceChild("mouth2_r1",
				CubeListBuilder.create().texOffs(228, 29).addBox(-5.99F, -1.15F, -0.75F, 12.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.5F, -15.25F, 0.2618F, 0.0F, -3.1416F));

		PartDefinition mouth_r1 = head
				.addOrReplaceChild("mouth_r1",
						CubeListBuilder.create().texOffs(138, 58).addBox(-6.0F, -2.5F, -14.75F, 12.0F, 4.0F, 18.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0436F, 0.0F, 0.0F));

		PartDefinition chin_r1 = head
				.addOrReplaceChild("chin_r1",
						CubeListBuilder.create().texOffs(220, 17).addBox(-5.0F, 0.5F, -14.5F, 10.0F, 4.0F, 8.0F,
								new CubeDeformation(0.0F)),
