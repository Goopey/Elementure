...
public class Forgottenwatcher1Entity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public Forgottenwatcher1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.FORGOTTENWATCHER_1.get(), world);
	}

	public Forgottenwatcher1Entity(EntityType<Forgottenwatcher1Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
