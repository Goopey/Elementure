...
import net.mcreator.elementure.procedures.StarryvillagerguardianTradeProcedure;
import net.mcreator.elementure.procedures.StarryvillagergathererParticlesProcedure;
import net.mcreator.elementure.init.ElementureModItems;
import net.mcreator.elementure.init.ElementureModEntities;

public class StarryvillagerguardianEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public StarryvillagerguardianEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.STARRYVILLAGERGUARDIAN.get(), world);
	}

	public StarryvillagerguardianEntity(EntityType<StarryvillagerguardianEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ElementureModItems.NETHERSTARGUARDIANHAMMER.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		StarryvillagerguardianTradeProcedure.execute(world, entity, itemstack);
		return retval;
	}
