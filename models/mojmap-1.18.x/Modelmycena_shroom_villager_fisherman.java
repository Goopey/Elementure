...
public class Modelmycena_shroom_villager_fisherman<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_shroom_villager_fisherman"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 48)
						.addBox(-1.3F, -12.455F, -1.0F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(6, 0)
						...
						.addBox(-0.05F, -8.455F, -1.01F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 0)
						.addBox(-5.3F, -12.955F, 0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.3F, 12.455F, 0.0F));

		PartDefinition rod_mid_r1 = Body.addOrReplaceChild("rod_mid_r1",
				CubeListBuilder.create().texOffs(50, 0).addBox(2.3F, 1.0F, -1.5F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3F, -5.955F, 2.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition rod_r1 = Body.addOrReplaceChild("rod_r1",
				CubeListBuilder.create().texOffs(58, 0).addBox(-1.0F, -7.5F, -1.0F, 2.0F, 15.0F, 1.0F,
						new CubeDeformation(0.0F)),
