...
import net.mcreator.elementure.procedures.MycenatrufflingFeedProcedure;
import net.mcreator.elementure.procedures.MycenamobsSpawnconditionProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class MycenatrufflingEntity extends PathfinderMob implements IAnimatable {
	...
	public MycenatrufflingEntity(EntityType<MycenatrufflingEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MycenatrufflingFeedProcedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.MYCENATRUFFLING.get(), SpawnPlacements.Type.ON_GROUND,
