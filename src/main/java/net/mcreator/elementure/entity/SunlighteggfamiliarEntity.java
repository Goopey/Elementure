...
public class SunlighteggfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public SunlighteggfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.SUNLIGHTEGGFAMILIAR.get(), world);
	}

	public SunlighteggfamiliarEntity(EntityType<SunlighteggfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SunlighteggfamiliarEntity retval = ElementureModEntities.SUNLIGHTEGGFAMILIAR.get().create(serverWorld);
