...
import net.mcreator.elementure.procedures.SkyjadearmorFullarmorBonusProcedure;
...
public abstract class SkyjadearmorItem extends ArmorItem {
	...
	public static class Helmet extends SkyjadearmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("Full armor effect : makes you fall slowly and makes regular clouds jump pads"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/skyjade__layer_1.png";
		}
	}
	...
	public static class Chestplate extends SkyjadearmorItem {
		...
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			SkyjadearmorFullarmorBonusProcedure.execute(world, entity);
		}
	}
	...
	public static class Leggings extends SkyjadearmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/skyjade__layer_2.png";
		}
	}
