...
public class GhostwarriorEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public GhostwarriorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.GHOSTWARRIOR.get(), world);
	}

	public GhostwarriorEntity(EntityType<GhostwarriorEntity> type, Level world) {
		super(type, world);
		xpReward = 8;
		setNoAi(false);
	}
