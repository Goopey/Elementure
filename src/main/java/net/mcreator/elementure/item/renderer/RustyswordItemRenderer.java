...
import net.mcreator.elementure.item.model.RustyswordItemModel;
...
public class RustyswordItemRenderer extends GeoItemRenderer<RustyswordItem> implements RendersPlayerArms {
	public RustyswordItemRenderer() {
		super(new RustyswordItemModel());
	}

	@Override
	public RenderType getRenderType(RustyswordItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof RustyswordItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new RustyswordItemRenderer();
	...
	protected RustyswordItem animatable;
	...
	@Override
	public void render(GeoModel model, RustyswordItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(RustyswordItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(RustyswordItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(RustyswordItem animatable) {
