...
public class Modelobleck_lord<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "obleck_lord"), "main");
	private final ModelPart l_arm3;
	...
	private final ModelPart l_arm4;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arm_bottom_l8_r1 = l_arm3.addOrReplaceChild("arm_bottom_l8_r1",
				CubeListBuilder.create().texOffs(26, 103)
						.addBox(-3.49F, 15.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 103)
						...
						.addBox(0.51F, 7.0F, 5.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 91)
						.mirror().addBox(-3.51F, 10.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(50, 97).mirror()
		...
		PartDefinition arm_bottom_l7_r1 = l_arm2.addOrReplaceChild("arm_bottom_l7_r1",
				CubeListBuilder.create().texOffs(26, 49)
						.addBox(-3.49F, 20.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 49)
						...
						.addBox(-3.51F, 15.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 43)
		...
		PartDefinition arm_bottom_l6_r1 = left_arm.addOrReplaceChild("arm_bottom_l6_r1", CubeListBuilder.create()
				.texOffs(78, 33).mirror().addBox(-2.49F, 16.5F, -2.49F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(78, 33).mirror()
				.addBox(-1.99F, 16.5F, 1.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(78, 33)
				.mirror().addBox(0.51F, 16.5F, 1.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(78, 33).mirror().addBox(0.01F, 16.5F, -3.01F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(94, 33).mirror()
				.addBox(1.51F, 8.0F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(78, 21)
				.mirror().addBox(-2.51F, 11.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(78, 0).mirror().addBox(-2.5F, 0.0F, -2.5F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F))
				.mirror(false), PartPose.offsetAndRotation(2.5F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));
		...
		PartDefinition arm_bottom_r18_r1 = r_arm3.addOrReplaceChild("arm_bottom_r18_r1",
				CubeListBuilder.create().texOffs(26, 103)
						.addBox(1.49F, 15.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 103)
						...
						.addBox(-2.49F, 10.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 97)
		...
		PartDefinition arm_bottom_r12_r1 = r_arm2.addOrReplaceChild("arm_bottom_r12_r1",
				CubeListBuilder.create().texOffs(70, 49)
						.addBox(1.49F, 20.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(70, 49)
						...
						.addBox(-2.49F, 15.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(108, 43)
		...
		PartDefinition arm_bottom_r6_r1 = right_arm.addOrReplaceChild("arm_bottom_r6_r1",
				CubeListBuilder.create().texOffs(78, 33)
						.addBox(0.49F, 16.5F, -2.49F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(-3.49F, 11.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(78, 0)
		...
		PartDefinition main_head = partdefinition.addOrReplaceChild("main_head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)).texOffs(25, 0)
						.addBox(-3.0F, -6.5F, -4.75F, 6.0F, 6.0F, 1.0F, new CubeDeformation(1.0F)),
				PartPose.offset(0.0F, -8.5F, 0.0F));

		PartDefinition back_spike_right_r1 = main_head.addOrReplaceChild("back_spike_right_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 1.0F, -0.5F, 1.0F, 1.0F, 3.0F,
		...
		PartDefinition side_spike_right_r1 = main_head.addOrReplaceChild("side_spike_right_r1",
				CubeListBuilder.create().texOffs(32, 8).mirror()
						.addBox(1.5F, 1.0F, 1.5F, 1.0F, 1.0F, 6.0F, new CubeDeformation(1.0F)).mirror(false),
		...
		PartDefinition back_spike_left_r1 = main_head.addOrReplaceChild("back_spike_left_r1",
				CubeListBuilder.create().texOffs(32, 8).addBox(-2.5F, 1.0F, 1.5F, 1.0F, 1.0F, 6.0F,
						new CubeDeformation(1.0F)),
				PartPose.offsetAndRotation(4.0F, -3.5F, 0.0F, 0.0436F, 0.3491F, 0.1309F));
		...
		PartDefinition back_ear_right = main_head.addOrReplaceChild("back_ear_right", CubeListBuilder.create()
				.texOffs(13, 23).mirror().addBox(-2.0F, -1.5F, -2.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(1.0F))
				.mirror(false).texOffs(0, 22).mirror()
				.addBox(-1.5F, -1.25F, 0.75F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).mirror(false).texOffs(0, 22)
				.mirror().addBox(-1.51F, 0.25F, 2.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).mirror(false)
				.texOffs(28, 16).mirror().addBox(-1.49F, 1.75F, 0.25F, 1.0F, 1.0F, 8.0F, new CubeDeformation(1.0F))
				.mirror(false), PartPose.offsetAndRotation(-4.0F, -7.0F, 1.5F, -0.0873F, -0.2618F, 0.2182F));
		...
		PartDefinition back_ear_left = main_head.addOrReplaceChild("back_ear_left",
				CubeListBuilder.create().texOffs(13, 23)
						.addBox(0.0F, -1.5F, -2.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(1.0F)).texOffs(0, 22)
						.addBox(0.5F, -1.25F, 0.75F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).texOffs(0, 22)
						.addBox(0.51F, 0.25F, 2.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).texOffs(28, 16)
						.addBox(0.49F, 1.75F, 0.25F, 1.0F, 1.0F, 8.0F, new CubeDeformation(1.0F)),
		...
		PartDefinition spike_left_side_r1 = back_ear_left.addOrReplaceChild("spike_left_side_r1",
				CubeListBuilder.create().texOffs(0, 22).addBox(0.5F, -1.25F, 0.75F, 1.0F, 1.0F, 6.0F,
						new CubeDeformation(1.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, -0.1745F, -0.0873F));

		PartDefinition ear_top_right = main_head.addOrReplaceChild("ear_top_right",
				CubeListBuilder.create().texOffs(0, 17).mirror()
						.addBox(-3.0F, 1.0F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false)
						.texOffs(1, 22).mirror()
						.addBox(-2.75F, 0.75F, 1.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(1.0F)).mirror(false),
		...
		PartDefinition ear_top_right2 = main_head.addOrReplaceChild("ear_top_right2",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(1.0F, 1.0F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).texOffs(1, 22)
						.addBox(1.75F, 0.75F, 1.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(1.0F)),
				PartPose.offsetAndRotation(0.0F, -9.5F, 1.5F, 0.7854F, 0.2182F, 0.3054F));

		PartDefinition ear_top = main_head
				.addOrReplaceChild("ear_top",
						CubeListBuilder.create().texOffs(0, 17).addBox(-1.5F, -0.25F, -5.0F, 3.0F, 1.0F, 4.0F,
								new CubeDeformation(1.0F)),
		...
		PartDefinition spike_top2_r1 = ear_top.addOrReplaceChild("spike_top2_r1",
				CubeListBuilder.create().texOffs(1, 22)
						.addBox(-0.5F, 0.49F, 0.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(1.0F)).texOffs(0, 26)
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create()
				.texOffs(108, 21).addBox(-5.0F, 0.0F, -2.5F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 8.0F, 0.0F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(108, 21).mirror()
						.addBox(0.0F, 0.0F, -2.5F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 8.0F, 0.0F));
		...
		PartDefinition arm_bottom_r19_r1 = r_arm4.addOrReplaceChild("arm_bottom_r19_r1",
				CubeListBuilder.create().texOffs(26, 76)
						.addBox(1.49F, 11.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 76)
						...
						.addBox(-2.49F, 6.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 70)
						.addBox(-1.5F, -1.0F, 3.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 1.0F, -6.0F, 0.0F, 0.0F, 0.0436F));
		...
		PartDefinition arm_bottom_l9_r1 = l_arm4.addOrReplaceChild("arm_bottom_l9_r1",
				CubeListBuilder.create().texOffs(26, 76)
						.addBox(-3.49F, 11.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 76)
						...
						.addBox(0.51F, 3.0F, 5.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 64)
						.mirror().addBox(-3.51F, 6.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(50, 70).mirror()
						.addBox(-3.5F, -1.0F, 3.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.0F, 1.0F, -6.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(98, 0)
				.addBox(-5.0F, -32.0F, -2.5F, 10.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition left_shoulder_r1 = bb_main.addOrReplaceChild("left_shoulder_r1",
				CubeListBuilder.create().texOffs(0, 35).addBox(-2.0F, -8.0F, -2.375F, 6.0F, 10.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -27.0F, 2.5F, -0.3491F, -0.48F, 0.5236F));

		PartDefinition right_shoulder_r1 = bb_main.addOrReplaceChild("right_shoulder_r1",
