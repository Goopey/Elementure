...
public class BubbledSummonBubblesProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (world.dayTime() % Math.max(100 - (entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ElementureModMobEffects.BUBBLED_EFFECT.get()) ? _livEnt.getEffect(ElementureModMobEffects.BUBBLED_EFFECT.get()).getAmplifier() : 0), 20) == 0
				&& Math.random() < 0.5) {
