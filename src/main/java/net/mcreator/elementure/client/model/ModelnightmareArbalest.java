...
public class ModelnightmareArbalest<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelnightmare_arbalest"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -12.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 48)
		...
		PartDefinition head_pivot_bob = head_tilt.addOrReplaceChild("head_pivot_bob",
				CubeListBuilder.create().texOffs(32, 0).addBox(-3.99F, -8.01F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 16)
		...
		PartDefinition cube_r2 = spider_leg_3.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(44, 35).addBox(-1.0F, 0.0F, -6.0F, 2.0F, 2.0F, 17.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = spider_leg_5.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(44, 35).addBox(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 16.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = right_arm_tilt.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 48).addBox(-12.0F, -10.0F, -0.4F, 16.0F, 16.0F, 0.0F, new CubeDeformation(0.01F)),
		...
		PartDefinition right_pauldron_r1 = right_arm_tilt.addOrReplaceChild("right_pauldron_r1",
				CubeListBuilder.create().texOffs(112, 0).addBox(-2.0F, -2.0F, -2.01F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(24, 18)
		...
		PartDefinition left_pauldron_r1 = left_arm_tilt.addOrReplaceChild("left_pauldron_r1",
				CubeListBuilder.create().texOffs(112, 0).mirror().addBox(-2.01F, -2.0F, -2.01F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(24, 18).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.01F, 0.5F, 0.0F, 0.0F, 0.0F, -0.1309F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(104, 21).addBox(-4.0F, -12.0F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
