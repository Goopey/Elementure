...
public class CorememoryseedsItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A seed used to harvest core memories."));
		list.add(Component.literal("-Grows on cobblestone"));
		list.add(Component.literal("-Water helps"));
		list.add(Component.literal("-Mossy cobblestone helps"));
	}

	@Override
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		CorememoryseedsPlantProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer(), context.getItemInHand());
