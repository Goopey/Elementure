...
public class Modelruingranitelemental<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelruingranitelemental"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Crystal5 = partdefinition.addOrReplaceChild("Crystal5",
				CubeListBuilder.create().texOffs(48, 0).addBox(-6.0F, 0.0F, 0.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body6 = partdefinition.addOrReplaceChild("Body6",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -2.01F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body5 = partdefinition.addOrReplaceChild("Body5",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.99F, -2.0F, -1.99F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body4 = partdefinition.addOrReplaceChild("Body4",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body2 = partdefinition.addOrReplaceChild("Body2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.1F, 0.0F, 2.0F, 10.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 4.5F, 3.5F, -3.1416F, 0.0F, 3.1416F));
		PartDefinition Ring = partdefinition.addOrReplaceChild("Ring",
				CubeListBuilder.create().texOffs(84, 0).addBox(-11.0F, 0.0F, 0.0F, 11.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Crystal4 = partdefinition.addOrReplaceChild("Crystal4",
				CubeListBuilder.create().texOffs(0, 32).addBox(0.0F, 0.0F, -2.0F, 0.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Crystal3 = partdefinition.addOrReplaceChild("Crystal3",
				CubeListBuilder.create().texOffs(44, 24).addBox(-8.3F, 0.0F, 0.0F, 9.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.8F, 14.5F, -3.5F, 2.7773F, 0.0F, 3.1416F));
		PartDefinition Crystal2 = partdefinition
				.addOrReplaceChild(
						"Crystal2", CubeListBuilder.create().texOffs(20, 24).mirror()
								.addBox(-8.3F, 0.0F, 0.0F, 9.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(-3.8F, 14.5F, 3.5F, -2.7773F, 0.0F, 3.1416F));
		PartDefinition Crystal1 = partdefinition.addOrReplaceChild("Crystal1",
				CubeListBuilder.create().texOffs(0, 16).addBox(0.0F, 0.0F, -2.0F, 0.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.5F, 14.5F, 1.5F, -3.1416F, 0.0F, 2.7773F));
		PartDefinition Headmain = partdefinition.addOrReplaceChild("Headmain",
				CubeListBuilder.create().texOffs(100, 16).addBox(-3.0F, -4.5F, -3.0F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -3.5F, 0.0F));
		PartDefinition HeadBottom = Headmain.addOrReplaceChild("HeadBottom",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2276F, 0.0F, 0.0F));
		PartDefinition HeadTop = Headmain.addOrReplaceChild("HeadTop",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.9F, 0.0F, -0.3187F, 0.0F, 0.0F));
		PartDefinition HeadMinor = Headmain.addOrReplaceChild("HeadMinor",
				CubeListBuilder.create().texOffs(50, 0).addBox(-3.5F, -2.0F, -4.0F, 7.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm = LeftArmBone.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.9F, 1.8F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.1F, -4.4F, 0.0F));
		...
		PartDefinition RightArm = RightArmBone.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.2F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.1F, 0.6F, 0.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -27.5F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Body1_r1 = bb_main.addOrReplaceChild("Body1_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(2.5F, -19.4F, 3.5F, 2.0F, 10.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 7.0F, -3.1416F, 0.0F, 3.1416F));
		PartDefinition ChestLeft_r1 = bb_main.addOrReplaceChild("ChestLeft_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1F, -2.5F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.7364F, -21.6879F, 0.0F, -3.1416F, 0.0F, 2.9596F));
		PartDefinition Shoulderleft_r1 = bb_main.addOrReplaceChild("Shoulderleft_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.1F, -0.7F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.8553F, -24.8874F, 0.0F, -3.1416F, 0.0F, -2.0944F));
		PartDefinition ChestRight_r1 = bb_main.addOrReplaceChild("ChestRight_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -1.5F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5625F, -22.516F, 0.0F, 0.0F, 0.0F, 0.185F));
		PartDefinition Shoulderright_r1 = bb_main.addOrReplaceChild("Shoulderright_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.2F, -0.7F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
