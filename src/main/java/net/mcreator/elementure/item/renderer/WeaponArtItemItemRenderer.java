...
import net.mcreator.elementure.utils.AnimUtils;
...
public class WeaponArtItemItemRenderer extends GeoItemRenderer<WeaponArtItemItem> implements RendersPlayerArms {
	public WeaponArtItemItemRenderer() {
		super(new WeaponArtItemItemModel());
	}

	@Override
	public RenderType getRenderType(WeaponArtItemItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof WeaponArtItemItem) {
	...
	protected WeaponArtItemItem animatable;
	...
	@Override
	public void render(GeoModel model, WeaponArtItemItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(WeaponArtItemItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(WeaponArtItemItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(WeaponArtItemItem animatable) {
