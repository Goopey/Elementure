...
public class Modelmycena_shroom_infected_guard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_shroom_infected_guard"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Shroom4 = Body.addOrReplaceChild("Shroom4",
				CubeListBuilder.create().texOffs(18, 1).addBox(0.55F, -2.455F, -1.5F, 0.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
