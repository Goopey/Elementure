...
public class FungalPitDisplayProcedure {
	public static boolean execute(Entity entity) {
		...
		ret_val = ((entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ElementureModVariables.PlayerVariables())).zonename).equals("fungalPit") && entity.getY() < 0
