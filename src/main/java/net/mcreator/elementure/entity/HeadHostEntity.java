...
import net.mcreator.elementure.procedures.HeadHostPoisonProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class HeadHostEntity extends Monster {
	public HeadHostEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.HEAD_HOST.get(), world);
	}

	public HeadHostEntity(EntityType<HeadHostEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		HeadHostPoisonProcedure.execute(sourceentity);
	}
