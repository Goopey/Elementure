...
import net.mcreator.elementure.procedures.MycenashroomvillagerleatherworkerOpenTradesProcedure;
import net.mcreator.elementure.procedures.MycenashroomvillagerleatherworkerDefineTradesProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

import javax.annotation.Nullable;

public class MycenashroomvillagerleatherworkerEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public MycenashroomvillagerleatherworkerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.MYCENASHROOMVILLAGERLEATHERWORKER.get(), world);
	}

	public MycenashroomvillagerleatherworkerEntity(EntityType<MycenashroomvillagerleatherworkerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		MycenashroomvillagerleatherworkerDefineTradesProcedure.execute(this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MycenashroomvillagerleatherworkerOpenTradesProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
