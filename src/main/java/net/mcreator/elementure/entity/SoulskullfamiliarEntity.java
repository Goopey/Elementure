...
import net.mcreator.elementure.procedures.SoulskullfamiliarTickUpdateProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

import java.util.List;

public class SoulskullfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public SoulskullfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.SOULSKULLFAMILIAR.get(), world);
	}

	public SoulskullfamiliarEntity(EntityType<SoulskullfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void baseTick() {
		super.baseTick();
		SoulskullfamiliarTickUpdateProcedure.execute(this.level, this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SoulskullfamiliarEntity retval = ElementureModEntities.SOULSKULLFAMILIAR.get().create(serverWorld);
