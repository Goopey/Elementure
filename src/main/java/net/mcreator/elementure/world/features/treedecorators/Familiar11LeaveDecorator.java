...
public class Familiar11LeaveDecorator extends LeaveVineDecorator {
	public static final Familiar11LeaveDecorator INSTANCE = new Familiar11LeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("familiar_11_tree_leave_decorator", tdt);
	}

	public Familiar11LeaveDecorator() {
		super(0.25f);
	}
