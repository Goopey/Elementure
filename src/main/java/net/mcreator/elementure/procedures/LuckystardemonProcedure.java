...
public class LuckystardemonProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		world.setBlock(new BlockPos(x, y + 1, z), ElementureModBlocks.LUCKYSTAR.get().defaultBlockState(), 3);
		...
		entity.getPersistentData().putBoolean("luckystaractivation", (true));
