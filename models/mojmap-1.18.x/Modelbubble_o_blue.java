...
public class Modelbubble_o_blue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bubble_o_blue"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(12, 41).mirror()
						.addBox(-1.5F, -0.99F, -1.5F, 3.0F, 20.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-6.5F, 26.0F, 6.5F));

		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 41)
				.addBox(-1.5F, -0.99F, -1.5F, 3.0F, 20.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.5F, 26.0F, -6.5F));
		...
		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(12, 41)
				.addBox(-1.5F, -0.99F, -1.5F, 3.0F, 20.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(6.5F, 26.0F, 6.5F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(64, 46)
						.addBox(-8.0F, -21.99F, -8.0F, 16.0F, 2.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(56, 0)
