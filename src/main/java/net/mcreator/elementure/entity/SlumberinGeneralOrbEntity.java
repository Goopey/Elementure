	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canContinueToUse() {
				return SlumberinGeneralOrbEntity.this.getMoveControl().hasWanted() && SlumberinGeneralOrbEntity.this.getTarget() != null && SlumberinGeneralOrbEntity.this.getTarget().isAlive();
			}
