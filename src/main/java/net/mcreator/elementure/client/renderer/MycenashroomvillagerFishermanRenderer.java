...
public class MycenashroomvillagerFishermanRenderer extends MobRenderer<MycenashroomvillagerFishermanEntity, Modelmycena_shroom_villager_fisherman<MycenashroomvillagerFishermanEntity>> {
	public MycenashroomvillagerFishermanRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<MycenashroomvillagerFishermanEntity, Modelmycena_shroom_villager_fisherman<MycenashroomvillagerFishermanEntity>>(this) {
			@Override
