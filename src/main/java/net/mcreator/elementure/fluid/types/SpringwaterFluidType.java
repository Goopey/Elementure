...
public class SpringwaterFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("elementure:blocks/springwater_still"),
					FLOWING_TEXTURE = new ResourceLocation("elementure:blocks/springwater_flowing");
