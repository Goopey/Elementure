...
import net.mcreator.elementure.procedures.HoneyberryjamRegenProcedure;
...
public class HoneyberryjamItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Super-rich berry jam!"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		HoneyberryjamRegenProcedure.execute(entity);
		return retval;
	}
}
