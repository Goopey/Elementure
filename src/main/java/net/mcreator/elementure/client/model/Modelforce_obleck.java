...
public class Modelforce_obleck<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelforce_obleck"), "main");
	public final ModelPart main_body;
	public final ModelPart FistWrist1;
	public final ModelPart FistWrist2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ear_top_right2 = main_body.addOrReplaceChild("ear_top_right2",
				...
				PartPose.offsetAndRotation(0.0F, -8.5F, 1.5F, 0.3927F, 0.2182F, 0.3054F));
		PartDefinition FistWrist1 = partdefinition.addOrReplaceChild("FistWrist1",
				CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 10.7399F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(13.3F, 6.1F, 2.0F, 0.0F, 0.0F, 0.182F));
		PartDefinition Fisttop1 = FistWrist1.addOrReplaceChild("Fisttop1",
				CubeListBuilder.create().texOffs(36, 19).addBox(-7.1114F, 6.525F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Fistside1_r1 = Fistside1.addOrReplaceChild("Fistside1_r1",
				CubeListBuilder.create().texOffs(36, 19).addBox(-13.8798F, 0.115F, -4.01F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition FistWristside11 = FistWrist1.addOrReplaceChild("FistWristside11",
				CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 9.1768F, 4.0796F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition FistWristside12 = FistWrist1.addOrReplaceChild("FistWristside12",
				CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 9.1768F, -7.0796F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, 0.7F, 0.5463F, 0.0F, 0.0F));
		...
		PartDefinition Fistside2_r1 = Fistside2.addOrReplaceChild("Fistside2_r1",
				CubeListBuilder.create().texOffs(36, 19).addBox(-11.4798F, -0.185F, -4.01F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
