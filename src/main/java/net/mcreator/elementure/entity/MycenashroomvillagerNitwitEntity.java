...
public class MycenashroomvillagerNitwitEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public MycenashroomvillagerNitwitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.MYCENASHROOMVILLAGER_NITWIT.get(), world);
	}

	public MycenashroomvillagerNitwitEntity(EntityType<MycenashroomvillagerNitwitEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
