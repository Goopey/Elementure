...
public class NightmareArbalestEntity extends Monster implements RangedAttackMob {
	public NightmareArbalestEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.NIGHTMARE_ARBALEST.get(), world);
	}

	public NightmareArbalestEntity(EntityType<NightmareArbalestEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		ArachneelbowEntity.shoot(this, target);
	}
