...
public class SoulobleckEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canContinueToUse() {
				return SoulobleckEntity.this.getMoveControl().hasWanted() && SoulobleckEntity.this.getTarget() != null && SoulobleckEntity.this.getTarget().isAlive();
			}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.SOULOBLECK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
