...
public class PapyscrownfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public PapyscrownfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.PAPYSCROWNFAMILIAR.get(), world);
	}

	public PapyscrownfamiliarEntity(EntityType<PapyscrownfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		PapyscrownfamiliarEntity retval = ElementureModEntities.PAPYSCROWNFAMILIAR.get().create(serverWorld);
