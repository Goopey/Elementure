...
import net.mcreator.elementure.procedures.VengefulspiritskillConsumeProcedure;
import net.mcreator.elementure.init.ElementureModTabs;
import net.mcreator.elementure.entity.VengefulspiritskillEntity;

public class VengefulspiritskillItem extends Item {
	public VengefulspiritskillItem() {
