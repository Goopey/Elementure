...
public class CormunculusClubItemRenderer extends GeoItemRenderer<CormunculusClubItem> implements RendersPlayerArms {
	public CormunculusClubItemRenderer() {
		super(new CormunculusClubItemModel());
	}

	@Override
	public RenderType getRenderType(CormunculusClubItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof CormunculusClubItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new CormunculusClubItemRenderer();
	...
	protected CormunculusClubItem animatable;
	...
	@Override
	public void render(GeoModel model, CormunculusClubItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(CormunculusClubItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(CormunculusClubItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(CormunculusClubItem animatable) {
