...
public class FishingrecordNetherStar1Screen extends AbstractContainerScreen<FishingrecordNetherStar1Menu> {
	...
	public void init() {
		...
		button_next_page = new Button(this.leftPos + 127, this.topPos + 140, 70, 20, Component.translatable("gui.elementure.fishingrecord_nether_star_1.button_next_page"), e -> {
			if (DeactivateSlotProcedure.execute()) {
