...
public class Modellightningblastskillprojectile<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("elementure", "modellightningblastskillprojectile"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Main1 = partdefinition.addOrReplaceChild("Main1",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -1.5F, -1.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Front1 = Main1.addOrReplaceChild("Front1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.5F, -5.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.9F, 0.0F, -1.6F, 0.0F, -0.4554F, 0.0F));
		PartDefinition Minor1 = Main1.addOrReplaceChild("Minor1",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -1.0F, -1.5F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, 0.0F, 0.0F));
		PartDefinition Tail1 = Main1.addOrReplaceChild("Tail1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.5F, 0.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Front2 = Main2.addOrReplaceChild("Front2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.5F, -5.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.9F, 0.0F, -1.6F, 0.0F, -0.4554F, 0.0F));
		PartDefinition Tail2 = Main2.addOrReplaceChild("Tail2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.5F, 0.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, 0.0F, 0.6F, 0.0F, -0.5009F, 0.0F));
