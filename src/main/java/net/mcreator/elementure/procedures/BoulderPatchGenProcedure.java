	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index0 = 0; index0 < (int) (7); index0++) {
			if (Math.random() < 0.5) {
				...
				if (world.getBlockState(new BlockPos(locX, world.getHeight(Heightmap.Types.OCEAN_FLOOR, (int) locX, (int) locZ), locZ)).getLightBlock(world,
						new BlockPos(locX, world.getHeight(Heightmap.Types.OCEAN_FLOOR, (int) locX, (int) locZ), locZ)) >= 15) {
