...
public class ModelslumberingSoldier<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "slumberingsoldier"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_pivot_bob = head_tilt.addOrReplaceChild("head_pivot_bob",
				CubeListBuilder.create().texOffs(32, 0)
						...
						.addBox(-3.99F, -8.01F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition cube_r3 = spider_leg_5.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(44, 35).addBox(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 48)
