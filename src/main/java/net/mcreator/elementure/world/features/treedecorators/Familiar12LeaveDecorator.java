...
public class Familiar12LeaveDecorator extends LeaveVineDecorator {
	public static final Familiar12LeaveDecorator INSTANCE = new Familiar12LeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("familiar_12_tree_leave_decorator", tdt);
	}

	public Familiar12LeaveDecorator() {
		super(0.25f);
	}
