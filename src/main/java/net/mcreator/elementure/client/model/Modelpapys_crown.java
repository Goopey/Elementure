...
public class Modelpapys_crown<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelpapys_crown"), "main");
	public final ModelPart bone;
	public final ModelPart main_body_bone;
	public final ModelPart crown;
	public final ModelPart crownbone;
