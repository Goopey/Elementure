...
import net.mcreator.elementure.procedures.RedsunshrinePlaceProcedure;

import java.util.Set;
import java.util.List;

public class RedsunshrineFeature extends Feature<NoneFeatureConfiguration> {
	public static RedsunshrineFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new RedsunshrineFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("elementure:redsunshrine", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("elementure:redsunshrine", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
