...
import net.mcreator.elementure.procedures.PurpletrouishDisplayProcedure;
...
public class PurpletrouishOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (PurpletrouishDisplayProcedure.execute(entity)) {
