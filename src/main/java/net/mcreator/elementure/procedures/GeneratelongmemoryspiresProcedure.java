...
public class GeneratelongmemoryspiresProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		world.setBlock(new BlockPos(x, y + 3, z), ElementureModBlocks.MEMORYCRYSTAL.get().defaultBlockState(), 3);
		world.setBlock(new BlockPos(x, y + 4, z), ElementureModBlocks.MEMORYCRYSTAL.get().defaultBlockState(), 3);
	}
}
