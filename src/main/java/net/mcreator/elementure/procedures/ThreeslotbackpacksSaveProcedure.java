		...
		for (int index0 = 0; index0 < (int) (3); index0++) {
			{
				...
				_setstack.setCount(
						(((entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get((int) inventorySlots)).getItem() : ItemStack.EMPTY).copy()))
								.getCount());
