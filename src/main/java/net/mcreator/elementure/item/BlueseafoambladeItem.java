...
import net.mcreator.elementure.procedures.BlueseabladeGatherProcedure;
import net.mcreator.elementure.init.ElementureModTabs;
import net.mcreator.elementure.init.ElementureModItems;

import java.util.List;

public class BlueseafoambladeItem extends SwordItem {
	public BlueseafoambladeItem() {
		super(new Tier() {
			public int getUses() {
				return 321;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		BlueseabladeGatherProcedure.execute(sourceentity);
		return retval;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			BlueseafoambladeTrueWaterProcedure.execute(entity);
	}
}
