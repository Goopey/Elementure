...
public class Modelmind_obleck<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mind_obleck"), "main");
	private final ModelPart main_body;
	private final ModelPart shield_rot;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ear_top = main_body.addOrReplaceChild("ear_top", CubeListBuilder.create().texOffs(0, 17).mirror()
				.addBox(-1.0F, -1.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 26)
				.mirror().addBox(-0.5F, -1.25F, -1.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition shield_rot = partdefinition
				.addOrReplaceChild(
						"shield_rot", CubeListBuilder.create().texOffs(36, 18).addBox(-3.5025F, -3.4975F, -3.4975F,
								7.0F, 7.0F, 7.0F, new CubeDeformation(4.0F)),
						PartPose.offset(0.0025F, 15.9975F, -0.0025F));

		PartDefinition shield_r1 = shield_rot.addOrReplaceChild("shield_r1",
				CubeListBuilder.create().texOffs(36, 18).addBox(-3.5F, -3.5F, -3.51F, 7.0F, 7.0F, 7.0F,
		...
		PartDefinition shield_r2 = shield_rot.addOrReplaceChild("shield_r2",
				CubeListBuilder.create().texOffs(36, 18).addBox(-3.49F, -3.5F, -3.5F, 7.0F, 7.0F, 7.0F,
						new CubeDeformation(4.0F)),
		...
		PartDefinition shield_r3 = shield_rot.addOrReplaceChild("shield_r3",
				CubeListBuilder.create().texOffs(36, 18).addBox(-3.5F, -8.51F, -3.5F, 7.0F, 7.0F, 7.0F,
						new CubeDeformation(4.0F)),
