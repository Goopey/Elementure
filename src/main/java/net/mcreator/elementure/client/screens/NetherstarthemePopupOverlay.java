...
public class NetherstarthemePopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (NetherstarConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.netherstartheme_popup.label_rebel_base_1"), posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.netherstartheme_popup.label_fromcrusaders"), posX + -198, posY + -108, -203);
		}
