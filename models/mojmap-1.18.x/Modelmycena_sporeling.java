...
public class Modelmycena_sporeling<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_sporeling"), "main");
	private final ModelPart bone_leg1;
	private final ModelPart bone_leg2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone_leg1 = partdefinition.addOrReplaceChild("bone_leg1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F,
		...
		PartDefinition bone_leg2 = partdefinition.addOrReplaceChild("bone_leg2",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 21.0F, 0.0F, -0.0873F, 0.0F, -0.3927F));

		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(20, 28)
						.addBox(-1.5F, -0.5F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(24, 20)
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 19.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(
				-0.5F, -5.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
