...
public class Modelcandle_knight<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "candle_knight"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition legs_r1 = legs.addOrReplaceChild("legs_r1",
				CubeListBuilder.create().texOffs(67, 16).addBox(-4.5F, 0.0F, -2.0F, 9.0F, 13.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -3.0F, 0.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition candles = partdefinition.addOrReplaceChild("candles", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition candle_1 = candles.addOrReplaceChild("candle_1",
				CubeListBuilder.create().texOffs(48, 0)
						.addBox(-2.0F, -4.0F, 0.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 0)
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(48, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 59)
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(48, 16)
				.mirror().addBox(0.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 59).mirror().addBox(3.01F, -0.5F, -2.01F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(64, 54).mirror()
				.addBox(-0.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(5.0F, 0.0F, 0.0F));

		PartDefinition sword_r1 = left_arm.addOrReplaceChild("sword_r1",
				CubeListBuilder.create().texOffs(96, 32).addBox(0.0F, -10.0F, -10.0F, 0.0F, 16.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 13.2426F, -5.6569F, 2.3562F, 0.0F, -3.1416F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(28, 46)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.5F, -19.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
