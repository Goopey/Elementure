...
public class Modelmycena_shroomal<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelmycena_shroomal"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Eye = partdefinition.addOrReplaceChild("Eye",
				CubeListBuilder.create().texOffs(120, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -2.5F, -1.5F));
		PartDefinition rArm = partdefinition.addOrReplaceChild("rArm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.7F, 0.0F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition lArm = partdefinition.addOrReplaceChild("lArm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.3F, 0.0F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -2.69F, -2.35F, 10.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 22)
		...
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(64, 116).addBox(-10.5F, -0.8F, -7.5F, 21.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(46, 100)
		...
		PartDefinition rLegbone = partdefinition.addOrReplaceChild("rLegbone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 0.0F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 9.0F, 0.0F));
		PartDefinition lLegbone = partdefinition.addOrReplaceChild("lLegbone",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, 9.0F, 0.0F));
