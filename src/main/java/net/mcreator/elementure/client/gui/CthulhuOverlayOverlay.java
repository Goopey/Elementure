...
import net.mcreator.elementure.procedures.CthulhuDisplayProcedure;
...
public class CthulhuOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (CthulhuDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/cthulhu.png"));
