...
public class Modelarachneel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(50, 12).addBox(-2.0F, -5.0F, -2.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition head2 = head.addOrReplaceChild("head2",
				CubeListBuilder.create().texOffs(40, 0).addBox(-3.0F, -6.0F, -6.5F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = jaw1.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(54, 58).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = jaw2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(54, 58).addBox(-1.0F, -2.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, 0.3491F, -0.6109F, 0.3054F));
		...
		PartDefinition cube_r3 = leg_1.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -6.5F, -2.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1309F, 0.0F, 0.3054F));
		PartDefinition cube_r4 = leg_1.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, -0.3054F));
		PartDefinition leg_2 = partdefinition.addOrReplaceChild("leg_2", CubeListBuilder.create(), PartPose.offset(-4.0F, 22.5F, 3.9F));
		PartDefinition cube_r5 = leg_2.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -6.5F, -0.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -0.5F, 0.0F, 0.0F, 0.3054F));
		PartDefinition cube_r6 = leg_2.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -7.0F, -0.5F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -0.5F, 0.0F, 0.0F, -0.3054F));
		...
		PartDefinition cube_r9 = leg_4
				.addOrReplaceChild(
						"cube_r9", CubeListBuilder.create().texOffs(0, 0).mirror()
								.addBox(3.0F, -6.5F, -2.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1309F, 0.0F, -0.3054F));
		PartDefinition cube_r10 = leg_4
				.addOrReplaceChild(
		...
		PartDefinition cube_r11 = leg_5
				.addOrReplaceChild(
						"cube_r11", CubeListBuilder.create().texOffs(0, 0).mirror()
								.addBox(3.0F, -6.5F, -0.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, -0.5F, 0.0F, 0.0F, -0.3054F));
		PartDefinition cube_r12 = leg_5
				.addOrReplaceChild(
						"cube_r12", CubeListBuilder.create().texOffs(0, 0).mirror()
		...
		PartDefinition cube_r13 = leg_6.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(3.0F, -6.5F, 0.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, -0.3054F));
		PartDefinition cube_r14 = leg_6
				.addOrReplaceChild(
		...
		PartDefinition cube_r15 = leg_7.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -2.0F, 0.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -12.0F, 3.0F, 0.2618F, -0.3054F, 0.0F));
		PartDefinition cube_r16 = leg_7.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -13.0F, -1.0F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = leg_8
				.addOrReplaceChild(
						"cube_r17", CubeListBuilder.create().texOffs(0, 0).mirror()
								.addBox(-0.5F, -2.0F, 0.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, -12.0F, 3.0F, 0.2618F, 0.3054F, 0.0F));
		PartDefinition cube_r18 = leg_8
				.addOrReplaceChild(
						"cube_r18", CubeListBuilder.create().texOffs(0, 0).mirror()
								.addBox(-1.0F, -13.0F, -1.0F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, -1.0F, 1.0F, -0.1309F, 0.3054F, 0.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 48).addBox(-4.0F, -8.01F, 0.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
