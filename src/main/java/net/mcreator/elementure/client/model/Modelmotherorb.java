...
public class Modelmotherorb<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon5 = three.addOrReplaceChild(
				"hexadecagon5", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -11.0F, -8.01F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-23.99F, -11.0F, 4.8174F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		PartDefinition hexadecagon_r1 = hexadecagon5.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -3.0F, -3.1826F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition hexadecagon_r3 = hexadecagon5.addOrReplaceChild("hexadecagon_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r4 = hexadecagon5.addOrReplaceChild("hexadecagon_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition hexadecagon6 = three.addOrReplaceChild(
				"hexadecagon6", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -11.1826F, -8.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-11.0F, -24.0F, 4.8174F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		PartDefinition hexadecagon_r5 = hexadecagon6.addOrReplaceChild("hexadecagon_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -16.0F, -3.1826F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition hexadecagon_r7 = hexadecagon6.addOrReplaceChild("hexadecagon_r7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r8 = hexadecagon6.addOrReplaceChild("hexadecagon_r8",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition hexadecagon7 = three.addOrReplaceChild(
				"hexadecagon7", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -24.0F, 5.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-24.0F, -11.1826F, 5.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		PartDefinition hexadecagon_r9 = hexadecagon7.addOrReplaceChild("hexadecagon_r9",
				CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -3.1826F, -3.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition hexadecagon_r11 = hexadecagon7.addOrReplaceChild("hexadecagon_r11",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -16.0F, -3.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon2 = two.addOrReplaceChild(
				"hexadecagon2", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -11.0F, -8.01F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-23.99F, -11.0F, 4.8174F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r16 = hexadecagon2.addOrReplaceChild("hexadecagon_r16",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition hexadecagon3 = two.addOrReplaceChild(
				"hexadecagon3", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -11.1826F, -8.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-11.0F, -24.0F, 4.8174F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r20 = hexadecagon3.addOrReplaceChild("hexadecagon_r20",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition hexadecagon4 = two.addOrReplaceChild(
				"hexadecagon4", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -24.0F, 5.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-24.0F, -11.1826F, 5.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition ohexadecagon = one.addOrReplaceChild(
				"ohexadecagon", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -11.0F, -8.01F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-23.99F, -11.0F, 4.8174F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r28 = ohexadecagon.addOrReplaceChild("hexadecagon_r28",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition rhexadecagon = one.addOrReplaceChild(
				"rhexadecagon", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -11.1826F, -8.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-11.0F, -24.0F, 4.8174F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r32 = rhexadecagon.addOrReplaceChild("hexadecagon_r32",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition ehexadecagon = one.addOrReplaceChild(
				"ehexadecagon", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -24.0F, 5.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-24.0F, -11.1826F, 5.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition four = bone2.addOrReplaceChild("four", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.0472F, 0.0F));
		PartDefinition hexadecagon8 = four.addOrReplaceChild(
				"hexadecagon8", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -11.0F, -8.01F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-23.99F, -11.0F, 4.8174F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r40 = hexadecagon8.addOrReplaceChild("hexadecagon_r40",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition hexadecagon9 = four.addOrReplaceChild(
				"hexadecagon9", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -11.1826F, -8.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-11.0F, -24.0F, 4.8174F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r44 = hexadecagon9.addOrReplaceChild("hexadecagon_r44",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition hexadecagon10 = four.addOrReplaceChild(
				"hexadecagon10", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -24.0F, 5.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-24.0F, -11.1826F, 5.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition five = bone2.addOrReplaceChild("five", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.5236F, 0.0F));
		PartDefinition hexadecagon11 = five
				.addOrReplaceChild("hexadecagon11",
						CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -11.0F, -8.01F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-23.99F, -11.0F, 4.8174F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
						PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r52 = hexadecagon11.addOrReplaceChild("hexadecagon_r52",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition hexadecagon12 = five.addOrReplaceChild(
				"hexadecagon12", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -11.1826F, -8.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-11.0F, -24.0F, 4.8174F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r56 = hexadecagon12.addOrReplaceChild("hexadecagon_r56",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition hexadecagon13 = five.addOrReplaceChild(
				"hexadecagon13", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -24.0F, 5.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-24.0F, -11.1826F, 5.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon14 = six
				.addOrReplaceChild("hexadecagon14",
						CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -11.0F, -8.01F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-23.99F, -11.0F, 4.8174F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
						PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r64 = hexadecagon14.addOrReplaceChild("hexadecagon_r64",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.1826F, -3.0F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition hexadecagon15 = six.addOrReplaceChild(
				"hexadecagon15", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -11.1826F, -8.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-11.0F, -24.0F, 4.8174F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition hexadecagon_r68 = hexadecagon15.addOrReplaceChild("hexadecagon_r68",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.1826F, -16.0F, 6.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition hexadecagon16 = six.addOrReplaceChild(
				"hexadecagon16", CubeListBuilder.create().texOffs(0, 0).addBox(-11.1826F, -24.0F, 5.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-24.0F, -11.1826F, 5.0F, 32.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		...
		PartDefinition heads = partdefinition.addOrReplaceChild("heads",
				CubeListBuilder.create().texOffs(0, 68).addBox(-15.0F, -15.0F, -17.0F, 30.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 98)
