...
public class Modelcrystal_creeper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crystal_creeper"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(20, 24)
				.addBox(-2.0F, -1.0F, -3.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2",
				CubeListBuilder.create().texOffs(20, 24).mirror()
						.addBox(-1.0F, -1.0F, -3.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(2.0F, 20.0F, -2.0F));

		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(20, 24).addBox(
				-1.0F, -1.0F, 0.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 20.0F, 2.0F));

		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4",
				CubeListBuilder.create().texOffs(20, 24).mirror()
						.addBox(-2.0F, -1.0F, 0.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-2.0F, 20.0F, 2.0F));

		PartDefinition shards = partdefinition.addOrReplaceChild("shards",
				CubeListBuilder.create().texOffs(0, 27)
						.addBox(-1.0F, -18.0F, 0.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 27)
