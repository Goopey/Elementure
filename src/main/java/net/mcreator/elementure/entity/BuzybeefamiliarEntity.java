...
public class BuzybeefamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public BuzybeefamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.BUZYBEEFAMILIAR.get(), world);
	}

	public BuzybeefamiliarEntity(EntityType<BuzybeefamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BuzybeefamiliarEntity retval = ElementureModEntities.BUZYBEEFAMILIAR.get().create(serverWorld);
