...
public class CoalpuckfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public CoalpuckfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.COALPUCKFAMILIAR.get(), world);
	}

	public CoalpuckfamiliarEntity(EntityType<CoalpuckfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 10, (float) 0, false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CoalpuckfamiliarEntity retval = ElementureModEntities.COALPUCKFAMILIAR.get().create(serverWorld);
