...
public class DiverscrownBonemealGrassProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index0 = 0; index0 < (int) (11); index0++) {
			if (Math.random() < 0.8) {
				...
				if (world instanceof Level _level) {
					BlockPos _bp = new BlockPos(locX, y, locZ);
					if (BoneMealItem.growCrop(new ItemStack(Items.BONE_MEAL), _level, _bp)
							|| BoneMealItem.growWaterPlant(new ItemStack(Items.BONE_MEAL), _level, _bp, null)) {
						if (!_level.isClientSide())
							_level.levelEvent(2005, _bp, 0);
				...
				if (world instanceof Level _level) {
					BlockPos _bp = new BlockPos(locX, y + 1, locZ);
					if (BoneMealItem.growCrop(new ItemStack(Items.BONE_MEAL), _level, _bp)
							|| BoneMealItem.growWaterPlant(new ItemStack(Items.BONE_MEAL), _level, _bp, null)) {
						if (!_level.isClientSide())
							_level.levelEvent(2005, _bp, 0);
				...
				if (world instanceof Level _level) {
					BlockPos _bp = new BlockPos(locX, y + 2, locZ);
					if (BoneMealItem.growCrop(new ItemStack(Items.BONE_MEAL), _level, _bp)
							|| BoneMealItem.growWaterPlant(new ItemStack(Items.BONE_MEAL), _level, _bp, null)) {
						if (!_level.isClientSide())
							_level.levelEvent(2005, _bp, 0);
