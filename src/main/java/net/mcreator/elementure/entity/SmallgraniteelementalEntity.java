...
public class SmallgraniteelementalEntity extends Monster {
	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ElementureModEntities.SMALLGRANITEELEMENTAL.get(), 52, 3, 7));
	}

	public SmallgraniteelementalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.SMALLGRANITEELEMENTAL.get(), world);
	}

	public SmallgraniteelementalEntity(EntityType<SmallgraniteelementalEntity> type, Level world) {
		super(type, world);
		xpReward = 9;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ElementureModBlocks.RUINGRANITE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.SMALLGRANITEELEMENTAL.get(), SpawnPlacements.Type.ON_GROUND,
