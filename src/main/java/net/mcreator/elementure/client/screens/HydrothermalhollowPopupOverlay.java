...
public class HydrothermalhollowPopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (HydrothermalhollowConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.hydrothermalhollow_popup.label_hydrothermal_hollow"), posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.hydrothermalhollow_popup.label_bylui37"), posX + -198, posY + -108, -203);
		}
