...
import net.mcreator.elementure.procedures.BetafishDisplayProcedure;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.platform.GlStateManager;

@Mod.EventBusSubscriber({Dist.CLIENT})
public class BetafishOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (BetafishDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/beta_fish.png"));
				...
				if (FishabilitytimerReturnProcedure.execute(entity) > 120) {
					RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/stun_particles.png"));
