...
import net.mcreator.elementure.procedures.PolaroidTeleportProcedure;
...
public class PolaroidItem extends Item {
	...
	public boolean isFoil(ItemStack itemstack) {
		return PolaroidTeleportSetProcedure.execute(itemstack);
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		PolaroidTeleportProcedure.execute(world, entity, itemstack);
		return ar;
	}
}
