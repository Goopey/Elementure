...
public class MagtunabusterEntity extends AbstractArrow implements ItemSupplier {
	public MagtunabusterEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(ElementureModEntities.MAGTUNABUSTER.get(), world);
	}

	public MagtunabusterEntity(EntityType<? extends MagtunabusterEntity> type, Level world) {
		super(type, world);
	}

	public MagtunabusterEntity(EntityType<? extends MagtunabusterEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public MagtunabusterEntity(EntityType<? extends MagtunabusterEntity> type, LivingEntity entity, Level world) {
