...
public class PurplemushroomsFeature extends RandomPatchFeature {
	public static PurplemushroomsFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("elementure:purplemushrooms", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(BlockStateProvider.simple(ElementureModBlocks.PURPLEMUSHROOMS.get().defaultBlockState())),
						List.of(), 8));
