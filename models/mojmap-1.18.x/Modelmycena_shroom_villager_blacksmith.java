...
public class Modelmycena_shroom_villager_blacksmith<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_shroom_villager_blacksmith"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition HammerBone = LeftArmBone.addOrReplaceChild("HammerBone",
				CubeListBuilder.create().texOffs(52, 0)
						.addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(-1.0F, -1.5F, -4.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
