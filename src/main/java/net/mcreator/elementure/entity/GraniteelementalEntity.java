...
public class GraniteelementalEntity extends Monster {
	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ElementureModEntities.GRANITEELEMENTAL.get(), 66, 2, 4));
	}

	public GraniteelementalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.GRANITEELEMENTAL.get(), world);
	}

	public GraniteelementalEntity(EntityType<GraniteelementalEntity> type, Level world) {
		super(type, world);
		xpReward = 12;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ElementureModBlocks.POLISHEDRUINGRANITE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.GRANITEELEMENTAL.get(), SpawnPlacements.Type.ON_GROUND,
