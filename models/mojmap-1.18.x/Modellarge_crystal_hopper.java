...
public class Modellarge_crystal_hopper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "large_crystal_hopper"), "main");
	private final ModelPart mid_gem2;
	private final ModelPart mid_gem;
	private final ModelPart leg6_extra;
	private final ModelPart leg3_r1;
	private final ModelPart leg5_r1;
	private final ModelPart leg7_r1;
	private final ModelPart leg8_r1;
	private final ModelPart leg9_r1;
	private final ModelPart leg1_extra;
	private final ModelPart leg2_r1;
	private final ModelPart leg4_r1;
	private final ModelPart leg10_r1;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mid_gem2 = partdefinition.addOrReplaceChild("mid_gem2",
				CubeListBuilder.create().texOffs(26, 14).addBox(-2.5F, -27.0F, -4.0F, 5.0F, 8.0F, 8.0F,
		...
		PartDefinition gem_8_r2 = mid_gem2.addOrReplaceChild("gem_8_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(0.5F, 3.5F, -2.4683F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition gem_7_r2 = mid_gem2.addOrReplaceChild("gem_7_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(0.0F, 0.5F, 0.0F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition gem_6_r2 = mid_gem2.addOrReplaceChild("gem_6_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -8.0F, -2.01F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition gem_4_r2 = mid_gem2.addOrReplaceChild("gem_4_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -8.0F, -0.01F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.0F, 0.0F, -0.2618F, 0.0F, -0.5236F));
		...
		PartDefinition gem_2_r2 = mid_gem2.addOrReplaceChild("gem_2_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(0.0F, -8.0F, -1.01F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition gem_1_r2 = mid_gem2.addOrReplaceChild("gem_1_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -8.0F, -1.01F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition mid_gem = partdefinition.addOrReplaceChild("mid_gem",
				CubeListBuilder.create().texOffs(24, 14)
						.addBox(-3.5F, -43.0F, -4.5F, 7.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(24, 14)
		...
		PartDefinition gem_8_r1 = mid_gem.addOrReplaceChild("gem_8_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(0.5F, -1.5F, -2.4683F, 2.0F, 13.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition gem_6_r1 = mid_gem.addOrReplaceChild("gem_6_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -21.0F, -2.01F, 2.0F, 21.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition gem_5_r1 = mid_gem.addOrReplaceChild("gem_5_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -17.0F, -2.01F, 2.0F, 17.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -30.0F, 0.0F, 0.2618F, 0.0F, -0.5236F));

		PartDefinition gem_4_r1 = mid_gem.addOrReplaceChild("gem_4_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -18.0F, -0.01F, 2.0F, 18.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -30.0F, 0.0F, -0.2618F, 0.0F, -0.5236F));

		PartDefinition gem_3_r1 = mid_gem.addOrReplaceChild("gem_3_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -15.0F, -0.01F, 2.0F, 15.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -30.0F, 0.0F, -0.2618F, 0.0F, 0.5236F));

		PartDefinition gem_2_r1 = mid_gem.addOrReplaceChild("gem_2_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(0.0F, -17.0F, -1.01F, 2.0F, 17.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -30.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition gem_1_r1 = mid_gem.addOrReplaceChild("gem_1_r1",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -16.0F, -1.01F, 2.0F, 16.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -30.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition leg6_extra = partdefinition.addOrReplaceChild("leg6_extra", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-1.0F, -10.25F, -1.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(9.0F, -10.75F, 11.0F));

		PartDefinition leg7_r2 = leg6_extra.addOrReplaceChild("leg7_r2", CubeListBuilder.create().texOffs(0, 0)
				.addBox(1.0F, -30.5F, 1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 18.25F, -2.0F));

		PartDefinition leg3_r1 = partdefinition.addOrReplaceChild("leg3_r1", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.0F, -14.25F, -1.0F, 2.0F, 19.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(9.0F, -10.75F, -11.0F));

		PartDefinition leg5_r1 = partdefinition.addOrReplaceChild("leg5_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 47.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leg7_r1 = partdefinition.addOrReplaceChild("leg7_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 44.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leg1_extra = partdefinition.addOrReplaceChild("leg1_extra", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-1.0F, -13.25F, -1.0F, 2.0F, 18.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.0F, -10.75F, 11.0F));

		PartDefinition leg11_r1 = leg1_extra.addOrReplaceChild("leg11_r1", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.0F, -31.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg4_r1 = partdefinition.addOrReplaceChild("leg4_r1", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.0F, -17.25F, -1.0F, 2.0F, 22.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.0F, -10.75F, -11.0F));

		PartDefinition leg10_r1 = partdefinition.addOrReplaceChild("leg10_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 45.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -16.5F, -5.0F, -0.0873F, 0.0F, -0.2618F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(20, 49)
						.addBox(-6.0F, -38.01F, -5.0F, 12.0F, 5.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(20, 49)
		...
		PartDefinition body_r1 = bb_main.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(16, 45).addBox(-5.0F, -2.5F, -7.0F, 10.0F, 5.0F, 14.0F,
						new CubeDeformation(0.0F)),
