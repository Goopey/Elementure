...
public class DemonheartGUIScreen extends AbstractContainerScreen<DemonheartGUIMenu> {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 1, 108, 20, Component.literal("Absorption"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 1, this.topPos + 20, 160, 20, Component.literal("Fire-resistance"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 1, this.topPos + 41, 56, 20, Component.literal("Haste"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 1, this.topPos + 61, 132, 20, Component.literal("Regeneration"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 80, 116, 20, Component.literal("Jump-boost"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 100, 188, 20, Component.literal("Luck UP! Better loot"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 120, 108, 20, Component.literal("Resistance"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 140, 264, 20, Component.literal("Saturation, no more hunger"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 1, this.topPos + 160, 60, 20, Component.literal("Speed"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 179, 160, 20, Component.literal("Strength. POWER!"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 153, this.topPos + 61, 116, 20, Component.literal("Night-vision"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 104, this.topPos + 120, 164, 20, Component.literal("Water-breathing"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 264, this.topPos + 143, 0, 20, Component.literal(""), e -> {
		}));
	}
}
