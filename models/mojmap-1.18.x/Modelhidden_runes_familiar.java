...
public class Modelhidden_runes_familiar<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hidden_runes_familiar"), "main");
	private final ModelPart main_bone;
	private final ModelPart runes;
	private final ModelPart top_runes_r1;
	private final ModelPart bottom_runes_r1;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main_bone = partdefinition.addOrReplaceChild("main_bone", CubeListBuilder.create(),
				PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition body = main_bone
				.addOrReplaceChild("body",
						CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.5F, 1.0F, 2.0F, 7.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, 0.0F));

		PartDefinition right_cover_r1 = body.addOrReplaceChild("right_cover_r1",
		...
		PartDefinition right_page_3_r1 = body.addOrReplaceChild("right_page_3_r1",
		...
		PartDefinition right_page_2_r1 = body.addOrReplaceChild("right_page_2_r1",
				CubeListBuilder.create().texOffs(20, 0).mirror()
						.addBox(-0.35F, -3.5F, -0.4F, 6.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 2.5307F, 0.0F));

		PartDefinition right_page_r1 = body.addOrReplaceChild("right_page_r1",
				CubeListBuilder.create().texOffs(20, 0).mirror()
		...
		PartDefinition left_page_2_r1 = body
				.addOrReplaceChild("left_page_2_r1",
						CubeListBuilder.create().texOffs(20, 0).addBox(-0.25F, -3.5F, 0.5F, 6.0F, 7.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3054F, 0.0F));

		PartDefinition left_page_r1 = body
				.addOrReplaceChild("left_page_r1",
						CubeListBuilder.create().texOffs(20, 0).addBox(-0.25F, -3.5F, 0.5F, 6.0F, 7.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2182F, 0.0F));

		PartDefinition left_cover_r1 = body
				.addOrReplaceChild("left_cover_r1",
						CubeListBuilder.create().texOffs(6, 0).addBox(-0.25F, -3.5F, 0.5F, 6.0F, 7.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1745F, 0.0F));

		PartDefinition runes = main_bone.addOrReplaceChild("runes", CubeListBuilder.create().texOffs(8, 46).addBox(
				-7.0F, -2.0F, -7.0F, 14.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition bottom_runes_r1 = runes.addOrReplaceChild(
				"bottom_runes_r1", CubeListBuilder.create().texOffs(24, 32).addBox(-5.0F, 3.5F, -5.0F, 10.0F, 3.0F,
						10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition top_runes_r1 = runes
				.addOrReplaceChild("top_runes_r1",
						CubeListBuilder.create().texOffs(24, 19).addBox(-5.0F, -6.5F, -5.0F, 10.0F, 3.0F, 10.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
