...
public class CorallabyrinthpopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (CorallabyrinthpopupConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), "Coral Labyrinth", posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), "By:Red&Green", posX + -198, posY + -108, -203);
		}
