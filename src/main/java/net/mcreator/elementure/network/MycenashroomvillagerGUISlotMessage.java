...
public class MycenashroomvillagerGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public MycenashroomvillagerGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public MycenashroomvillagerGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(MycenashroomvillagerGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MycenashroomvillagerGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = MycenashroomvillagerGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ElementureMod.addNetworkMessage(MycenashroomvillagerGUISlotMessage.class, MycenashroomvillagerGUISlotMessage::buffer, MycenashroomvillagerGUISlotMessage::new, MycenashroomvillagerGUISlotMessage::handler);
	}
}
