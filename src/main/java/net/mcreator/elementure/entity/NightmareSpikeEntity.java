...
public class NightmareSpikeEntity extends PathfinderMob {
	public NightmareSpikeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.NIGHTMARE_SPIKE.get(), world);
	}

	public NightmareSpikeEntity(EntityType<NightmareSpikeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		NightmareSpikeSpikeProcedure.execute(this.level, this);
	}
