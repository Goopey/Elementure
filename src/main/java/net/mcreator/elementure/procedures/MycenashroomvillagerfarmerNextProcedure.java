...
public class MycenashroomvillagerfarmerNextProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getPersistentData().getDouble("trades") == 0) {
			if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
				...
				_setstack.setCount((int) ((1 + entity.getPersistentData().getDouble("tradeAmount") / 4.5)
			...
			if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
					&& _current.get() instanceof Map _slots) {
				ItemStack _setstack = new ItemStack(ElementureModItems.MYCENAMOSSBRICK.get());
