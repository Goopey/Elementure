...
public class ElementureModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == VillagerProfession.TOOLSMITH) {
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(Blocks.OBSIDIAN, 4),
					new ItemStack(ElementureModItems.OBSIDIANBOBBER.get()), 1, 20, 0.05f));
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 8), new ItemStack(Items.IRON_INGOT, 4),
					new ItemStack(ElementureModItems.IRONBOBBER.get()), 2, 12, 0.05f));
		}
		if (event.getType() == VillagerProfession.FISHERMAN) {
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(Blocks.OBSIDIAN, 4),
					new ItemStack(ElementureModItems.OBSIDIANBOBBER.get()), 1, 5, 0.05f));
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 8), new ItemStack(ElementureModItems.PIP.get(), 4),
					new ItemStack(ElementureModItems.CRABBOBBER.get()), 2, 12, 0.05f));
		}
	}
}
