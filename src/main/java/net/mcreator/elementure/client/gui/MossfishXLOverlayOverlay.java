...
import net.mcreator.elementure.procedures.MossfishXLchosenProcedure;
...
public class MossfishXLOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (MossfishXLchosenProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/moss_fish_xl_gui.png"));
