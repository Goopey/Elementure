...
public class FishingbaroverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (FishingbaroverlayDisplayProcedure.execute(entity)) {
			...
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -77, posY + -114, 0, 0, 72, 212, 72, 212);

			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/fishing_progress_bar.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -23, posY + -110, 0, 0, 13, 204, 13, 204);
			...
			if (Reelingtimer1Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + 67, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer2Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + 42, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer3Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + 17, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer4Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + -8, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer5Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + -33, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer6Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + -58, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer7Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + -83, 0, 0, 9, 25, 9, 25);
			}
			if (Reelingtimer8Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -21, posY + -108, 0, 0, 9, 25, 9, 25);
			}
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/backg_fishingitems.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 9, posY + -64, 0, 0, 56, 124, 56, 124);

			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/inventory_slot_texture.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 15, posY + -11, 0, 0, 18, 18, 18, 18);

			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/inventory_slot_texture.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 15, posY + -56, 0, 0, 18, 18, 18, 18);

			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/inventory_slot_texture.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 15, posY + 34, 0, 0, 18, 18, 18, 18);

			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/fishing_stun_progress_bar.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 45, posY + -58, 0, 0, 13, 112, 13, 112);
			...
			if (Stuntimer1Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 47, posY + 34, 0, 0, 9, 18, 9, 18);
			}
			if (Stuntimer2Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 47, posY + 16, 0, 0, 9, 18, 9, 18);
			}
			if (Stuntimer3Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 47, posY + -2, 0, 0, 9, 18, 9, 18);
			}
			if (Stuntimer4Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 47, posY + -20, 0, 0, 9, 18, 9, 18);
			}
			if (Stuntimer5Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 47, posY + -38, 0, 0, 9, 18, 9, 18);
			}
			if (Stuntimer6Procedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 47, posY + -56, 0, 0, 9, 18, 9, 18);
			}
		}
