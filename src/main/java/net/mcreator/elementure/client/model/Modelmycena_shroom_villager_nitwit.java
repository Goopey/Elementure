...
public class Modelmycena_shroom_villager_nitwit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("elementure", "modelmycena_shroom_villager_nitwit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(56, 48).addBox(-1.0F, -24.0F, -1.0F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(45, 60)
