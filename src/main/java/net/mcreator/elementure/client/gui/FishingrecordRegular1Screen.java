...
import net.mcreator.elementure.procedures.TrouishconfirmProcedure;
import net.mcreator.elementure.procedures.TrahiraconfirmProcedure;
import net.mcreator.elementure.procedures.SmallbrumconfirmProcedure;
...
import net.mcreator.elementure.procedures.GreatbrumconfirmProcedure;
import net.mcreator.elementure.procedures.EelconfirmProcedure;
import net.mcreator.elementure.procedures.DelaconcordeConfirmProcedure;
import net.mcreator.elementure.procedures.DeadbrumConfirmProcedure;
import net.mcreator.elementure.procedures.DeactivateSlotProcedure;
import net.mcreator.elementure.procedures.ChubconfirmProcedure;
import net.mcreator.elementure.network.FishingrecordRegular1ButtonMessage;
...
public class FishingrecordRegular1Screen extends AbstractContainerScreen<FishingrecordRegular1Menu> {
	private final static HashMap<String, Object> guistate = FishingrecordRegular1Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_next_page;

	public FishingrecordRegular1Screen(FishingrecordRegular1Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("elementure:textures/screens/fishingrecord_regular_1.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		if (ChubconfirmProcedure.execute(entity)) {
		...
		if (TrahiraconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 35, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/trahira.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 33, 0, 0, 16, 16, 16, 16);

		if (MaxtrahiraconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 57, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/max_trahira.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 55, 0, 0, 16, 16, 16, 16);

		if (SmallbrumconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 79, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/smallbrum.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 77, 0, 0, 16, 16, 16, 16);

		if (GreatbrumconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 101, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/greatbrum.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 99, 0, 0, 16, 16, 16, 16);

		if (HalibutconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 123, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/halibut.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 121, 0, 0, 16, 16, 16, 16);

		if (TrouishconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 145, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/trouish.png"));
		...
		if (PipconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 13, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/pip.png"));
		this.blit(ms, this.leftPos + 47, this.topPos + 11, 0, 0, 16, 16, 16, 16);

		if (MelshconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 35, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/melsh.png"));
		this.blit(ms, this.leftPos + 47, this.topPos + 33, 0, 0, 16, 16, 16, 16);

		if (EelconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 57, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/eel.png"));
		this.blit(ms, this.leftPos + 47, this.topPos + 55, 0, 0, 16, 16, 16, 16);

		if (PacuconfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 79, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/pacu.png"));
		this.blit(ms, this.leftPos + 47, this.topPos + 77, 0, 0, 16, 16, 16, 16);

		if (DelaconcordeConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 101, 0, 0, 12, 12, 12, 12);
		}
		if (DelaconcordeConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/dela_concorde.png"));
			this.blit(ms, this.leftPos + 48, this.topPos + 99, 0, 0, 16, 16, 16, 16);
		}
		if (MidnighthalibutConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 123, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/midnight_halibut.png"));
		this.blit(ms, this.leftPos + 47, this.topPos + 121, 0, 0, 16, 16, 16, 16);

		if (DeadbrumConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + 31, this.topPos + 145, 0, 0, 12, 12, 12, 12);
		}
	...
	public void init() {
		...
		button_next_page = new Button(this.leftPos + 127, this.topPos + 140, 70, 20, Component.translatable("gui.elementure.fishingrecord_regular_1.button_next_page"), e -> {
			if (DeactivateSlotProcedure.execute()) {
				ElementureMod.PACKET_HANDLER.sendToServer(new FishingrecordRegular1ButtonMessage(0, x, y, z));
				FishingrecordRegular1ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
