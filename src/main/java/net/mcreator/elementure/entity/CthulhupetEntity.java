...
public class CthulhupetEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public CthulhupetEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.CTHULHUPET.get(), world);
	}

	public CthulhupetEntity(EntityType<CthulhupetEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 2, (float) 0, false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CthulhupetEntity retval = ElementureModEntities.CTHULHUPET.get().create(serverWorld);
