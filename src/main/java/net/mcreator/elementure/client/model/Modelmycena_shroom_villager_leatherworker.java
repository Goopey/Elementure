...
public class Modelmycena_shroom_villager_leatherworker<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("elementure", "modelmycena_shroom_villager_leatherworker"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ScepterBone = RightArmBone.addOrReplaceChild("ScepterBone",
				CubeListBuilder.create().texOffs(32, 0).addBox(-0.5F, -0.5F, -3.75F, 1.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(58, 0)
