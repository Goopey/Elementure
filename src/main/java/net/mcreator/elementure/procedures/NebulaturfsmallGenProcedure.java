...
public class NebulaturfsmallGenProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index0 = 0; index0 < (int) (169); index0++) {
			if (locX * locX * modX + locZ * locZ * modZ < 36 && ((world.getBlockState(new BlockPos(x + locX, y, z + locZ))).getBlock() == ElementureModBlocks.NETHERUMCARPET.get()
