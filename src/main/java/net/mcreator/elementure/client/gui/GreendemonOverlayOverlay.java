...
import net.mcreator.elementure.procedures.GreendemonDisplayProcedure;
...
public class GreendemonOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (GreendemonDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/green_demon_fish.png"));
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -57, posY + 68 - (int) FishPosReturnProcedure.execute(entity), 0, 0,
						16, 16, 16, 16);
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/green_demon_fish_woke.png"));
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -57, posY + 68 - (int) FishabilityposReturnProcedure.execute(entity),
						0, 0, 16, 16, 16, 16);
			}
