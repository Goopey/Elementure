...
import net.mcreator.elementure.procedures.StripedanioDisplayProcedure;
...
public class StripeddanioOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (StripedanioDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/striped_danio.png"));
