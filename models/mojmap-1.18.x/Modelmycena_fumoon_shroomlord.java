...
public class Modelmycena_fumoon_shroomlord<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_fumoon_shroomlord"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rArm = partdefinition.addOrReplaceChild("rArm", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.75F, 0.0F, -2.5F, 4.0F, 19.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-10.0F, -9.0F, 0.0F));

		PartDefinition lArm = partdefinition.addOrReplaceChild("lArm", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-2.25F, 0.0F, -2.5F, 4.0F, 19.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, -9.0F, 0.0F));

		PartDefinition eye = partdefinition.addOrReplaceChild("eye", CubeListBuilder.create().texOffs(116, 0).addBox(
				-1.5F, -2.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.5F, -2.5F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.5F, -7.0F, -2.5F, 13.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(88, 19)
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(42, 112)
						.addBox(-14.0F, -1.0F, -7.5F, 28.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(30, 93)
		...
		PartDefinition rLeg = partdefinition.addOrReplaceChild("rLeg", CubeListBuilder.create().texOffs(0, 0).addBox(
				-2.5F, 0.0F, -2.5F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.5F, 8.0F, 0.0F));

		PartDefinition lLeg = partdefinition.addOrReplaceChild("lLeg", CubeListBuilder.create().texOffs(0, 0).addBox(
				-2.5F, 0.0F, -2.5F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(4.5F, 8.0F, 0.0F));
