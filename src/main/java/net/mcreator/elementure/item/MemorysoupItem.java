...
import net.mcreator.elementure.procedures.MemorysoupEffectProcedure;
...
public class MemorysoupItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A soup made from memory fish. It helps you remember."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		MemorysoupEffectProcedure.execute(entity);
