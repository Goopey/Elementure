...
import net.mcreator.elementure.procedures.RedsunpillarAbilityProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class RedsunpillarEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public RedsunpillarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.REDSUNPILLAR.get(), world);
	}

	public RedsunpillarEntity(EntityType<RedsunpillarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		RedsunpillarAbilityProcedure.execute(this.level, this);
	}
