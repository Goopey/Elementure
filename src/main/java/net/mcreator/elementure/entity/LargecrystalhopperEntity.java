...
public class LargecrystalhopperEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ElementureModEntities.LARGECRYSTALHOPPER.get(), 90, 1, 2));
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.LARGECRYSTALHOPPER.get(), SpawnPlacements.Type.ON_GROUND,
