...
import net.mcreator.elementure.procedures.NetherbrumDisplayProcedure;
...
public class NetherbrumOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (NetherbrumDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/nethebrum.png"));
