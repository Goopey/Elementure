...
public class Modelobleck_cleric<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg_r = partdefinition.addOrReplaceChild("leg_r",
				CubeListBuilder.create().texOffs(0, 54).addBox(-3.5F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 17.0F, 0.0F));
		PartDefinition leg_l = partdefinition.addOrReplaceChild("leg_l",
				CubeListBuilder.create().texOffs(0, 54).mirror().addBox(0.5F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 17.0F, 0.0F));
		PartDefinition main_body = partdefinition.addOrReplaceChild("main_body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -3.5F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(40, 0)
		...
		PartDefinition back_ear_right = main_body.addOrReplaceChild("back_ear_right",
				CubeListBuilder.create().texOffs(13, 23).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 26).mirror().addBox(-0.5F, -2.75F, 1.75F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 26).mirror().addBox(-0.5F, -1.25F, 3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(14, 16).mirror().addBox(-0.5F, 0.25F, 1.25F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition spike_right_side_r1 = back_ear_right.addOrReplaceChild(
				"spike_right_side_r1", CubeListBuilder.create().texOffs(0, 26).mirror()
		...
		PartDefinition back_ear_left = main_body.addOrReplaceChild("back_ear_left",
				CubeListBuilder.create().texOffs(13, 23).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
						.addBox(-0.5F, -2.75F, 1.75F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
						.addBox(-0.5F, -1.25F, 3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(14, 16).addBox(-0.5F, 0.25F, 1.25F, 1.0F,
		...
		PartDefinition spike_left_side_r1 = back_ear_left.addOrReplaceChild("spike_left_side_r1",
				CubeListBuilder.create().texOffs(0, 26).addBox(-0.5F, -10.75F, 1.75F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.3927F, -0.1745F, -0.0873F));
		PartDefinition ear_top_right = main_body.addOrReplaceChild("ear_top_right",
				CubeListBuilder.create().texOffs(0, 17).mirror().addBox(-3.0F, -0.5F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 26).mirror().addBox(-2.75F, -0.75F, 1.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition ear_top_right2 = main_body.addOrReplaceChild("ear_top_right2",
				CubeListBuilder.create().texOffs(0, 17).addBox(1.0F, -0.5F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
						.addBox(1.75F, -0.75F, 1.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.5F, 1.5F, 0.3927F, 0.2182F, 0.3054F));
		PartDefinition arm_l = partdefinition.addOrReplaceChild("arm_l", CubeListBuilder.create().texOffs(56, 0).mirror()
				.addBox(-0.5F, -1.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 12.0F, 0.0F));
		PartDefinition arm_r = partdefinition.addOrReplaceChild("arm_r",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.5F, -1.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gem_8_r1 = mid_gem.addOrReplaceChild("gem_8_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(0.5F, -7.5F, -2.4683F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gem_7_r1 = mid_gem.addOrReplaceChild("gem_7_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(0.0F, -9.5F, 0.0F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gem_6_r1 = mid_gem.addOrReplaceChild("gem_6_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(-1.0F, -21.0F, -2.01F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gem_4_r1 = mid_gem.addOrReplaceChild("gem_4_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(-1.0F, -21.0F, -0.01F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 17.6457F, 0.3315F, -0.2618F, 0.0F, -0.5236F));
		PartDefinition gem_3_r1 = mid_gem.addOrReplaceChild("gem_3_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(-1.0F, -21.0F, -0.01F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 17.6457F, 0.3315F, -0.2618F, 0.0F, 0.5236F));
		PartDefinition gem_2_r1 = mid_gem.addOrReplaceChild("gem_2_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(0.0F, -20.0F, -1.01F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gem_1_r1 = mid_gem.addOrReplaceChild("gem_1_r1",
				CubeListBuilder.create().texOffs(56, 32).addBox(-2.0F, -20.0F, -1.01F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 17.6457F, 0.3315F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(42, 55).addBox(-3.0F, -9.5F, -2.51F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(12, 49)
