...
public class ModelslumberingGeneral<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "slumberinggeneral"), "main");
	private final ModelPart bone;

	private final ModelPart eye_tentacle_1;
	private final ModelPart off_rot;
	private final ModelPart eye_tentacle_11;
	private final ModelPart eye_tentacle_111;

	private final ModelPart eye_tentacle_2;
	private final ModelPart off_rot2;
	private final ModelPart eye_tentacle_3;
	private final ModelPart eye_tentacle_4;
	...
	private final ModelPart leg_9;
	private final ModelPart leg_10;
	private final ModelPart leg_11;
	private final ModelPart leg_12;
	private final ModelPart leg_13;
	private final ModelPart leg_14;

	private final ModelPart eye_tentacle_5;
	private final ModelPart off_rot3;
	private final ModelPart eye_tentacle_6;
	private final ModelPart eye_tentacle_7;

	private final ModelPart eye_tentacle_8;
	private final ModelPart off_rot4;
	private final ModelPart eye_tentacle_9;
	private final ModelPart eye_tentacle_10;

	private final ModelPart eye_tentacle_12;
	private final ModelPart off_rot5;
	private final ModelPart eye_tentacle_13;
	private final ModelPart eye_tentacle_14;

	private final ModelPart eye_tentacle_15;
	private final ModelPart off_rot6;
	private final ModelPart eye_tentacle_16;
	private final ModelPart eye_tentacle_17;

	private final ModelPart eye_tentacle_18;
	private final ModelPart off_rot7;
	private final ModelPart eye_tentacle_19;
	private final ModelPart eye_tentacle_20;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(64, 80)
				.addBox(-4.5F, 2.0F, -4.0F, 9.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 101)
		...
		PartDefinition off_rot = eye_tentacle_1
				.addOrReplaceChild("off_rot",
						CubeListBuilder.create().texOffs(96, 119).addBox(-2.0771F, -6.9526F, -2.0F, 4.0F, 6.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2182F));

		PartDefinition eye_tentacle_11 = off_rot.addOrReplaceChild("eye_tentacle_11", CubeListBuilder.create()
				.texOffs(102, 121).addBox(-1.5671F, -5.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_111 = eye_tentacle_11.addOrReplaceChild("eye_tentacle_111", CubeListBuilder.create()
				.texOffs(107, 123).addBox(-1.0671F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition off_rot2 = eye_tentacle_2.addOrReplaceChild(
				"off_rot2", CubeListBuilder.create().texOffs(97, 117).addBox(-2.9429F, -6.9526F, -2.0F, 4.0F, 7.0F,
						4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition eye_tentacle_3 = off_rot2.addOrReplaceChild("eye_tentacle_3", CubeListBuilder.create()
				.texOffs(112, 120).addBox(-2.4329F, -6.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_4 = eye_tentacle_3.addOrReplaceChild("eye_tentacle_4", CubeListBuilder.create()
				.texOffs(110, 123).addBox(-1.9329F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition leg_1 = partdefinition.addOrReplaceChild("leg_1", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, 22.0F, -15.0F));

		PartDefinition leg_2 = partdefinition.addOrReplaceChild("leg_2", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, 22.0F, -10.0F));

		PartDefinition leg_3 = partdefinition.addOrReplaceChild("leg_3", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, 22.0F, -5.0F));

		PartDefinition leg_4 = partdefinition.addOrReplaceChild("leg_4", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, 22.0F, 5.0F));

		PartDefinition leg_5 = partdefinition.addOrReplaceChild("leg_5", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, 22.0F, 10.0F));

		PartDefinition leg_6 = partdefinition.addOrReplaceChild("leg_6", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, 22.0F, 15.0F));

		PartDefinition leg_7 = partdefinition.addOrReplaceChild("leg_7", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, 5.0F));

		PartDefinition leg_8 = partdefinition.addOrReplaceChild("leg_8", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, 10.0F));

		PartDefinition leg_9 = partdefinition.addOrReplaceChild("leg_9", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, 15.0F));

		PartDefinition leg_10 = partdefinition.addOrReplaceChild("leg_10", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, 0.0F));

		PartDefinition leg_11 = partdefinition.addOrReplaceChild("leg_11", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, -5.0F));

		PartDefinition leg_12 = partdefinition.addOrReplaceChild("leg_12", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, -15.0F));

		PartDefinition leg_13 = partdefinition.addOrReplaceChild("leg_13", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.2F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-11.0F, 22.0F, -10.0F));

		PartDefinition leg_14 = partdefinition.addOrReplaceChild("leg_14", CubeListBuilder.create().texOffs(118, 122)
				.addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition off_rot3 = eye_tentacle_5.addOrReplaceChild("off_rot3",
				CubeListBuilder.create().texOffs(97, 117).addBox(-2.9429F, -6.9526F, -2.0F, 4.0F, 7.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 0.0F, 0.0F, -1.3526F, 0.0F, 0.2182F));

		PartDefinition eye_tentacle_6 = off_rot3.addOrReplaceChild("eye_tentacle_6", CubeListBuilder.create()
				.texOffs(112, 120).addBox(-2.4329F, -6.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_7 = eye_tentacle_6.addOrReplaceChild("eye_tentacle_7", CubeListBuilder.create()
				.texOffs(110, 123).addBox(-1.9329F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));
		...
		PartDefinition eye_tentacle_9 = off_rot4.addOrReplaceChild("eye_tentacle_9", CubeListBuilder.create()
				.texOffs(112, 120).addBox(-2.4329F, -6.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_10 = eye_tentacle_9.addOrReplaceChild("eye_tentacle_10", CubeListBuilder.create()
				.texOffs(110, 123).addBox(-1.9329F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));
		...
		PartDefinition eye_tentacle_13 = off_rot5.addOrReplaceChild("eye_tentacle_13", CubeListBuilder.create()
				.texOffs(112, 120).addBox(-2.4329F, -6.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_14 = eye_tentacle_13.addOrReplaceChild("eye_tentacle_14", CubeListBuilder.create()
				.texOffs(110, 123).addBox(-1.9329F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));
		...
		PartDefinition eye_tentacle_16 = off_rot6.addOrReplaceChild("eye_tentacle_16", CubeListBuilder.create()
				.texOffs(112, 120).addBox(-2.4329F, -6.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_17 = eye_tentacle_16.addOrReplaceChild("eye_tentacle_17", CubeListBuilder.create()
				.texOffs(110, 123).addBox(-1.9329F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));
		...
		PartDefinition eye_tentacle_19 = off_rot7.addOrReplaceChild("eye_tentacle_19", CubeListBuilder.create()
				.texOffs(112, 120).addBox(-2.4329F, -6.4526F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition eye_tentacle_20 = eye_tentacle_19.addOrReplaceChild("eye_tentacle_20", CubeListBuilder.create()
				.texOffs(110, 123).addBox(-1.9329F, -3.9526F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(216, 76)
						.addBox(-9.0F, -4.0F, -20.0F, 18.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(216, 76)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -5.0F, -19.0F, 4.0F, 6.0F, 38.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.0F, -16.0F, 0.0F, 0.0F, 0.0F, -1.0472F));

		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -5.0F, -19.0F, 4.0F, 6.0F, 38.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-10.0F, -16.0F, 0.0F, 0.0F, 0.0F, 1.0472F));
