...
import net.mcreator.elementure.procedures.RaredaggerloachDisplayProcedure;
...
public class RaredaggerloachOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (RaredaggerloachDisplayProcedure.execute(entity)) {
