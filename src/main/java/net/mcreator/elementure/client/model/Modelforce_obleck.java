...
public class Modelforce_obleck<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FistWrist1 = partdefinition.addOrReplaceChild("FistWrist1", CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 10.7399F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(13.3F, 6.1F, 2.0F, 0.0F, 0.0F, 0.182F));
		PartDefinition Fisttop1 = FistWrist1.addOrReplaceChild("Fisttop1", CubeListBuilder.create().texOffs(36, 19).addBox(-7.1114F, 6.525F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Fistside1_r1 = Fistside1.addOrReplaceChild("Fistside1_r1", CubeListBuilder.create().texOffs(36, 19).addBox(-13.8798F, 0.115F, -4.01F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 1.9F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition FistWristside11 = FistWrist1.addOrReplaceChild("FistWristside11", CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 9.1768F, 4.0796F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, -0.7F, -0.5463F, 0.0F, 0.0F));
		PartDefinition FistWristside12 = FistWrist1.addOrReplaceChild("FistWristside12", CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 9.1768F, -7.0796F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, 0.7F, 0.5463F, 0.0F, 0.0F));
		PartDefinition FistWrist2 = partdefinition.addOrReplaceChild("FistWrist2", CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 10.7399F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-13.3F, 6.1F, 2.0F, 0.0F, -3.1416F, -0.182F));
		PartDefinition Fisttop2 = FistWrist2.addOrReplaceChild("Fisttop2", CubeListBuilder.create().texOffs(36, 19).addBox(-7.1114F, 6.525F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.6F, 7.6F, 0.0F, 0.0F, 0.0F, 0.182F));
		...
		PartDefinition Fistside2_r1 = Fistside2.addOrReplaceChild("Fistside2_r1", CubeListBuilder.create().texOffs(36, 19).addBox(-11.4798F, -0.185F, -4.01F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.6F, 1.9F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition FistWristside21 = FistWrist2.addOrReplaceChild("FistWristside21", CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 9.1768F, 4.0796F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, -0.7F, -0.5463F, 0.0F, 0.0F));
		PartDefinition FistWristside22 = FistWrist2.addOrReplaceChild("FistWristside22", CubeListBuilder.create().texOffs(36, 19).addBox(-4.607F, 9.1768F, -7.0796F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, 0.7F, 0.5463F, 0.0F, 0.0F));
