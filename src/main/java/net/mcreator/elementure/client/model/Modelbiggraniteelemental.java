...
public class Modelbiggraniteelemental<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelbiggraniteelemental"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(92, 0).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -20.7F, -1.0F));
		PartDefinition Horn1 = Head.addOrReplaceChild("Horn1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -4.7F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.9F, 2.1F, -2.5F, 0.6374F, -1.0016F, 0.0F));
		PartDefinition Horn2 = Head.addOrReplaceChild("Horn2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -4.7F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.9F, 2.1F, -2.5F, 0.6374F, 1.0016F, 0.0F));
		PartDefinition Main4 = partdefinition.addOrReplaceChild("Main4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -20.0F, -1.5F, 3.0F, 20.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Neck4 = partdefinition.addOrReplaceChild("Neck4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -9.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Shoulder2 = partdefinition.addOrReplaceChild("Shoulder2",
				CubeListBuilder.create().texOffs(32, 32).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-12.5F, -15.5F, 2.0F));
		PartDefinition Band2 = Shoulder2.addOrReplaceChild("Band2",
				CubeListBuilder.create().texOffs(48, 16).addBox(-4.5F, -0.5F, -4.5F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 21.2F, 0.0F));
		PartDefinition FistWrist2 = Shoulder2.addOrReplaceChild("FistWrist2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Fisttop2 = FistWrist2.addOrReplaceChild("Fisttop2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -4.6F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Fistside2_r1 = Fistside2.addOrReplaceChild("Fistside2_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.9F, -3.8F, -4.01F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition FistWristside21 = FistWrist2.addOrReplaceChild("FistWristside21",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, -0.7F, -0.5463F, 0.0F, 0.0F));
		PartDefinition FistWristside22 = FistWrist2.addOrReplaceChild("FistWristside22",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, 0.7F, 0.5463F, 0.0F, 0.0F));
		PartDefinition Shoulder1 = partdefinition.addOrReplaceChild("Shoulder1",
				CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.5F, -15.5F, 2.0F));
		PartDefinition Band1 = Shoulder1.addOrReplaceChild("Band1",
				CubeListBuilder.create().texOffs(48, 16).addBox(-4.5F, -0.5F, -4.5F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 21.2F, 0.0F));
		PartDefinition FistWrist1 = Shoulder1.addOrReplaceChild("FistWrist1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Fistside1_r1 = Fistside1.addOrReplaceChild("Fistside1_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.3F, -3.5F, -4.01F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Heart = partdefinition.addOrReplaceChild("Heart",
				CubeListBuilder.create().texOffs(60, 0).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 21.0F, 2.0F));
		PartDefinition Ring6 = partdefinition.addOrReplaceChild("Ring6",
				CubeListBuilder.create().texOffs(92, 36).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Ring4 = partdefinition.addOrReplaceChild("Ring4",
				CubeListBuilder.create().texOffs(64, 40).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -38.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
