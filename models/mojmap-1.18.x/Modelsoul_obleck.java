...
public class Modelsoul_obleck<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "soul_obleck"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition spin = partdefinition.addOrReplaceChild("spin", CubeListBuilder.create().texOffs(15, 21)
				.addBox(-5.5F, -8.0F, -5.5F, 11.0F, 0.0F, 11.0F, new CubeDeformation(0.01F)).texOffs(48, 10).mirror()
				.addBox(-11.0F, -10.0F, -2.0F, 4.0F, 18.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(48, 10).addBox(7.0F, -10.0F, -2.0F, 4.0F, 18.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition back_ear_right = main_body.addOrReplaceChild("back_ear_right", CubeListBuilder.create()
				.texOffs(12, 23).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
