...
import net.mcreator.elementure.procedures.SupremetrahiraDisplayProcedure;
...
public class SupremetrahiraOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (SupremetrahiraDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/supreme_trahira.png"));
