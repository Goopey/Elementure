...
public class PouchGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PouchGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElementureModMenus.POUCH_GUI.get(), id);
