...
import net.mcreator.elementure.procedures.ForgottenwatcherDegradesanityProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class Forgottenwatcher2Entity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public Forgottenwatcher2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.FORGOTTENWATCHER_2.get(), world);
	}

	public Forgottenwatcher2Entity(EntityType<Forgottenwatcher2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void baseTick() {
		super.baseTick();
		ForgottenwatcherDegradesanityProcedure.execute(this.level, this);
	}
