...
import net.mcreator.elementure.procedures.ChaliceofEffectProcedure;
...
public class ChaliceofFishingPowerItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A chalice full of white"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		ChaliceofEffectProcedure.execute(entity);
