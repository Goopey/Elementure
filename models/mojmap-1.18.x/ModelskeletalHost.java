...
public class ModelskeletalHost<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "skeletalhost"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_pivot_bob = head_tilt.addOrReplaceChild(
				"head_pivot_bob", CubeListBuilder.create().texOffs(32, 0).addBox(-3.99F, -8.01F, -4.0F, 8.0F, 8.0F,
