...
import net.mcreator.elementure.procedures.PacificshaubDisplayProcedure;
...
public class PacificshaubOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (PacificshaubDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/pacific_shaub.png"));
