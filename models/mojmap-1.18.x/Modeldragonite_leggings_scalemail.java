...
public class Modeldragonite_leggings_scalemail<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dragonite_leggings_scalemail"), "main");
	private final ModelPart leg_top;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg_top = partdefinition.addOrReplaceChild("leg_top", CubeListBuilder.create().texOffs(16, 87)
				.addBox(-4.0F, 7.0F, -2.0F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.22F)),
				PartPose.offset(0.01F, 12.0F, -0.01F));

		PartDefinition b_spike_1 = leg_top.addOrReplaceChild("b_spike_1",
				CubeListBuilder.create().texOffs(0, 75).addBox(-1.0F, -2.5F, -0.67F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.22F)),
				PartPose.offsetAndRotation(-0.01F, 8.0F, 2.01F, -0.3491F, 0.0F, 0.0F));

		PartDefinition b_spike_2 = leg_top.addOrReplaceChild("b_spike_2",
		...
		PartDefinition b_spike_3 = leg_top.addOrReplaceChild("b_spike_3",
				CubeListBuilder.create().texOffs(0, 76).addBox(-1.67F, -3.0F, -1.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.22F)),
		...
		PartDefinition r_leg = partdefinition.addOrReplaceChild("r_leg", CubeListBuilder.create().texOffs(0, 83).addBox(
				-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 12.0F, 0.0F));
