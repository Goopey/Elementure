...
import net.mcreator.elementure.procedures.SmallbrumDisplayProcedure;
...
public class SmallbrumOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (SmallbrumDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/smallbrum.png"));
