...
public class Modelsirenqueen<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sirenqueen"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(210, 0)
						.addBox(-7.0F, -20.0F, -4.5F, 14.0F, 26.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(191, 16)
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(180, 32).addBox(-6.0F, 0.0F, -6.5F, 6.0F, 0.0F, 13.0F,
		...
		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(162, 0).addBox(-9.0F, 0.0F, 0.0F, 18.0F, 0.0F, 6.0F,
						new CubeDeformation(0.01F)),
		...
		PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(191, 16).mirror()
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create()
				.texOffs(196, 93).mirror().addBox(-3.0F, -9.0F, -8.01F, 14.0F, 16.0F, 16.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(196, 93).mirror()
				.addBox(-2.5F, 9.0F, -2.01F, 13.0F, 16.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(196, 93).mirror().addBox(-1.5F, 9.0F, -8.01F, 11.0F, 16.0F, 2.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(196, 93).mirror()
				.addBox(-1.99F, 13.0F, -8.51F, 12.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(196, 93).mirror().addBox(-2.0F, 7.0F, -6.01F, 12.0F, 23.0F, 12.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(196, 93).mirror()
				.addBox(0.0F, 30.0F, -5.01F, 8.0F, 11.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(16.0F, -10.0F, 0.0F));

		PartDefinition FistWrist1 = right_arm.addOrReplaceChild("FistWrist1",
				CubeListBuilder.create().texOffs(147, 81).mirror()
		...
		PartDefinition Fisttop1 = FistWrist1.addOrReplaceChild("Fisttop1",
				CubeListBuilder.create().texOffs(147, 81).mirror()
		...
		PartDefinition Fistside1_r1 = Fistside1.addOrReplaceChild("Fistside1_r1",
				CubeListBuilder.create().texOffs(147, 81).mirror()
		...
		PartDefinition FistWristside12 = FistWrist1.addOrReplaceChild("FistWristside12",
				CubeListBuilder.create().texOffs(147, 81).mirror()
						.addBox(-1.691F, -3.8403F, -0.9891F, 5.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.8F, 0.7F, 0.5463F, 0.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(196, 93)
						.addBox(-11.0F, -9.0F, -8.01F, 14.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(196, 93)
						.addBox(-10.5F, 9.0F, -2.01F, 13.0F, 16.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(196, 93)
		...
		PartDefinition FistWrist2 = left_arm.addOrReplaceChild("FistWrist2",
				CubeListBuilder.create().texOffs(147, 81).addBox(-1.309F, -1.9835F, -2.0F, 5.0F, 5.0F, 4.0F,
		...
		PartDefinition Fisttop2 = FistWrist2
				.addOrReplaceChild("Fisttop2",
						CubeListBuilder.create().texOffs(147, 81).addBox(-8.0F, -4.6F, -4.0F, 8.0F, 7.0F, 8.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(2.6F, 7.6F, 0.0F, 0.0F, 0.0F, 0.182F));
		...
		PartDefinition Fistside2_r1 = Fistside2.addOrReplaceChild(
				"Fistside2_r1", CubeListBuilder.create().texOffs(147, 81).addBox(-3.3905F, -3.9158F, -4.01F, 7.0F, 8.0F,
						8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 1.9F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition FistWristside2 = FistWrist2.addOrReplaceChild("FistWristside2",
				CubeListBuilder.create().texOffs(147, 81).addBox(-1.319F, -3.8403F, -2.0109F, 5.0F, 7.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, -0.7F, -0.5463F, 0.0F, 0.0F));

		PartDefinition FistWristside3 = FistWrist2.addOrReplaceChild(
				"FistWristside3", CubeListBuilder.create().texOffs(147, 81).addBox(-1.329F, -3.8403F, -0.9891F, 5.0F,
						7.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.8F, 0.7F, 0.5463F, 0.0F, 0.0F));

		PartDefinition tail_base = partdefinition.addOrReplaceChild("tail_base", CubeListBuilder.create()
				.texOffs(91, 43).addBox(-10.0F, -2.0F, -7.0F, 20.0F, 12.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 27.0F, 0.0F));

		PartDefinition tail_top = tail_base.addOrReplaceChild("tail_top", CubeListBuilder.create().texOffs(91, 43)
				.addBox(-9.0F, -2.0F, -6.0F, 18.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 10.0F, 0.0F));

		PartDefinition tail_mid = tail_top.addOrReplaceChild("tail_mid",
				CubeListBuilder.create().texOffs(91, 43)
						.addBox(-8.0F, -2.0F, -5.0F, 16.0F, 14.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 51)
						.mirror().addBox(8.0F, 0.0F, 0.0F, 12.0F, 18.0F, 0.0F, new CubeDeformation(0.01F)).mirror(false)
						.texOffs(0, 51).addBox(-20.0F, 0.0F, 0.0F, 12.0F, 18.0F, 0.0F, new CubeDeformation(0.01F)),
				PartPose.offset(0.0F, 10.0F, 0.0F));

		PartDefinition tail_end = tail_mid.addOrReplaceChild("tail_end", CubeListBuilder.create().texOffs(91, 43)
				.addBox(-7.5F, -2.0F, -4.5F, 15.0F, 20.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition tail = tail_end.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(34, 58).addBox(-12.0F,
				0.0F, -1.0F, 24.0F, 19.0F, 0.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 18.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-16.0F, -38.0F, -8.0F, 32.0F, 17.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(49, 84).addBox(0.0F, -12.0F, 0.0F, 0.0F, 24.0F, 20.0F,
						new CubeDeformation(0.0F)),
