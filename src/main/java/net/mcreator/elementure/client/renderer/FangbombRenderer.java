...
public class FangbombRenderer extends EntityRenderer<FangbombEntity> {
	...
	public FangbombRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelfang_bomb(context.bakeLayer(Modelfang_bomb.LAYER_LOCATION));
	}

	@Override
	public void render(FangbombEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FangbombEntity entity) {
		return texture;
	}
}
