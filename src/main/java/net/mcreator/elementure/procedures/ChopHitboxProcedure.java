...
public class ChopHitboxProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
			...
			return;
		{
			...
			List<Entity> _entfound = world.getEntitiesOfClass(Entity.class,
					new AABB(_center, _center).inflate(((entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ElementureModVariables.PlayerVariables())).hitbox_size) / 2d), e -> true).stream()
