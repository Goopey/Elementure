...
public class SoulobleckEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(ElementureModEntities.SOULOBLECK.get(), 4, 2, 3));
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new RandomStrollGoal(this, 1, 20) {
			...
			protected Vec3 getPosition() {
				Random random = SoulobleckEntity.this.getRandom();
