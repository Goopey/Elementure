...
public class MycenafumoonSpawnSporesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getDouble("wait") > 600 && !(!world.getEntitiesOfClass(MycenafumoonsporeEntity.class, AABB.ofSize(new Vec3(x, y, z), 10, 10, 10), e -> true).isEmpty())) {
