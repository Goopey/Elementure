...
public class Modeldeaths_witness<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition WispBone = partdefinition
				.addOrReplaceChild("WispBone",
						CubeListBuilder.create().texOffs(1800, 1200).addBox(-116.0F, -8.0F, -8.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, -69.2F, 0.0F));
		PartDefinition WispFlame2 = WispBone.addOrReplaceChild("WispFlame2",
				CubeListBuilder.create().texOffs(1700, 1100).addBox(0.0F, -24.0F, -12.0F, 0.0F, 36.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-108.0F, 0.0F, 0.0F));
		PartDefinition WispFlame1 = WispBone.addOrReplaceChild("WispFlame1",
				CubeListBuilder.create().texOffs(1800, 1100).addBox(-12.0F, -24.0F, 0.0F, 24.0F, 36.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-108.0F, 0.0F, 0.0F));
		PartDefinition EyeTop = partdefinition.addOrReplaceChild("EyeTop",
				CubeListBuilder.create().texOffs(300, 760).addBox(-112.0F, 0.0F, 0.0F, 112.0F, 144.0F, 112.0F, new CubeDeformation(0.0F)),
				PartPose.offset(56.0F, -72.0F, -56.0F));
		PartDefinition EyeTopShade = EyeTop.addOrReplaceChild("EyeTopShade",
				CubeListBuilder.create().texOffs(0, 1556).addBox(-112.0F, 0.0F, 0.0F, 112.0F, 144.0F, 72.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 112.0F));
		PartDefinition EyeSide = partdefinition.addOrReplaceChild("EyeSide",
				CubeListBuilder.create().texOffs(0, 512).addBox(-144.0F, 0.0F, 0.0F, 144.0F, 112.0F, 112.0F, new CubeDeformation(0.0F)),
				PartPose.offset(72.0F, -56.0F, -56.0F));
		PartDefinition EyeSideShade = EyeSide.addOrReplaceChild("EyeSideShade",
				CubeListBuilder.create().texOffs(0, 1800).addBox(-144.0F, 0.0F, 0.0F, 144.0F, 112.0F, 72.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 112.0F));
		PartDefinition EyeSideMain = partdefinition.addOrReplaceChild("EyeSideMain",
				CubeListBuilder.create().texOffs(0, 360).addBox(-168.0F, 0.0F, 0.0F, 168.0F, 72.0F, 72.0F, new CubeDeformation(0.0F)),
				PartPose.offset(84.0F, -36.0F, -36.0F));
		PartDefinition EyeBack = partdefinition.addOrReplaceChild("EyeBack",
				CubeListBuilder.create().texOffs(800, 772).addBox(-112.0F, 0.0F, 0.0F, 112.0F, 112.0F, 138.0F, new CubeDeformation(0.0F)),
				PartPose.offset(56.0F, -56.0F, -66.0F));
		PartDefinition EyeBackShade = EyeBack.addOrReplaceChild("EyeBackShade",
				CubeListBuilder.create().texOffs(460, 1800).addBox(-112.0F, 0.0F, 0.0F, 112.0F, 112.0F, 104.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 138.0F));
		PartDefinition EyeBackMain = partdefinition.addOrReplaceChild("EyeBackMain",
				CubeListBuilder.create().texOffs(0, 1080).addBox(-72.0F, 0.0F, 0.0F, 72.0F, 72.0F, 84.0F, new CubeDeformation(0.0F)),
				PartPose.offset(36.0F, -36.0F, 0.0F));
		PartDefinition EyeBackMainShade = EyeBackMain.addOrReplaceChild("EyeBackMainShade",
				CubeListBuilder.create().texOffs(600, 1520).addBox(-72.0F, 0.0F, 0.0F, 72.0F, 72.0F, 120.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 84.0F));
		PartDefinition EyeBackMinor = partdefinition.addOrReplaceChild("EyeBackMinor",
				CubeListBuilder.create().texOffs(512, 256).addBox(-88.0F, 0.0F, 0.0F, 88.0F, 128.0F, 132.0F, new CubeDeformation(0.0F)),
				PartPose.offset(44.0F, -64.0F, -66.0F));
		PartDefinition EyeBackMinorShade = EyeBackMinor.addOrReplaceChild("EyeBackMinorShade",
				CubeListBuilder.create().texOffs(564, 1280).addBox(-88.0F, 0.0F, 0.0F, 88.0F, 128.0F, 84.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 132.0F));
		PartDefinition EyeTopMinor = partdefinition.addOrReplaceChild("EyeTopMinor",
				CubeListBuilder.create().texOffs(688, 540).addBox(-132.0F, 0.0F, 0.0F, 132.0F, 128.0F, 88.0F, new CubeDeformation(0.0F)),
				PartPose.offset(66.0F, -64.0F, -44.0F));
		PartDefinition EyeSideMinor = partdefinition.addOrReplaceChild("EyeSideMinor",
				CubeListBuilder.create().texOffs(0, 1284).addBox(-132.0F, 0.0F, 0.0F, 132.0F, 88.0F, 132.0F, new CubeDeformation(0.0F)),
				PartPose.offset(66.0F, -44.0F, -66.0F));
		PartDefinition EyeSideMinorShade = EyeSideMinor.addOrReplaceChild("EyeSideMinorShade",
				CubeListBuilder.create().texOffs(960, 1284).addBox(-132.0F, 0.0F, 0.0F, 132.0F, 88.0F, 84.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 132.0F));
		PartDefinition EyeBackMMinor1 = partdefinition.addOrReplaceChild("EyeBackMMinor1",
				CubeListBuilder.create().texOffs(1072, 0).addBox(-14.0F, 0.0F, 0.0F, 14.0F, 60.0F, 156.0F, new CubeDeformation(0.0F)),
				PartPose.offset(44.0F, -30.0F, -78.0F));
		PartDefinition EyeBackMMinor2Shade = EyeBackMMinor1.addOrReplaceChild("EyeBackMMinor2Shade",
				CubeListBuilder.create().texOffs(1072, 1800).addBox(-88.0F, 0.0F, 0.0F, 88.0F, 60.0F, 72.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 156.0F));
		PartDefinition EyeBackMMinor2 = partdefinition.addOrReplaceChild("EyeBackMMinor2",
				CubeListBuilder.create().texOffs(1072, 0).addBox(-14.0F, 0.0F, 0.0F, 14.0F, 60.0F, 156.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-30.0F, -30.0F, -78.0F));
		PartDefinition EyeBackMMinor3 = partdefinition.addOrReplaceChild("EyeBackMMinor3",
				CubeListBuilder.create().texOffs(1072, 264).addBox(-60.0F, 0.0F, 0.0F, 60.0F, 14.0F, 156.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, -44.0F, -78.0F));
		PartDefinition EyeBackMMinor1Shade = EyeBackMMinor3.addOrReplaceChild("EyeBackMMinor1Shade",
				CubeListBuilder.create().texOffs(1072, 1600).addBox(-60.0F, 0.0F, 0.0F, 60.0F, 88.0F, 72.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 156.0F));
		PartDefinition EyeBackMMinor4 = partdefinition.addOrReplaceChild("EyeBackMMinor4",
				CubeListBuilder.create().texOffs(1072, 264).addBox(-60.0F, 0.0F, 0.0F, 60.0F, 14.0F, 156.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, 30.0F, -78.0F));
		PartDefinition EyeSideMMinor1 = partdefinition.addOrReplaceChild("EyeSideMMinor1",
				CubeListBuilder.create().texOffs(1480, 0).addBox(-156.0F, 0.0F, 0.0F, 156.0F, 88.0F, 60.0F, new CubeDeformation(0.0F)),
				PartPose.offset(78.0F, -44.0F, -30.0F));
		PartDefinition EyeSideMMinor2 = partdefinition.addOrReplaceChild("EyeSideMMinor2",
				CubeListBuilder.create().texOffs(1480, 856).addBox(-156.0F, 0.0F, 0.0F, 156.0F, 60.0F, 88.0F, new CubeDeformation(0.0F)),
				PartPose.offset(78.0F, -30.0F, -44.0F));
		PartDefinition EyeTopMMinor1 = partdefinition.addOrReplaceChild("EyeTopMMinor1",
				CubeListBuilder.create().texOffs(1548, 256).addBox(-60.0F, 0.0F, 0.0F, 60.0F, 156.0F, 88.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, -78.0F, -44.0F));
		PartDefinition EyeTopMMinor2 = partdefinition.addOrReplaceChild("EyeTopMMinor2",
				CubeListBuilder.create().texOffs(1480, 554).addBox(-88.0F, 0.0F, 0.0F, 88.0F, 156.0F, 60.0F, new CubeDeformation(0.0F)),
				PartPose.offset(44.0F, -78.0F, -30.0F));
		PartDefinition EyeFront1 = partdefinition.addOrReplaceChild("EyeFront1",
				CubeListBuilder.create().texOffs(564, 0).addBox(-26.0F, 0.0F, 0.0F, 26.0F, 112.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(56.0F, -56.0F, -72.0F));
		PartDefinition EyeFront2 = partdefinition.addOrReplaceChild("EyeFront2",
				CubeListBuilder.create().texOffs(450, 0).addBox(-26.0F, 0.0F, 0.0F, 26.0F, 112.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-30.0F, -56.0F, -72.0F));
		PartDefinition EyeFront3 = partdefinition.addOrReplaceChild("EyeFront3",
				CubeListBuilder.create().texOffs(280, 0).addBox(-60.0F, 0.0F, 0.0F, 60.0F, 25.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, -56.0F, -72.0F));
		PartDefinition EyeFront4 = partdefinition.addOrReplaceChild("EyeFront4",
				CubeListBuilder.create().texOffs(140, 0).addBox(-60.0F, 0.0F, 0.0F, 60.0F, 25.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, 31.0F, -72.0F));
		PartDefinition EyeMinor1 = partdefinition.addOrReplaceChild("EyeMinor1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, -30.0F, -72.0F));
		PartDefinition EyeMinor2 = partdefinition.addOrReplaceChild("EyeMinor2",
				CubeListBuilder.create().texOffs(64, 0).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-22.0F, -30.0F, -72.0F));
		PartDefinition EyeMinor3 = partdefinition.addOrReplaceChild("EyeMinor3",
				CubeListBuilder.create().texOffs(0, 64).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-22.0F, 22.0F, -72.0F));
		PartDefinition EyeMinor4 = partdefinition.addOrReplaceChild("EyeMinor4",
				CubeListBuilder.create().texOffs(64, 64).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(30.0F, 22.0F, -72.0F));
		PartDefinition EyeTopMain = partdefinition.addOrReplaceChild("EyeTopMain",
				CubeListBuilder.create().texOffs(0, 772).addBox(-72.0F, 0.0F, 0.0F, 72.0F, 168.0F, 72.0F, new CubeDeformation(0.0F)),
				PartPose.offset(36.0F, -84.0F, -36.0F));
		PartDefinition BottomEyeBoneMain = partdefinition.addOrReplaceChild("BottomEyeBoneMain",
				CubeListBuilder.create().texOffs(0, 120).addBox(-19.0F, -8.0F, -22.0F, 38.0F, 16.0F, 48.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BottomEyeBoneFront = BottomEyeBoneMain.addOrReplaceChild("BottomEyeBoneFront",
				CubeListBuilder.create().texOffs(184, 120).addBox(-12.0F, -8.0F, -48.0F, 24.0F, 16.0F, 48.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BottomEyeBoneFrontTip = BottomEyeBoneFront.addOrReplaceChild("BottomEyeBoneFrontTip",
				CubeListBuilder.create().texOffs(356, 120).addBox(-9.0F, -4.0F, -24.0F, 18.0F, 12.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BottomEyeBoneBack = BottomEyeBoneMain.addOrReplaceChild("BottomEyeBoneBack",
				CubeListBuilder.create().texOffs(0, 232).addBox(-14.0F, -8.0F, 0.0F, 28.0F, 14.0F, 64.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BottomEyeBoneBackTip = BottomEyeBoneBack.addOrReplaceChild("BottomEyeBoneBackTip",
				CubeListBuilder.create().texOffs(178, 232).addBox(-12.0F, -6.0F, 0.0F, 24.0F, 12.0F, 18.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BottomEyeBoneMinor1 = BottomEyeBoneMain.addOrReplaceChild("BottomEyeBoneMinor1",
				CubeListBuilder.create().texOffs(298, 232).addBox(-44.0F, -8.0F, -12.0F, 44.0F, 16.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BottomEyeBoneMinor2 = BottomEyeBoneMain.addOrReplaceChild("BottomEyeBoneMinor2",
				CubeListBuilder.create().texOffs(298, 232).addBox(0.0F, -8.0F, -12.0F, 44.0F, 16.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(15.2F, 0.0F, -5.1F, 0.0F, 0.0F, 0.2731F));
		PartDefinition BottomEyeBoneMinor3 = BottomEyeBoneMinor2.addOrReplaceChild("BottomEyeBoneMinor3",
				CubeListBuilder.create().texOffs(480, 180).addBox(-26.0F, -6.0F, -12.0F, 26.0F, 16.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightEyeBoneFrontTip = RightEyeBoneFront.addOrReplaceChild("RightEyeBoneFrontTip",
				CubeListBuilder.create().texOffs(356, 120).addBox(-9.0F, -6.0F, -24.0F, 18.0F, 12.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.6F, -43.4F, -0.5918F, 0.0F, 0.0F));
		PartDefinition RightEyeBoneBack = RightEyeBoneMain.addOrReplaceChild("RightEyeBoneBack",
				CubeListBuilder.create().texOffs(0, 232).addBox(-14.0F, -8.0F, 0.0F, 28.0F, 14.0F, 64.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 23.0F, 0.1403F, 0.0F, 0.0F));
		PartDefinition RightEyeBoneBackTip = RightEyeBoneBack.addOrReplaceChild("RightEyeBoneBackTip",
				CubeListBuilder.create().texOffs(178, 232).addBox(-12.0F, -6.0F, 0.0F, 24.0F, 12.0F, 18.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 61.2F, 0.3643F, 0.0F, 0.0F));
		...
		PartDefinition RightEyeBoneMinor3 = RightEyeBoneMinor1.addOrReplaceChild("RightEyeBoneMinor3",
				CubeListBuilder.create().texOffs(480, 180).addBox(-26.0F, -8.0F, -12.0F, 26.0F, 16.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftEyeBoneFrontTip = LeftEyeBoneFront.addOrReplaceChild("LeftEyeBoneFrontTip",
				CubeListBuilder.create().texOffs(356, 120).addBox(-9.0F, -6.0F, -24.0F, 18.0F, 12.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.6F, -43.4F, -0.5918F, 0.0F, 0.0F));
		PartDefinition LeftEyeBoneBack = LeftEyeBoneMain.addOrReplaceChild("LeftEyeBoneBack",
				CubeListBuilder.create().texOffs(0, 232).addBox(-14.0F, -8.0F, 0.0F, 28.0F, 14.0F, 64.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 23.0F, 0.1403F, 0.0F, 0.0F));
		PartDefinition LeftEyeBoneBackTip = LeftEyeBoneBack.addOrReplaceChild("LeftEyeBoneBackTip",
				CubeListBuilder.create().texOffs(178, 232).addBox(-12.0F, -6.0F, 0.0F, 24.0F, 12.0F, 18.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 61.2F, 0.3643F, 0.0F, 0.0F));
		...
		PartDefinition LeftEyeBoneMinor2 = LeftEyeBoneMain.addOrReplaceChild("LeftEyeBoneMinor2",
				CubeListBuilder.create().texOffs(298, 232).addBox(0.0F, -8.0F, -12.0F, 44.0F, 16.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(15.2F, 0.0F, -5.1F, 0.0F, 0.0F, -0.2731F));
		PartDefinition TopEyeBoneMain = partdefinition.addOrReplaceChild("TopEyeBoneMain",
				CubeListBuilder.create().texOffs(0, 120).addBox(-19.0F, -8.0F, -22.0F, 38.0F, 16.0F, 48.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition TopEyeBoneMinor3 = TopEyeBoneMinor2.addOrReplaceChild("TopEyeBoneMinor3",
				CubeListBuilder.create().texOffs(480, 180).addBox(-26.0F, -7.0F, -12.0F, 26.0F, 16.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(40.0F, -0.1F, 0.0F, 0.0F, 3.1416F, 0.5166F));
		PartDefinition EyeShine = partdefinition.addOrReplaceChild("EyeShine",
		...
		PartDefinition EyeSLayer1 = EyeShine.addOrReplaceChild("EyeSLayer1",
				CubeListBuilder.create().texOffs(1800, 1800).addBox(-42.0F, -42.0F, 0.0F, 84.0F, 84.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 3.0F));
		PartDefinition EyeSLayer2 = EyeShine.addOrReplaceChild("EyeSLayer2",
				CubeListBuilder.create().texOffs(1600, 1600).addBox(-96.0F, -96.0F, 0.0F, 192.0F, 192.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition EyeSLayer3 = EyeShine.addOrReplaceChild("EyeSLayer3",
				CubeListBuilder.create().texOffs(1800, 1400).addBox(-32.0F, -32.0F, 0.0F, 64.0F, 64.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, -4.0F));
		PartDefinition SkullDeco = partdefinition.addOrReplaceChild("SkullDeco",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition DSkull1 = SkullDeco.addOrReplaceChild("DSkull1",
				CubeListBuilder.create().texOffs(768, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -24.0F, 0.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
