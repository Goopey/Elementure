...
public class PhaseblinkchannelerEntity extends AbstractArrow implements ItemSupplier {
	public PhaseblinkchannelerEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(ElementureModEntities.PHASEBLINKCHANNELER.get(), world);
	}

	public PhaseblinkchannelerEntity(EntityType<? extends PhaseblinkchannelerEntity> type, Level world) {
		super(type, world);
	}

	public PhaseblinkchannelerEntity(EntityType<? extends PhaseblinkchannelerEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public PhaseblinkchannelerEntity(EntityType<? extends PhaseblinkchannelerEntity> type, LivingEntity entity, Level world) {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		PhaseblinkchannelerInvisibleProcedure.execute(entityHitResult.getEntity());
	}
	...
	public static PhaseblinkchannelerEntity shoot(LivingEntity entity, LivingEntity target) {
		PhaseblinkchannelerEntity entityarrow = new PhaseblinkchannelerEntity(ElementureModEntities.PHASEBLINKCHANNELER.get(), entity, entity.level);
