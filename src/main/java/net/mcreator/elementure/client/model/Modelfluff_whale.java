...
public class Modelfluff_whale<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -7.0F, -15.0F, 14.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(37, 11)
		...
		PartDefinition tailtop = partdefinition.addOrReplaceChild("tailtop",
				CubeListBuilder.create().texOffs(79, 0).addBox(-4.0F, -4.0F, -10.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 15.0F, 13.0F));
		PartDefinition tailmid = tailtop.addOrReplaceChild("tailmid",
				CubeListBuilder.create().texOffs(84, 38).addBox(-3.5F, -3.5F, -10.0F, 7.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 6.0F));
		PartDefinition tailend = tailmid.addOrReplaceChild("tailend",
				CubeListBuilder.create().texOffs(104, 52).addBox(-3.0F, -3.0F, -10.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 6.0F));
		PartDefinition tailfin = tailend.addOrReplaceChild("tailfin",
				CubeListBuilder.create().texOffs(92, 0).addBox(0.0F, -8.0F, -10.0F, 0.0F, 16.0F, 18.0F, new CubeDeformation(0.01F)),
				PartPose.offset(0.0F, 0.0F, 6.0F));
		PartDefinition rightfin = partdefinition.addOrReplaceChild("rightfin",
				CubeListBuilder.create().texOffs(38, 52).addBox(-18.0F, 0.0F, -16.0F, 18.0F, 0.0F, 12.0F, new CubeDeformation(0.01F)),
				PartPose.offset(-4.5F, 16.0F, 6.0F));
		PartDefinition leftfin = partdefinition.addOrReplaceChild(
				"leftfin", CubeListBuilder.create().texOffs(38, 52).mirror()
						.addBox(0.0F, 0.0F, -16.0F, 18.0F, 0.0F, 12.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offset(4.5F, 16.0F, 6.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 43).addBox(-4.5F, -13.5F, -9.0F, 9.0F, 9.0F, 12.0F, new CubeDeformation(0.0F)),
