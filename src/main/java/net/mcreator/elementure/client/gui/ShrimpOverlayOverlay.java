...
import net.mcreator.elementure.procedures.ShrimpDisplayProcedure;
...
public class ShrimpOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (ShrimpDisplayProcedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -57, posY + 68 - (int) FishPosReturnProcedure.execute(entity), 0, 0,
						16, 16, 16, 16);
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/shrimp_reinforcements.png"));
