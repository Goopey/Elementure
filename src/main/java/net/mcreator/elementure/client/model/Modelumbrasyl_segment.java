...
public class Modelumbrasyl_segment<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelumbrasyl_segment"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0).addBox(-24.0F, -37.0F, -24.0F, 48.0F, 48.0F, 48.0F, new CubeDeformation(4.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 98).addBox(-20.95F, -42.51F, -46.05F, 10.0F, 6.0F, 54.0F, new CubeDeformation(4.0F))
						.texOffs(0, 98).addBox(-20.95F, -42.5F, -8.05F, 10.0F, 6.0F, 54.0F, new CubeDeformation(4.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(55, 108).addBox(-9.0F, -33.0F, -4.5F, 6.0F, 36.0F, 3.0F, new CubeDeformation(2.0F)),
				PartPose.offsetAndRotation(-30.0F, 0.0F, 0.5F, -1.9635F, -0.4363F, 1.0908F));
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(55, 108).addBox(3.0F, -33.0F, -4.5F, 6.0F, 36.0F, 3.0F, new CubeDeformation(2.0F)),
				PartPose.offsetAndRotation(30.0F, 0.0F, 0.5F, -1.9635F, 0.4363F, -1.0908F));
