...
public class SuitcaseGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SuitcaseGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElementureModMenus.SUITCASE_GUI.get(), id);
