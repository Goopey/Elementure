...
public class DesecratedrelicItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Mini-Boss item : Summons the Statue Protector"));
	}

	@Override
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		DesecratedrelicSummonStatueProtectorProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
