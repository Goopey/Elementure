...
public class ModeldiscardedSkeleton<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modeldiscarded_skeleton"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_tilt = bone.addOrReplaceChild("head_tilt", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -23.0F, 0.5F, 0.0F, 0.0F, -0.1309F));
		PartDefinition head_pivot_bob = head_tilt.addOrReplaceChild("head_pivot_bob", CubeListBuilder.create().texOffs(32, 0).addBox(-3.99F, -8.01F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
