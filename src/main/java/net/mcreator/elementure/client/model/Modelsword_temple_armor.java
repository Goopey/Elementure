...
public class Modelsword_temple_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelsword_temple_armor"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(48, 80).addBox(-3.2F, -2.0F, -2.01F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.2F)).texOffs(0, 123)
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(48, 80).mirror().addBox(-0.8F, -2.0F, -2.01F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.2F))
						.mirror(false).texOffs(0, 123).mirror().addBox(1.9F, -3.0F, -2.01F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false)
						.texOffs(40, 118).mirror().addBox(-1.2F, -3.5F, -2.51F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.2F)).mirror(false),
				PartPose.offset(4.0F, -1.0F, 0.0F));
