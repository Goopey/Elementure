...
public class SpidermatriarchEntity extends Monster {
	public SpidermatriarchEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.SPIDERMATRIARCH.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		SpidermatriarchSpawnSpiderlingsProcedure.execute(this.level, this);
	}
