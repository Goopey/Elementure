...
import net.mcreator.elementure.procedures.SkyjadeaxeTrueAirProcedure;
import net.mcreator.elementure.init.ElementureModTabs;
import net.mcreator.elementure.init.ElementureModItems;

import java.util.List;

public class SkyjadeaxeItem extends AxeItem {
	public SkyjadeaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 459;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			SkyjadeaxeTrueAirProcedure.execute(world, entity);
	}
}
