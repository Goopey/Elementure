...
public class Modelweaklightningandesiteelemental<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "weaklightningandesiteelemental"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hands = partdefinition.addOrReplaceChild("hands",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.0F, -15.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(8, 0)
				.addBox(-1.5F, -10.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
