...
public class NetherquartzchargerEntity extends Monster implements IAnimatable {
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.NETHERQUARTZCHARGER.get(), SpawnPlacements.Type.ON_GROUND,
