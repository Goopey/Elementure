...
public class Modeldragonite_chest_scalemail<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dragonite_chest_scalemail"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(40, 118).mirror()
						.addBox(-3.75F, -2.5F, -2.5F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(48, 80).addBox(-3.2F, -2.0F, -2.011F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.2F)),
				PartPose.offset(-4.0F, -1.0F, 0.0F));

		PartDefinition spike_3_r1 = right_arm.addOrReplaceChild("spike_3_r1",
				CubeListBuilder.create().texOffs(28, 100).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -2.0F, -2.0F, 0.3054F, -0.7854F, -0.4363F));

		PartDefinition spike_2_r1 = right_arm.addOrReplaceChild("spike_2_r1",
				CubeListBuilder.create().texOffs(28, 100).mirror()
		...
		PartDefinition spike_1_r1 = right_arm.addOrReplaceChild("spike_1_r1",
				CubeListBuilder.create().texOffs(28, 100).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(48, 80).mirror()
						.addBox(-0.8F, -2.0F, -2.011F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false)
						.texOffs(40, 118).addBox(0.75F, -2.5F, -2.5F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, -1.0F, 0.0F));
		...
		PartDefinition spike_4_r1 = left_arm
				.addOrReplaceChild("spike_4_r1",
						CubeListBuilder.create().texOffs(28, 100).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(4.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.3491F));

		PartDefinition spike_6_r1 = left_arm.addOrReplaceChild("spike_6_r1",
				CubeListBuilder.create().texOffs(28, 100).mirror()
						.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, -2.0F, -2.0F, 0.3054F, 0.7854F, 0.4363F));
		...
		PartDefinition b_spike_5_r1 = body.addOrReplaceChild("b_spike_5_r1",
				CubeListBuilder.create().texOffs(28, 101).mirror()
		...
		PartDefinition b_spike_4_r1 = body.addOrReplaceChild("b_spike_4_r1",
				CubeListBuilder.create().texOffs(28, 101).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 0.0F, 2.0F, -0.2618F, 0.6109F, 0.0873F));

		PartDefinition b_spike_3_r1 = body
				.addOrReplaceChild("b_spike_3_r1",
						CubeListBuilder.create().texOffs(28, 101).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.0F, 2.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition b_spike_2_r1 = body.addOrReplaceChild("b_spike_2_r1",
				CubeListBuilder.create().texOffs(28, 101).mirror()
						.addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
