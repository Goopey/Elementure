...
import net.mcreator.elementure.procedures.DiseasedcodDisplayProcedure;
...
public class DiseasedcodOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (DiseasedcodDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/diseased_cod.png"));
