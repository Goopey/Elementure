...
import net.mcreator.elementure.procedures.SpiderSwarmerDropsProcedure;
import net.mcreator.elementure.procedures.SpiderSwarmerDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class SpiderSwarmerEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public SpiderSwarmerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.SPIDER_SWARMER.get(), world);
	}

	public SpiderSwarmerEntity(EntityType<SpiderSwarmerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new FollowMobGoal(this, (float) 1, 10, 2));
	...
	public void die(DamageSource source) {
		super.die(source);
		SpiderSwarmerDropsProcedure.execute(this.level, this);
	}

	@Override
	public void playerTouch(Player sourceentity) {
		super.playerTouch(sourceentity);
		SpiderSwarmerDamageProcedure.execute(this, sourceentity);
	}
