...
public class Modelblue_blaze<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelblue_blaze"), "main");
	public final ModelPart rods;
	public final ModelPart bottom_rods;
	public final ModelPart bottom_rods_d;
	public final ModelPart top_rods;
	public final ModelPart top_rods_a;
	public final ModelPart big_rods;
	public final ModelPart big_rod_under_bob;
