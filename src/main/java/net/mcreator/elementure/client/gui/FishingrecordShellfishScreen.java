...
import net.mcreator.elementure.procedures.SpikercrabConfirmProcedure;
import net.mcreator.elementure.procedures.RarewinkleConfirmProcedure;
import net.mcreator.elementure.procedures.PeriwinkleConfirmProcedure;
import net.mcreator.elementure.procedures.GrapplercrabConfirmProcedure;
import net.mcreator.elementure.procedures.DeactivateSlotProcedure;
import net.mcreator.elementure.procedures.BubblecrabConfirmProcedure;
import net.mcreator.elementure.network.FishingrecordShellfishButtonMessage;
...
public class FishingrecordShellfishScreen extends AbstractContainerScreen<FishingrecordShellfishMenu> {
	private final static HashMap<String, Object> guistate = FishingrecordShellfishMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("elementure:textures/screens/fishingrecord_shellfish.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		if (GrapplercrabConfirmProcedure.execute(entity)) {
		...
		if (SpikercrabConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 35, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/spiking_crab.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/shrimp.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 55, 0, 0, 16, 16, 16, 16);

		if (BubblecrabConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 79, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/bubble_crab.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 77, 0, 0, 16, 16, 16, 16);

		if (PeriwinkleConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 101, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/periwinkle.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 99, 0, 0, 16, 16, 16, 16);

		if (RarewinkleConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 123, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/rarewinkle.png"));
