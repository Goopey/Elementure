...
public class Modellargejellyfloat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modellargejellyfloat"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-12.0F, -38.0F, -12.0F, 24.0F, 24.0F, 24.0F, new CubeDeformation(2.0F)).texOffs(0, 48)
		...
		PartDefinition l_wing_r1 = body.addOrReplaceChild("l_wing_r1",
				CubeListBuilder.create().texOffs(92, 0).addBox(-5.5F, -1.0F, -6.0F, 6.0F, 12.0F, 12.0F, new CubeDeformation(2.0F)),
		...
		PartDefinition tentacle_2 = body.addOrReplaceChild("tentacle_2",
				CubeListBuilder.create().texOffs(0, 91).addBox(-6.0F, -1.0F, -3.0F, 5.0F, 32.0F, 5.0F, new CubeDeformation(2.0F)),
		...
		PartDefinition cube_r1 = tentacle_3.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 91).addBox(-2.5F, -17.0F, -2.5F, 5.0F, 32.0F, 5.0F, new CubeDeformation(2.0F)),
