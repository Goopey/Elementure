...
public class Modelmycena_shroom_villager_fisherman<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("elementure", "modelmycena_shroom_villager_fisherman"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rod_mid_r1 = Body.addOrReplaceChild("rod_mid_r1",
				CubeListBuilder.create().texOffs(50, 0).addBox(2.3F, 1.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3F, -5.955F, 2.0F, 0.0F, 0.0F, 0.7854F));
		PartDefinition rod_r1 = Body.addOrReplaceChild("rod_r1",
				CubeListBuilder.create().texOffs(58, 0).addBox(-1.0F, -7.5F, -1.0F, 2.0F, 15.0F, 1.0F, new CubeDeformation(0.0F)),
