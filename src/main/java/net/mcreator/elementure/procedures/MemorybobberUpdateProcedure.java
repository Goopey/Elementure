							...
							if (entity.getPersistentData()
								...
								if (Math.random() < 0.25 + EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FISHING_LUCK,
									...
									if (world instanceof ServerLevel _level)
										_level.sendParticles(ParticleTypes.DRAGON_BREATH, (entity.getX()), (entity.getY()), (entity.getZ()), 50, 0.2,
												0.2, 0.2, 0.3);
									if (world instanceof ServerLevel _level)
										_level.sendParticles((SimpleParticleType) (ElementureModParticleTypes.FISHNOTIFPARTICLE.get()),
												(entity.getX()), (entity.getY()), (entity.getZ()), (int) (5 + Math.random() * 4), 0.2, 0.2, 0.2, 0);
									new Object() {
										private int ticks = 0;
