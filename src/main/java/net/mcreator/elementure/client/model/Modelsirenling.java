...
public class Modelsirenling<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -9.25F, -26.0F, 9.0F, 14.0F, 26.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(5.0F, -8.0F, -18.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).mirror()
						.addBox(-6.0F, -8.0F, -18.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 108)
						.addBox(-8.0F, -12.25F, -7.0F, 17.0F, 20.0F, 0.0F, new CubeDeformation(0.01F)),
		...
		PartDefinition tailtop = tail_rot.addOrReplaceChild(
		...
		PartDefinition tailmid = tailtop.addOrReplaceChild(
				"tailmid", CubeListBuilder.create().texOffs(138, 0).addBox(-5.5F, -4.5F, -1.0F, 11.0F, 8.0F, 14.0F, new CubeDeformation(0.0F))
						.texOffs(148, 29).addBox(-6.0F, -4.0F, -0.99F, 12.0F, 7.0F, 14.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition tailend = tailmid.addOrReplaceChild(
				"tailend", CubeListBuilder.create().texOffs(116, 23).addBox(-4.5F, -3.5F, -1.0F, 9.0F, 6.0F, 9.0F, new CubeDeformation(0.0F))
						.texOffs(110, 45).addBox(-5.0F, -3.0F, -0.99F, 10.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 13.0F));
		PartDefinition tailbit = tailend.addOrReplaceChild("tailbit",
				CubeListBuilder.create().texOffs(214, 21).addBox(-7.0F, 0.0F, 0.0F, 14.0F, 0.0F, 14.0F, new CubeDeformation(0.01F)),
				PartPose.offset(0.0F, -0.5F, 8.0F));
		PartDefinition fin_right = tailbit.addOrReplaceChild(
				"fin_right", CubeListBuilder.create().texOffs(226, 0).mirror()
		...
		PartDefinition fin_right2 = tailbit.addOrReplaceChild("fin_right2",
				CubeListBuilder.create().texOffs(226, 0).addBox(-5.5F, 0.0F, -1.0F, 11.0F, 0.0F, 8.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
