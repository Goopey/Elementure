...
public class Modelcoal_puck<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "coal_puck"), "main");
	private final ModelPart body_whole_pivot;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_whole_pivot = partdefinition.addOrReplaceChild("body_whole_pivot",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(28, 0)
						.addBox(-2.5F, 3.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 0).mirror()
						.addBox(1.5F, 3.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 13).addBox(-3.0F, -1.5F, -3.15F, 6.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
