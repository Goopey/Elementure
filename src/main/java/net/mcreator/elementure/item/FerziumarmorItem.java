...
public abstract class FerziumarmorItem extends ArmorItem {
	public FerziumarmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends FerziumarmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/ferzium__layer_1.png";
		}
	}

	public static class Chestplate extends FerziumarmorItem {
		public Chestplate() {
		...
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			FerziumarmorFullArmorEffectProcedure.execute(world, entity);
		}
	}

	public static class Leggings extends FerziumarmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/ferzium__layer_2.png";
		}
	}

	public static class Boots extends FerziumarmorItem {
		public Boots() {
