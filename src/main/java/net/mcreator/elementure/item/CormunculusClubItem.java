...
public class CormunculusClubItem extends Item implements IAnimatable {
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, CormunculusClubItemRenderer renderer) {
	...
	public void setupAnimationState(CormunculusClubItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
