...
import net.mcreator.elementure.procedures.RedstonefishDisplayProcedure;
...
public class RedstonefishOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (RedstonefishDisplayProcedure.execute(entity)) {
