...
public class Modelthe_nine<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "the_nine"), "main");
	private final ModelPart main;
	private final ModelPart eye_easteregg;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition eye_1 = main.addOrReplaceChild("eye_1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(5.0F, -6.0F, 3.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_2 = main.addOrReplaceChild("eye_2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-7.0F, -8.0F, -1.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_3 = main.addOrReplaceChild("eye_3",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(2.0F, -6.5F, -6.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_4 = main.addOrReplaceChild("eye_4",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -10.5F, 4.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_5 = main.addOrReplaceChild("eye_5",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -10.5F, -8.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_6 = main.addOrReplaceChild("eye_6",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(0.0F, -12.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_7 = main.addOrReplaceChild("eye_7",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(4.0F, -14.5F, -8.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_8 = main.addOrReplaceChild("eye_8",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-7.0F, -15.5F, 2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_9 = main.addOrReplaceChild("eye_9",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -18.5F, -3.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition eye_easteregg = main.addOrReplaceChild("eye_easteregg",
				CubeListBuilder.create().texOffs(56, 0)
						.addBox(0.0F, -3.0F, -2.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 0)
