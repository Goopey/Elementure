...
import net.mcreator.elementure.procedures.NetherstarflareSpawningProcedure;
import net.mcreator.elementure.procedures.Netherstarflare2FlareProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class Netherstarflare2Entity extends PathfinderMob implements IAnimatable {
	...
	public Netherstarflare2Entity(EntityType<Netherstarflare2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		Netherstarflare2FlareProcedure.execute(this.level, this);
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.NETHERSTARFLARE_2.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
				Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
					int x = pos.getX();
					int y = pos.getY();
					int z = pos.getZ();
					return NetherstarflareSpawningProcedure.execute(world, x, z);
				});
	}
