...
public class MycenashroomvillagerblacksmithRenderer extends MobRenderer<MycenashroomvillagerblacksmithEntity, Modelmycena_shroom_villager_blacksmith<MycenashroomvillagerblacksmithEntity>> {
	public MycenashroomvillagerblacksmithRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<MycenashroomvillagerblacksmithEntity, Modelmycena_shroom_villager_blacksmith<MycenashroomvillagerblacksmithEntity>>(this) {
			@Override
