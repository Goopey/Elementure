...
public class Modelmycena_shroom_infected_guard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("elementure", "modelmycena_shroom_infected_guard"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 48).addBox(-1.3F, -12.455F, -1.0F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(45, 60)
		...
		PartDefinition Shroom1 = Body.addOrReplaceChild("Shroom1",
				CubeListBuilder.create().texOffs(18, 1).addBox(0.05F, -2.455F, -1.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4F, -4.0F, -1.5F, -1.2217F, 1.9199F, -0.7854F));
		PartDefinition Shroom2 = Body.addOrReplaceChild("Shroom2",
				CubeListBuilder.create().texOffs(18, 1).addBox(0.2F, -2.455F, -1.75F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.6F, -4.0F, 1.5F, -0.4363F, -1.309F, 0.3491F));
		PartDefinition Shroom3 = Body.addOrReplaceChild("Shroom3",
				CubeListBuilder.create().texOffs(24, 1).addBox(-0.3F, -3.5F, -1.5F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Shroom4 = Body.addOrReplaceChild("Shroom4",
				CubeListBuilder.create().texOffs(18, 1).addBox(0.55F, -2.455F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rLegBone = partdefinition.addOrReplaceChild("rLegBone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -0.99F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 13.0F, 0.0F));
		PartDefinition lLegBone = partdefinition.addOrReplaceChild("lLegBone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.01F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, 13.0F, 0.0F));
