...
import net.mcreator.elementure.procedures.KassemattacksProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class KassemEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public KassemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.KASSEM.get(), world);
	}

	public KassemEntity(EntityType<KassemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void baseTick() {
		super.baseTick();
		KassemattacksProcedure.execute(this);
	}
