...
public class AbyssalplainsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-14811106).waterColor(-16777216).waterFogColor(-16777216).skyColor(-14811106).foliageColorOverride(-13421773).grassColorOverride(-13421773).build();
