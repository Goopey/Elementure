...
public class StatuewraithEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public StatuewraithEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.STATUEWRAITH.get(), world);
	}

	public StatuewraithEntity(EntityType<StatuewraithEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
