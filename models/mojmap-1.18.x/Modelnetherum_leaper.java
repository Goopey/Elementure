...
public class Modelnetherum_leaper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "netherum_leaper"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg_1 = partdefinition.addOrReplaceChild("leg_1", CubeListBuilder.create().texOffs(0, 47).addBox(
				0.0F, -1.0F, -1.0F, 2.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 11.0F, 3.0F));

		PartDefinition leg_2 = partdefinition.addOrReplaceChild("leg_2",
				CubeListBuilder.create().texOffs(0, 47).mirror()
						.addBox(0.0F, -1.0F, -2.0F, 2.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(6.0F, 11.0F, -3.0F));

		PartDefinition leg_3 = partdefinition.addOrReplaceChild("leg_3", CubeListBuilder.create().texOffs(0, 47)
				.addBox(-2.0F, -1.0F, -2.0F, 2.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.0F, 11.0F, -3.0F));

		PartDefinition leg_4 = partdefinition.addOrReplaceChild("leg_4",
				CubeListBuilder.create().texOffs(0, 47).mirror()
						.addBox(-2.0F, -1.0F, -1.0F, 2.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-6.0F, 11.0F, 3.0F));

		PartDefinition leg_5 = partdefinition.addOrReplaceChild("leg_5",
				CubeListBuilder.create().texOffs(0, 47).mirror()
						.addBox(-2.0F, -1.0F, 0.0F, 3.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.0F, 11.0F, 6.0F));

		PartDefinition leg_6 = partdefinition.addOrReplaceChild("leg_6", CubeListBuilder.create().texOffs(0, 47).addBox(
				-1.0F, -1.0F, 0.0F, 3.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 11.0F, 6.0F));

		PartDefinition leg_7 = partdefinition.addOrReplaceChild("leg_7", CubeListBuilder.create().texOffs(0, 47)
				.addBox(-1.0F, -1.0F, -2.0F, 3.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 11.0F, -6.0F));

		PartDefinition leg_8 = partdefinition.addOrReplaceChild("leg_8",
				CubeListBuilder.create().texOffs(0, 47).mirror()
						.addBox(-2.0F, -1.0F, -2.0F, 3.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.0F, 11.0F, -6.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-6.0F, -25.0F, -6.0F, 12.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)),
