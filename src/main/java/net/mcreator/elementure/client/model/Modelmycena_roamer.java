...
public class Modelmycena_roamer<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(42, 57).addBox(-2.5F, -1.75F, -4.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition Shell1 = Shell.addOrReplaceChild("Shell1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -3.0F, -3.5F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition shell7 = Shell1.addOrReplaceChild("shell7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.25F, 3.0F, 6.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Shell2 = Shell.addOrReplaceChild("Shell2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -1.5F, -2.5F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Shell3 = Shell.addOrReplaceChild("Shell3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -1.0F, -2.5F, 7.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 3.0F, -0.1309F, 0.0F, 0.0F));
		PartDefinition Shell4 = Shell3.addOrReplaceChild("Shell4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.49F, -1.75F, -2.25F, 7.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Shell8 = Shell.addOrReplaceChild("Shell8",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.99F, -1.0F, -5.0F, 10.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 1.0F, -0.3491F, 0.0F, 0.0F));
		PartDefinition Shell9 = Shell8.addOrReplaceChild("Shell9",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -1.25F, -4.0F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -3.0F, 0.7854F, 0.0F, 0.0F));
		PartDefinition Shell17 = Shell9.addOrReplaceChild("Shell17",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -0.9F, -1.25F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.25F, -1.75F, 0.0873F, 0.0F, 0.0F));
		PartDefinition Shell18 = Shell9.addOrReplaceChild("Shell18",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.49F, 0.1F, -1.25F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, 3.25F, -0.3054F, 0.0F, 0.0F));
		PartDefinition Shell10 = Shell8.addOrReplaceChild("Shell10",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.51F, -1.0F, -5.75F, 9.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.25F, 1.5F, 0.0436F, 0.0F, 0.0F));
		PartDefinition Shell11 = Shell8.addOrReplaceChild("Shell11",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -0.75F, -5.0F, 8.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, 1.5F, -0.0873F, 0.0F, 0.0F));
		PartDefinition Shell13 = Shell8.addOrReplaceChild("Shell13",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -1.5F, -3.5F, 7.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, 1.5F, -0.2618F, 0.0F, 0.0F));
		PartDefinition Shell14 = Shell8.addOrReplaceChild("Shell14",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.25F, -2.5F, 6.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, 1.5F, -0.3927F, 0.0F, 0.0F));
		PartDefinition Shell15 = Shell8.addOrReplaceChild("Shell15",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -3.25F, -1.5F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, 1.5F, -0.5236F, 0.0F, 0.0F));
		PartDefinition Shell16 = Shell8.addOrReplaceChild("Shell16",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -4.65F, -1.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, 1.5F, -0.7854F, 0.0F, 0.0F));
		PartDefinition rLeg1 = partdefinition.addOrReplaceChild("rLeg1",
				CubeListBuilder.create().texOffs(54, 49).addBox(-1.0F, -0.5F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 21.25F, -0.5F, 0.0F, 0.4363F, 0.0F));
		PartDefinition rLeg1_2 = rLeg1.addOrReplaceChild("rLeg1_2",
				CubeListBuilder.create().texOffs(54, 49).addBox(-1.0F, -0.65F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rLeg1_3 = rLeg1_2.addOrReplaceChild("rLeg1_3",
				CubeListBuilder.create().texOffs(54, 49).addBox(-0.5F, -0.3F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition lLeg1 = partdefinition.addOrReplaceChild("lLeg1",
				CubeListBuilder.create().texOffs(54, 33).addBox(0.0F, -0.5F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 21.25F, -0.5F, 0.0F, -0.4363F, 0.0F));
		PartDefinition lLeg1_2 = lLeg1.addOrReplaceChild("lLeg1_2",
				CubeListBuilder.create().texOffs(54, 33).addBox(0.0F, -0.65F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, -0.3054F, -0.2182F, 0.2618F));
		PartDefinition lLeg1_3 = lLeg1_2.addOrReplaceChild("lLeg1_3",
				CubeListBuilder.create().texOffs(54, 33).addBox(-0.5F, -0.3F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 1.25F, 0.0F, 0.6109F, 0.4363F, 0.2618F));
		PartDefinition lLeg2 = partdefinition.addOrReplaceChild("lLeg2",
				CubeListBuilder.create().texOffs(58, 40).addBox(0.0F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 22.5F, -0.5F, 0.0F, -0.0873F, 0.0F));
		PartDefinition lLeg2_2 = lLeg2.addOrReplaceChild("lLeg2_2",
				CubeListBuilder.create().texOffs(58, 40).addBox(-0.5F, -0.5F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rLeg2 = partdefinition.addOrReplaceChild("rLeg2",
				CubeListBuilder.create().texOffs(58, 44).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 22.5F, -0.5F, 0.0F, 0.0873F, 0.0F));
		PartDefinition rLeg2_2 = rLeg2.addOrReplaceChild("rLeg2_2",
				CubeListBuilder.create().texOffs(58, 44).addBox(-1.0F, -0.5F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
