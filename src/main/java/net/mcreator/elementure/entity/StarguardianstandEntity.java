...
import net.mcreator.elementure.procedures.StarguardianstandChecksProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

import java.util.List;

public class StarguardianstandEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public StarguardianstandEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.STARGUARDIANSTAND.get(), world);
	}

	public StarguardianstandEntity(EntityType<StarguardianstandEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 0, (float) 2, false));
	...
	public void baseTick() {
		super.baseTick();
		StarguardianstandChecksProcedure.execute(this.level, this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		StarguardianstandEntity retval = ElementureModEntities.STARGUARDIANSTAND.get().create(serverWorld);
