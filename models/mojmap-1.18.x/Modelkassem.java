...
public class Modelkassem<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "kassem"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-3.5F, -3.0F, -3.0F, 7.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 13)
		...
		PartDefinition hat_r1 = head.addOrReplaceChild("hat_r1",
				CubeListBuilder.create().texOffs(5, 11).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F,
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create()
				.texOffs(38, 33).addBox(-2.0F, -3.0F, -9.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 4.0F, 0.0F));

		PartDefinition staff_r1 = right_arm.addOrReplaceChild("staff_r1",
				CubeListBuilder.create().texOffs(60, 23).addBox(-0.5F, -10.0F, -0.5F, 1.0F, 20.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 44)
						...
						.addBox(-7.0F, -21.01F, -2.5F, 14.0F, 20.0F, 5.0F, new CubeDeformation(0.0F)),
