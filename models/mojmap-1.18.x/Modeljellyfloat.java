...
public class Modeljellyfloat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "jellyfloat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-12.0F, -32.0F, -12.0F, 24.0F, 24.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(0, 48)
		...
		PartDefinition tentacle_2 = body.addOrReplaceChild("tentacle_2", CubeListBuilder.create().texOffs(0, 91)
				.addBox(-4.0F, -1.0F, -1.0F, 5.0F, 32.0F, 5.0F, new CubeDeformation(0.0F)),
