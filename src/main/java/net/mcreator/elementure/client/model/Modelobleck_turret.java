...
public class Modelobleck_turret<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main_head = partdefinition.addOrReplaceChild("main_head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -9.5F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)),
		...
		PartDefinition ear_top_side_1 = ears_1.addOrReplaceChild("ear_top_side_1",
				CubeListBuilder.create().texOffs(0, 17).mirror().addBox(-1.0F, -4.0F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F))
						.mirror(false).texOffs(1, 22).mirror().addBox(-0.5F, -4.25F, -2.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(1.0F))
						.mirror(false),
		...
		PartDefinition ear_top_side_2 = ears_1.addOrReplaceChild("ear_top_side_2",
				CubeListBuilder.create().texOffs(0, 17).addBox(-1.0F, -7.0F, -3.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).texOffs(1, 22)
		...
		PartDefinition ear_top_side_3 = ears_2.addOrReplaceChild("ear_top_side_3",
				CubeListBuilder.create().texOffs(0, 17).mirror().addBox(-1.0F, -4.0F, -2.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F))
						.mirror(false).texOffs(1, 22).mirror().addBox(-0.5F, -4.25F, -1.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(1.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.0F, -4.5F, 1.5F, 1.0908F, 3.1416F, 0.0F));
		PartDefinition ear_top_side_4 = ears_2.addOrReplaceChild("ear_top_side_4",
				CubeListBuilder.create().texOffs(0, 17).addBox(-1.0F, -7.0F, -4.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).texOffs(1, 22)
		...
		PartDefinition r_arm1 = bottom_arms.addOrReplaceChild("r_arm1",
				CubeListBuilder.create().texOffs(78, 0).addBox(-8.0F, -0.5F, 3.0F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(78, 21)
						...
						.addBox(-4.49F, 15.5F, 4.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33).addBox(-6.5F, 15.5F, 2.49F, 2.0F,
		...
		PartDefinition r_arm3 = bottom_arms.addOrReplaceChild("r_arm3",
				CubeListBuilder.create().texOffs(78, 0).addBox(-8.0F, -0.5F, -8.0F, 5.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(78, 21)
						...
						.addBox(-4.49F, 15.5F, -6.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33).addBox(-6.5F, 15.5F, -4.51F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, 0.0F, -0.0873F));
