...
import net.mcreator.elementure.procedures.DiversalloyswordHarvestProcedure;
import net.mcreator.elementure.init.ElementureModTabs;
import net.mcreator.elementure.init.ElementureModItems;

import java.util.List;

public class DiversalloyswordItem extends SwordItem {
	public DiversalloyswordItem() {
		super(new Tier() {
			public int getUses() {
				return 459;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		DiversalloyswordHarvestProcedure.execute(entity, sourceentity, itemstack);
		return retval;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			DiversalloyswordTrueAirProcedure.execute(entity);
	}
}
