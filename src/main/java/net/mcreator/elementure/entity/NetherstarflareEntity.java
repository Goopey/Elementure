...
public class NetherstarflareEntity extends PathfinderMob implements IAnimatable {
	...
	public NetherstarflareEntity(EntityType<NetherstarflareEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		NetherstarflareFlareProcedure.execute(this.level, this);
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.NETHERSTARFLARE.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
