...
import net.mcreator.elementure.procedures.WindyshoresflareSpawnProcedure;
import net.mcreator.elementure.procedures.WindyshoresflareFlareProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class WindyshoreFlare1Entity extends PathfinderMob implements IAnimatable {
	...
	public WindyshoreFlare1Entity(EntityType<WindyshoreFlare1Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		WindyshoresflareFlareProcedure.execute(this.level, this);
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.WINDYSHORE_FLARE_1.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
				Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
					int x = pos.getX();
					int y = pos.getY();
					int z = pos.getZ();
					return WindyshoresflareSpawnProcedure.execute(world, x, y, z);
				});
	}
