...
public class PinkrimeshineItem extends Item {
	public PinkrimeshineItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Pink rimeshine. The STRONGEST rimeshine. Makes you and everyone around you dizzy. Also summons a fog."));
	}
