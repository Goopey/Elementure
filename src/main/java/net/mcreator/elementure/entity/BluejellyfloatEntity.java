...
public class BluejellyfloatEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.WATER_CREATURE)
				.add(new MobSpawnSettings.SpawnerData(ElementureModEntities.BLUEJELLYFLOAT.get(), 80, 2, 4));
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.BLUEJELLYFLOAT.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
