...
public class MycenainfectedshroomguardEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ElementureModEntities.MYCENAINFECTEDSHROOMGUARD.get(), 140, 4, 4));
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.MYCENAINFECTEDSHROOMGUARD.get(), SpawnPlacements.Type.ON_GROUND,
