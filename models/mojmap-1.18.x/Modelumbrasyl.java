...
public class Modelumbrasyl<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "umbrasyl"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(406, 232)
						.addBox(-40.0F, -19.0F, 15.0F, 80.0F, 30.0F, 40.0F, new CubeDeformation(0.0F)).texOffs(411, 243)
						.addBox(-40.0F, -54.0F, 27.0F, 80.0F, 20.0F, 34.0F, new CubeDeformation(0.0F)).texOffs(746, 205)
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(768, 0).addBox(-37.0F, -15.0F, -27.0F, 74.0F, 37.0F, 54.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 25.0F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(487, 0).addBox(-5.0F, -10.0F, -10.0F, 12.0F, 12.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(487, 0).addBox(-11.0F, -3.0F, 6.0F, 12.0F, 12.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(35.0F, -12.0F, -20.0F, 0.0F, 0.0F, 1.0472F));

		PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(487, 0).addBox(-11.0F, -3.0F, -10.0F, 12.0F, 12.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(33.0F, -10.0F, -22.0F, 0.0F, 0.0F, 1.0472F));

		PartDefinition cube_r6 = head.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(487, 0).addBox(-9.0F, -10.0F, -10.0F, 12.0F, 12.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = head.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(487, 0).addBox(-11.0F, -6.0F, -10.0F, 12.0F, 12.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(33.0F, 23.0F, -22.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition cube_r9 = head.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(487, 0).addBox(-11.0F, -6.0F, 6.0F, 12.0F, 12.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(35.0F, 21.0F, -20.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition cube_r10 = head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(746, 0).addBox(-19.5F, -16.0F, -8.5F, 39.0F, 32.0F, 16.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = head.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(487, 0).addBox(-6.0F, -26.0F, -5.0F, 12.0F, 56.0F, 14.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = head.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(487, 0).addBox(-6.0F, -33.0F, -11.0F, 12.0F, 40.0F, 14.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 33.0F, -50.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition cube_r15 = head.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(746, 0)
						.addBox(-18.0F, 0.0F, -38.0F, 36.0F, 24.0F, 72.0F, new CubeDeformation(0.0F)).texOffs(746, 0)
						.addBox(-24.0F, -16.0F, -51.0F, 48.0F, 18.0F, 17.0F, new CubeDeformation(0.0F)).texOffs(746, 0)
						.addBox(-31.0F, -16.0F, -34.0F, 62.0F, 32.0F, 46.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 22.0F, -9.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r16 = head.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(746, 0).addBox(-20.0F, -27.0F, 27.0F, 40.0F, 26.0F, 66.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -20.5F, -30.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r17 = head.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(746, 0).addBox(-16.0F, -18.0F, -35.0F, 32.0F, 26.0F, 67.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -20.5F, -30.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r18 = head.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(487, 0).addBox(-6.0F, -19.0F, -6.0F, 12.0F, 32.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = head.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(487, 0).addBox(-6.0F, -15.0F, -6.0F, 12.0F, 32.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = head.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(746, 0).addBox(-36.0F, -16.51F, -18.0F, 47.0F, 22.0F, 32.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = head.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(406, 232).addBox(-5.0F, -11.0F, -17.0F, 12.0F, 22.0F, 50.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(37.0F, -4.0F, 47.0F, 0.0F, 0.3491F, 0.0F));

		PartDefinition cube_r28 = head.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(406, 232).mirror()
		...
		PartDefinition cube_r31 = head.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(406, 232).addBox(-12.0F, -9.0F, -29.0F, 16.0F, 16.0F, 60.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r32 = head.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(406, 232).addBox(9.0F, 3.0F, -17.0F, 20.0F, 20.0F, 68.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r33 = head.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(406, 232).addBox(-10.0F, -10.0F, -17.0F, 20.0F, 20.0F, 68.0F,
						new CubeDeformation(0.0F)),
