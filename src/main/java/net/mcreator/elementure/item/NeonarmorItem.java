...
import net.mcreator.elementure.procedures.NeonarmorFullArmorBonusProcedure;
...
public abstract class NeonarmorItem extends ArmorItem {
	...
	public static class Helmet extends NeonarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/neon__layer_1.png";
		}
	}
	...
	public static class Chestplate extends NeonarmorItem {
		...
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			NeonarmorFullArmorBonusProcedure.execute(entity);
		}
	}
	...
	public static class Leggings extends NeonarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/neon__layer_2.png";
		}
	}
