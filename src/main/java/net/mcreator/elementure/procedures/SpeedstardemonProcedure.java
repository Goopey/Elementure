...
public class SpeedstardemonProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		world.setBlock(new BlockPos(x, y + 1, z), ElementureModBlocks.SPEEDSTAR.get().defaultBlockState(), 3);
		...
		entity.getPersistentData().putBoolean("speedstaractivation", (true));
