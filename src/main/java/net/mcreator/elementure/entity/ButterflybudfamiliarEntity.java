...
public class ButterflybudfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public ButterflybudfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.BUTTERFLYBUDFAMILIAR.get(), world);
	}

	public ButterflybudfamiliarEntity(EntityType<ButterflybudfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ButterflybudfamiliarEntity retval = ElementureModEntities.BUTTERFLYBUDFAMILIAR.get().create(serverWorld);
