...
public class Modelglassbellboat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "glassbellboat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 18)
				.addBox(-12.0F, -1.0F, -25.0F, 24.0F, 9.0F, 50.0F, new CubeDeformation(0.0F)).texOffs(86, 77)
				...
				.addBox(17.0F, -2.0F, -10.0F, 12.0F, 12.0F, 52.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(128, 0).addBox(-29.0F, -2.0F, -10.0F, 12.0F, 12.0F, 52.0F, new CubeDeformation(0.0F))
				.texOffs(216, 0).addBox(-15.0F, 7.0F, -36.0F, 6.0F, 6.0F, 14.0F, new CubeDeformation(0.0F))
				.texOffs(216, 0).mirror().addBox(9.0F, 7.0F, -36.0F, 6.0F, 6.0F, 14.0F, new CubeDeformation(0.0F))
