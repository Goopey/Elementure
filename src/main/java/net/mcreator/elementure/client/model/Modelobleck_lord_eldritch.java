...
public class Modelobleck_lord_eldritch<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelobleck_lord_eldritch"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arm_bottom_r22_r1 = r_arm5.addOrReplaceChild("arm_bottom_r22_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(8.49F, 44.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(4.51F, 39.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(78, 0).addBox(5.5F, 28.0F, 3.51F, 5.0F,
		...
		PartDefinition arm_bottom_r21_r1 = r_arm4.addOrReplaceChild("arm_bottom_r21_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(8.49F, 37.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(4.51F, 32.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(78, 0).addBox(5.5F, 21.0F, 3.5F, 5.0F, 16.0F,
		...
		PartDefinition arm_bottom_r20_r1 = r_arm3.addOrReplaceChild("arm_bottom_r20_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(10.49F, 35.5F, 1.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(6.51F, 30.0F, 1.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(78, 0).addBox(7.5F, 19.0F, 1.5F, 5.0F, 16.0F,
								5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition arm_bottom_l9_r1 = l_arm2.addOrReplaceChild("arm_bottom_l9_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(-0.49F, 42.5F, -0.49F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(3.51F, 34.0F, 1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 21).mirror()
						.addBox(-0.51F, 37.0F, -1.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(78, 0).mirror()
		...
		PartDefinition arm_bottom_l8_r1 = l_arm1.addOrReplaceChild("arm_bottom_l8_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(-3.49F, 42.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(0.51F, 34.0F, 5.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 21).mirror()
						.addBox(-3.51F, 37.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(78, 0).mirror()
		...
		PartDefinition arm_bottom_r19_r1 = r_arm2.addOrReplaceChild("arm_bottom_r19_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(2.49F, 42.5F, -2.49F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(-1.49F, 37.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(78, 0).addBox(-0.5F, 26.0F, -2.5F, 5.0F,
								16.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition arm_bottom_r18_r1 = r_arm1.addOrReplaceChild("arm_bottom_r18_r1",
				CubeListBuilder.create().texOffs(78, 33).addBox(1.49F, 42.5F, 3.51F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 33)
						...
						.addBox(-2.49F, 37.0F, 3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(78, 0).addBox(-1.5F, 26.0F, 3.5F, 5.0F,
								16.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -25.0F, -6.0F, 0.0F, 0.0F, 0.0436F));
		PartDefinition ear_top = partdefinition.addOrReplaceChild("ear_top",
				CubeListBuilder.create().texOffs(0, 17).addBox(-1.5F, -1.25F, -5.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)),
		...
		PartDefinition spike_top2_r1 = ear_top.addOrReplaceChild("spike_top2_r1",
				CubeListBuilder.create().texOffs(1, 22).addBox(-0.5F, -0.51F, 0.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(1.0F)).texOffs(0, 26)
		...
		PartDefinition ear_top_right2 = partdefinition.addOrReplaceChild("ear_top_right2",
				CubeListBuilder.create().texOffs(0, 17).addBox(1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).texOffs(1, 22)
		...
		PartDefinition ear_top_right = partdefinition.addOrReplaceChild("ear_top_right",
				CubeListBuilder.create().texOffs(0, 17).mirror().addBox(-3.0F, 0.0F, 0.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false)
						.texOffs(1, 22).mirror().addBox(-2.75F, -0.25F, 1.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(1.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 14.0F, 1.5F, 0.7854F, -0.2182F, -0.3054F));
		PartDefinition back_ear_left = partdefinition.addOrReplaceChild("back_ear_left",
				CubeListBuilder.create().texOffs(13, 23).addBox(0.0F, 0.5F, -2.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(1.0F)).texOffs(0, 22)
						.addBox(0.5F, 0.75F, 0.75F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).texOffs(0, 22)
						.addBox(0.51F, 2.25F, 2.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).texOffs(28, 16).addBox(0.49F, 3.75F, 0.25F, 1.0F,
		...
		PartDefinition spike_left_side_r1 = back_ear_left.addOrReplaceChild("spike_left_side_r1",
				CubeListBuilder.create().texOffs(0, 22).addBox(0.5F, 0.75F, 0.75F, 1.0F, 1.0F, 6.0F, new CubeDeformation(1.0F)),
		...
		PartDefinition back_ear_right = partdefinition.addOrReplaceChild("back_ear_right",
				CubeListBuilder.create().texOffs(13, 23).mirror().addBox(-2.0F, 0.5F, -2.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(1.0F))
						.mirror(false).texOffs(0, 22).mirror().addBox(-1.5F, 0.75F, 0.75F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).mirror(false)
						.texOffs(0, 22).mirror().addBox(-1.51F, 2.25F, 2.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(1.0F)).mirror(false)
						.texOffs(28, 16).mirror().addBox(-1.49F, 3.75F, 0.25F, 1.0F, 1.0F, 8.0F, new CubeDeformation(1.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.0F, 13.5F, 1.5F, -0.0873F, -0.2618F, 0.2182F));
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild(
				"bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -9.5F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F))
						.texOffs(25, 0).addBox(-3.0F, -8.0F, -4.75F, 6.0F, 6.0F, 1.0F, new CubeDeformation(1.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition back_spike_right_r1 = bb_main.addOrReplaceChild("back_spike_right_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 2.0F, -0.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(1.0F)),
		...
		PartDefinition back_spike_left_r1 = bb_main.addOrReplaceChild("back_spike_left_r1",
				CubeListBuilder.create().texOffs(32, 8).addBox(-2.5F, 2.0F, 1.5F, 1.0F, 1.0F, 6.0F, new CubeDeformation(1.0F)),
		...
		PartDefinition side_spike_right_r1 = bb_main.addOrReplaceChild("side_spike_right_r1",
				CubeListBuilder.create().texOffs(32, 8).mirror().addBox(1.5F, 2.0F, 1.5F, 1.0F, 1.0F, 6.0F, new CubeDeformation(1.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.0F, -6.0F, 0.0F, 0.0436F, -0.3491F, -0.1309F));
