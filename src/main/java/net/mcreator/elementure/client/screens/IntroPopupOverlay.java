...
public class IntroPopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (IntrothemepopupConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.intro_popup.label_intro"), posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.intro_popup.label_byc418"), posX + -198, posY + -108, -203);
		}
