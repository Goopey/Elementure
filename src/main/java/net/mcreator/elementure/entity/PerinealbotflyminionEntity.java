...
import net.mcreator.elementure.procedures.PerinealbotflyRegisterPlayerProcedure;
import net.mcreator.elementure.procedures.PerinealbotflyCheckPlayerProcedure;
...
public class PerinealbotflyminionEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public PerinealbotflyminionEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.PERINEALBOTFLYMINION.get(), world);
	}

	public PerinealbotflyminionEntity(EntityType<PerinealbotflyminionEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1, (float) 6, (float) 2, false));
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		PerinealbotflyRegisterPlayerProcedure.execute(world, this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		PerinealbotflyCheckPlayerProcedure.execute(this.level, this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		PerinealbotflyminionEntity retval = ElementureModEntities.PERINEALBOTFLYMINION.get().create(serverWorld);
