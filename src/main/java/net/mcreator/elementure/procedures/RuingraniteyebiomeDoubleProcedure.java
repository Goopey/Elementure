		...
		for (int index0 = 0; index0 < (int) (15625); index0++) {
			if (CoordsX * CoordsX + CoordsY * CoordsY + CoordsZ * CoordsZ <= 144) {
				if ((world.getBlockState(new BlockPos(x + CoordsX, y + CoordsY, z + CoordsZ)))
					...
					if (CoordsX * CoordsX + CoordsY * CoordsY + CoordsZ * CoordsZ >= 124
							|| CoordsX * CoordsX + CoordsY * CoordsY + CoordsZ * CoordsZ <= 44) {
					...
					} else if (CoordsX * CoordsX + CoordsY * CoordsY + CoordsZ * CoordsZ < 124
							&& CoordsX * CoordsX + CoordsY * CoordsY + CoordsZ * CoordsZ >= 134) {
