...
public class NetherstarthemePopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (NetherstarConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), "Rebel Base 1", posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), "From:Crusaders", posX + -198, posY + -108, -203);
		}
