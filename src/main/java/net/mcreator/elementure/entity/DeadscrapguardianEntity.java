...
import net.mcreator.elementure.procedures.ScrapguardianRegenProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class DeadscrapguardianEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public DeadscrapguardianEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.DEADSCRAPGUARDIAN.get(), world);
	}

	public DeadscrapguardianEntity(EntityType<DeadscrapguardianEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		ScrapguardianRegenProcedure.execute(this.level, this);
	}
