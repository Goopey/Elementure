...
public class HiddenrunesfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public HiddenrunesfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.HIDDENRUNESFAMILIAR.get(), world);
	}

	public HiddenrunesfamiliarEntity(EntityType<HiddenrunesfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HiddenrunesfamiliarEntity retval = ElementureModEntities.HIDDENRUNESFAMILIAR.get().create(serverWorld);
