...
public class Modelfirebolt<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "firebolt"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail_r1 = main_body.addOrReplaceChild("tail_r1",
				CubeListBuilder.create().texOffs(0, 8).addBox(-0.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F,
		...
		PartDefinition mid_r1 = main_body.addOrReplaceChild("mid_r1",
				CubeListBuilder.create().texOffs(20, 0)
						.addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 10)
						.addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(20, 6)
						.addBox(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition front_2_r1 = main_body.addOrReplaceChild("front_2_r1",
				CubeListBuilder.create().texOffs(9, 4)
						.addBox(-1.0F, -1.0F, -1.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(9, 0)
