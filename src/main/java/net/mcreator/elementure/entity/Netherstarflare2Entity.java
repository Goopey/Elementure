...
public class Netherstarflare2Entity extends PathfinderMob {
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.NETHERSTARFLARE_2.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
