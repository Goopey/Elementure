...
public class ElementureModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(ModeloceanAngel.LAYER_LOCATION, ModeloceanAngel::createBodyLayer);
		...
		event.registerLayerDefinition(ModelslumberingGeneral.LAYER_LOCATION, ModelslumberingGeneral::createBodyLayer);
