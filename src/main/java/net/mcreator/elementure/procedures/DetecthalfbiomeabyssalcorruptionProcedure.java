...
public class DetecthalfbiomeabyssalcorruptionProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double z, Entity entity) {
		...
		if (!((entity instanceof Player _playerHasItem
				? _playerHasItem.getInventory().contains(new ItemStack(ElementureModItems.ABYSSALEMBLEM.get()))
				: false)
				|| (entity instanceof Player _playerHasItem
						? _playerHasItem.getInventory().contains(new ItemStack(ElementureModItems.ABYSSALMEDALION.get()))
						: false)
				|| (entity instanceof Player _playerHasItem
						? _playerHasItem.getInventory().contains(new ItemStack(ElementureModItems.ABYSSALTROPHY.get()))
						: false)
				|| (entity instanceof Player _playerHasItem
						? _playerHasItem.getInventory().contains(new ItemStack(ElementureModItems.ABYSSALOATHBLADE.get()))
						: false)
				|| (entity instanceof Player _playerHasItem
						? _playerHasItem.getInventory().contains(new ItemStack(ElementureModItems.ABYSSALSIGIL.get()))
						: false))) {
			while (CoordsY < 257) {
		...
		if (entity instanceof Player _playerHasItem
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
					.getItem() == ElementureModItems.ABYSSALOATHBLADE.get()) {
				while (CoordsY < 257) {
					if ((world.getBlockState(new BlockPos(x - 0.5, CoordsY, z))).getBlock() == ElementureModBlocks.ABYSSALCORRUPTION.get()) {
						if (entity instanceof LivingEntity _entity)
