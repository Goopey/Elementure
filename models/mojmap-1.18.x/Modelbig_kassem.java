...
public class Modelbig_kassem<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "big_kassem"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-3.5F, -7.0F, -3.0F, 7.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 13)
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create()
				.texOffs(38, 112).addBox(-2.0F, -4.0F, -10.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.0F, 1.0F, 0.0F));

		PartDefinition staff_r1 = right_arm.addOrReplaceChild("staff_r1",
				CubeListBuilder.create().texOffs(60, 101).addBox(-0.5F, -12.0F, -0.5F, 1.0F, 26.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 44)
						.addBox(-5.0F, -25.0F, -2.0F, 10.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(18, 68)
						.addBox(-9.0F, -25.01F, -2.5F, 18.0F, 22.0F, 5.0F, new CubeDeformation(0.0F)),
