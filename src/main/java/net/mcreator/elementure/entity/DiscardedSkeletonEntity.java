...
import net.mcreator.elementure.procedures.DiscardedSkeletonSpawnHeadHostProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class DiscardedSkeletonEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public DiscardedSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.DISCARDED_SKELETON.get(), world);
	}

	public DiscardedSkeletonEntity(EntityType<DiscardedSkeletonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	}
	...
	public void baseTick() {
		super.baseTick();
		DiscardedSkeletonSpawnHeadHostProcedure.execute(this.level, this);
	}
