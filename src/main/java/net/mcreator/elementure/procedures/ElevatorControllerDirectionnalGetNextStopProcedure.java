...
public class ElevatorControllerDirectionnalGetNextStopProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		mult = 1;
		while (mult <= 256) {
			if ((world.getBlockState(new BlockPos(x + locX * mult, y + locY * mult, z + locZ * mult))).is(BlockTags.create(new ResourceLocation("elementure:directionnal_elevator_controllers"))) && (new Object() {
				public Direction getDirection(BlockState _bs) {
					Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
					if (_prop instanceof DirectionProperty _dp)
						return _bs.getValue(_dp);
				...
				return (x + locX * mult) + "+" + (y + locY * mult) + "+" + (z + locZ * mult) + (new Object() {
					public Direction getDirection(BlockState _bs) {
						Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
						if (_prop instanceof DirectionProperty _dp)
							return _bs.getValue(_dp);
