...
public class DeathswitnessEntity extends Monster implements IAnimatable {
	...
	public DeathswitnessEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.DEATHSWITNESS.get(), world);
	}

	public DeathswitnessEntity(EntityType<DeathswitnessEntity> type, Level world) {
		super(type, world);
		xpReward = 200;
		setNoAi(false);
