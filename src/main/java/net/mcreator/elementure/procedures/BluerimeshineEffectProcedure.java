...
public class BluerimeshineEffectProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (itemstack.getItem() == ElementureModItems.RAREBLUERIMESHINE.get() || itemstack.getItem() == ElementureModItems.BLUERIMESHINE.get()) {
