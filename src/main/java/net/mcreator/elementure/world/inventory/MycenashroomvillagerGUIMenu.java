...
import net.mcreator.elementure.network.MycenashroomvillagerGUISlotMessage;
...
public class MycenashroomvillagerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MycenashroomvillagerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElementureModMenus.MYCENASHROOMVILLAGER_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ElementureMod.PACKET_HANDLER.sendToServer(new MycenashroomvillagerGUISlotMessage(slotid, x, y, z, ctype, meta));
			MycenashroomvillagerGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof MycenashroomvillagerGUIMenu) {
