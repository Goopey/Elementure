...
public class CosmicslimefamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public CosmicslimefamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.COSMICSLIMEFAMILIAR.get(), world);
	}

	public CosmicslimefamiliarEntity(EntityType<CosmicslimefamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CosmicslimefamiliarEntity retval = ElementureModEntities.COSMICSLIMEFAMILIAR.get().create(serverWorld);
