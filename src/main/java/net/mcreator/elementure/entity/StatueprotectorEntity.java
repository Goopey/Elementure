...
import net.mcreator.elementure.procedures.StatueprotectorDropsProcedure;
import net.mcreator.elementure.procedures.StatueprotectorAttackMasterProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class StatueprotectorEntity extends Monster implements IAnimatable {
	...
	public StatueprotectorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.STATUEPROTECTOR.get(), world);
	}

	public StatueprotectorEntity(EntityType<StatueprotectorEntity> type, Level world) {
		super(type, world);
		xpReward = 17;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		StatueprotectorDropsProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void baseTick() {
		super.baseTick();
		StatueprotectorAttackMasterProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
