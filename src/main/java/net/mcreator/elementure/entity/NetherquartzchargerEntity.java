...
public class NetherquartzchargerEntity extends Monster {
	...
	public NetherquartzchargerEntity(EntityType<NetherquartzchargerEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.NETHERQUARTZCHARGER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 0.30000000000000004);
		return builder;
	}
}
