...
public class Modelostrachain<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mouth_r1 = mask.addOrReplaceChild("mouth_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 3.9469F, -15.3764F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.0F, 1.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition mask_2_r1 = mask.addOrReplaceChild("mask_2_r1",
				CubeListBuilder.create().texOffs(50, 0).addBox(-5.4945F, 1.4235F, -9.5168F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.5236F, 0.0F));
		PartDefinition mask_1_r1 = mask.addOrReplaceChild(
				"mask_1_r1", CubeListBuilder.create().texOffs(50, 0).mirror()
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(13, 19).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
