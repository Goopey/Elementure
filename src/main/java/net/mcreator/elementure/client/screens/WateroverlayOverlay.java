...
public class WateroverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (WaterelementaloverlayConditionProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.wateroverlay.label_varintegerwater_essence"), posX + 180, posY + 77, -16750900);
		}
