...
public class Modelobleck_minion<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "obleck_minion"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ear_2_r1 = bb_main.addOrReplaceChild("ear_2_r1",
		...
		PartDefinition ear_1_r1 = bb_main.addOrReplaceChild("ear_1_r1",
				CubeListBuilder.create().texOffs(0, 11).addBox(-1.0F, -0.6F, -1.0F, 1.0F, 3.0F, 2.0F,
