...
public class Modelironknighthelmet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelironknighthelmet"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 32).addBox(-4.5F, -8.5F, -4.5F, 9.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 23.5F, 0.0F));
		PartDefinition HornRightBase = head.addOrReplaceChild("HornRightBase",
				CubeListBuilder.create().texOffs(0, 55).addBox(-2.0F, -8.1F, -3.2F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition HornRightMain = HornRightBase.addOrReplaceChild("HornRightMain",
				CubeListBuilder.create().texOffs(25, 54).addBox(-0.9F, -9.0F, -8.0F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.9561F, -0.2731F, -0.1676F));
		PartDefinition HornLeftBase = head.addOrReplaceChild(
				"HornLeftBase", CubeListBuilder.create().texOffs(0, 55).mirror()
		...
		PartDefinition HornLeftMain = HornLeftBase.addOrReplaceChild(
				"HornLeftMain", CubeListBuilder.create().texOffs(25, 54).mirror()
