...
public class AscendedaspidEntity extends Monster implements RangedAttackMob {
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		AscendedaspidEntityProjectile entityarrow = new AscendedaspidEntityProjectile(ElementureModEntities.ASCENDEDASPID_PROJECTILE.get(), this, this.level);
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.ASCENDEDASPID.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
