...
public class CoalpuckEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new Goal() {
			...
			public boolean canContinueToUse() {
				return CoalpuckEntity.this.getMoveControl().hasWanted() && CoalpuckEntity.this.getTarget() != null && CoalpuckEntity.this.getTarget().isAlive();
			}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.COALPUCK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
