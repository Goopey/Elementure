...
import net.mcreator.elementure.procedures.MaxtrahiraDisplayProcedure;
...
public class MaxtrahiraOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (MaxtrahiraDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/max_trahira.png"));
