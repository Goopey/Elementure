...
public class RepulsiveForgottenPopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (RepulsiveForgottenpopupConditionProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), "Forgotten", posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), "By:REPULSIVE", posX + -198, posY + -108, -203);
		}
