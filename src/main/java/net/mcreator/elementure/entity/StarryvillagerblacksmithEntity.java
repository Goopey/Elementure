...
import net.mcreator.elementure.procedures.StarryvillagergathererParticlesProcedure;
import net.mcreator.elementure.procedures.StarryvillagerblacksmithTradeProcedure;
import net.mcreator.elementure.init.ElementureModItems;
import net.mcreator.elementure.init.ElementureModEntities;

public class StarryvillagerblacksmithEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public StarryvillagerblacksmithEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.STARRYVILLAGERBLACKSMITH.get(), world);
	}

	public StarryvillagerblacksmithEntity(EntityType<StarryvillagerblacksmithEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ElementureModItems.NETHERSTARHAMMER.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		StarryvillagerblacksmithTradeProcedure.execute(world, entity, itemstack);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		StarryvillagergathererParticlesProcedure.execute(this.level, this);
	}
