...
public class Modelsunlight_egg<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sunlight_egg"), "main");
	private final ModelPart main_body;
	private final ModelPart egg_body;
	private final ModelPart light_crown;
	private final ModelPart sunlight_crown;
	private final ModelPart sunlight_crown_mid;
	private final ModelPart sunlight_crown_bottom;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition egg_body = main_body.addOrReplaceChild("egg_body",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-1.5F, 3.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition light_crown = egg_body.addOrReplaceChild("light_crown", CubeListBuilder.create()
				.texOffs(104, 116).addBox(-6.0F, -5.0F, 4.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition sunlight_crown = main_body.addOrReplaceChild("sunlight_crown",
				CubeListBuilder.create().texOffs(0, 112)
						.addBox(-8.0F, 0.0F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 68)
		...
		PartDefinition sunlight_crown_mid = sunlight_crown.addOrReplaceChild("sunlight_crown_mid", CubeListBuilder
				.create().texOffs(88, 95).addBox(-5.0F, 0.0F, -5.0F, 10.0F, 6.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition sunlight_crown_bottom = sunlight_crown.addOrReplaceChild("sunlight_crown_bottom", CubeListBuilder
				.create().texOffs(104, 64).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 15.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
