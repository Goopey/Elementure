...
public class Modelmycena_fumoon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_fumoon"), "main");
	private final ModelPart body;
	private final ModelPart spore_vent_1;
	private final ModelPart spore_vent_2;
	private final ModelPart spore_vent_3;
	private final ModelPart spore_vent_4;
	private final ModelPart spore_vent_5;
	private final ModelPart spore_vent_6;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.5F, -1.0F, -5.5F, 11.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition spore_vent_1 = partdefinition.addOrReplaceChild("spore_vent_1", CubeListBuilder.create(),
				PartPose.offset(0.0F, 17.25F, 0.0F));

		PartDefinition spore_arm_1 = spore_vent_1.addOrReplaceChild("spore_arm_1",
				CubeListBuilder.create().texOffs(52, 59)
						.addBox(-1.5F, -1.5F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(19, 58)
		...
		PartDefinition spore_vent_2 = partdefinition.addOrReplaceChild("spore_vent_2", CubeListBuilder.create(),
				PartPose.offset(6.5F, 19.5F, 2.0F));

		PartDefinition sporevent_2_2 = spore_vent_2
				.addOrReplaceChild("sporevent_2_2",
						CubeListBuilder.create().texOffs(0, 57).addBox(-1.5F, -3.0F, -1.5F, 3.0F, 4.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition spore_vent_3 = partdefinition.addOrReplaceChild("spore_vent_3", CubeListBuilder.create(),
				PartPose.offset(1.5F, 17.5F, 7.0F));

		PartDefinition sporevent_3_2 = spore_vent_3.addOrReplaceChild("sporevent_3_2",
				CubeListBuilder.create().texOffs(0, 57).addBox(-1.5F, -2.0F, -1.5F, 3.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition spore_vent_6 = partdefinition.addOrReplaceChild("spore_vent_6", CubeListBuilder.create(),
				PartPose.offset(1.0F, 20.0F, -6.5F));

		PartDefinition sporevent_6_2 = spore_vent_6.addOrReplaceChild("sporevent_6_2",
				CubeListBuilder.create().texOffs(0, 57).addBox(-1.5F, -3.0F, -2.0F, 3.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
