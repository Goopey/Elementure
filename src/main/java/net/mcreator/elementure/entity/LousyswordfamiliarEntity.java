...
import net.mcreator.elementure.procedures.LousyswordfamiliarStopSoundProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.procedures.FamiliarCheckPlayerProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

import java.util.List;

public class LousyswordfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public LousyswordfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.LOUSYSWORDFAMILIAR.get(), world);
	}

	public LousyswordfamiliarEntity(EntityType<LousyswordfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 2.5, (float) 0, false));
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LousyswordfamiliarStopSoundProcedure.execute(sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		FamiliarCheckPlayerProcedure.execute(this.level, this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LousyswordfamiliarEntity retval = ElementureModEntities.LOUSYSWORDFAMILIAR.get().create(serverWorld);
