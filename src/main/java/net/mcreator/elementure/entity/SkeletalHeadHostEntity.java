...
import net.mcreator.elementure.procedures.SkeletalHeadHostDropsProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class SkeletalHeadHostEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public SkeletalHeadHostEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.SKELETAL_HEAD_HOST.get(), world);
	}

	public SkeletalHeadHostEntity(EntityType<SkeletalHeadHostEntity> type, Level world) {
		super(type, world);
		xpReward = 9;
		setNoAi(false);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		SkeletalHeadHostDropsProcedure.execute(this.level, this);
	}
