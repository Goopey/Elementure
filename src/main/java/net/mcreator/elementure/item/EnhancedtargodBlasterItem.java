...
public class EnhancedtargodBlasterItem extends Item {
	public EnhancedtargodBlasterItem() {
		super(new Item.Properties().tab(ElementureModTabs.TAB_TABMODDEDSWORDS).durability(760));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				EnhancedtargodBlasterEntity entityarrow = EnhancedtargodBlasterEntity.shoot(world, entity, world.getRandom(), 1.5f, 9, 0);
