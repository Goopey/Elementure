...
public class OnemoredayPopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (OnemoredaypopupConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.onemoreday_popup.label_one_more_day"), posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.onemoreday_popup.label_bylena_raine"), posX + -198, posY + -108, -203);
		}
