...
public class MycenasproutsSpreadProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		CoordsY = -4;
		CoordsZ = -4;
		for (int index1 = 0; index1 < (int) (729); index1++) {
			if (16 * CoordsY * CoordsY + CoordsX * CoordsX + CoordsZ * CoordsZ < 16 && (world.getBlockState(new BlockPos(x + CoordsX, y + CoordsY, z + CoordsZ))).getBlock() == Blocks.AIR && Math.random() < 4e-7
