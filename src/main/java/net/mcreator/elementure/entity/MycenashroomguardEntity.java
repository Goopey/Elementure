...
import net.mcreator.elementure.procedures.MycenashroomguardDropSpearProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class MycenashroomguardEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public MycenashroomguardEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.MYCENASHROOMGUARD.get(), world);
	}

	public MycenashroomguardEntity(EntityType<MycenashroomguardEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, MycenainfectedshroomguardEntity.class, false, true));
	...
	public void die(DamageSource source) {
		super.die(source);
		MycenashroomguardDropSpearProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
