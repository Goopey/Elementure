...
public class TinyclaymanfamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public TinyclaymanfamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.TINYCLAYMANFAMILIAR.get(), world);
	}

	public TinyclaymanfamiliarEntity(EntityType<TinyclaymanfamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TinyclaymanfamiliarEntity retval = ElementureModEntities.TINYCLAYMANFAMILIAR.get().create(serverWorld);
