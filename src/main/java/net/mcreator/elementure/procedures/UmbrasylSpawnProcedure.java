...
public class UmbrasylSpawnProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		while (num < lengthChain) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new UmbrasylSegmentEntity(ElementureModEntities.UMBRASYL_SEGMENT.get(), _level);
				entityToSpawn.moveTo((entity.getX() - num * 4 * yaw), (entity.getY()), (entity.getZ() - num * 4 * yaw2), 0, 0);
			...
			{
				final Vec3 _center = new Vec3((entity.getX() - num * 4 * yaw), (entity.getY()), (entity.getZ() - num * 4 * yaw2));
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UmbrasylSegmentEntity) {
