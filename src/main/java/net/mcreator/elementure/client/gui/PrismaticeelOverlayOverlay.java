...
import net.mcreator.elementure.procedures.PrismaticeelDisplayProcedure;
...
public class PrismaticeelOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (PrismaticeelDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/prismatic_eel.png"));
