...
import net.mcreator.elementure.procedures.MemoryfishrareDisplayProcedure;
...
public class MemoryfishrareOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (MemoryfishrareDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/memory_fish_rare.png"));
