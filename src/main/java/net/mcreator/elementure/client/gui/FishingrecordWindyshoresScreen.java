...
import net.mcreator.elementure.procedures.SkyChubConfirmProcedure;
import net.mcreator.elementure.procedures.SkipsnakeConfirmProcedure;
import net.mcreator.elementure.procedures.MrLConfirmProcedure;
import net.mcreator.elementure.procedures.DeactivateSlotProcedure;
import net.mcreator.elementure.network.FishingrecordWindyshoresButtonMessage;
...
public class FishingrecordWindyshoresScreen extends AbstractContainerScreen<FishingrecordWindyshoresMenu> {
	private final static HashMap<String, Object> guistate = FishingrecordWindyshoresMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_next_page;

	public FishingrecordWindyshoresScreen(FishingrecordWindyshoresMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("elementure:textures/screens/fishingrecord_windyshores.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		if (SkyChubConfirmProcedure.execute(entity)) {
		...
		if (SkipsnakeConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 35, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/skipsnake.png"));
		this.blit(ms, this.leftPos + -4, this.topPos + 33, 0, 0, 16, 16, 16, 16);

		if (MrLConfirmProcedure.execute(entity)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/green_checkmark.png"));
			this.blit(ms, this.leftPos + -20, this.topPos + 57, 0, 0, 12, 12, 12, 12);
		}

		RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/screens/mrl.png"));
	...
	public void init() {
		...
		button_next_page = new Button(this.leftPos + 127, this.topPos + 140, 70, 20, Component.translatable("gui.elementure.fishingrecord_windyshores.button_next_page"), e -> {
			if (DeactivateSlotProcedure.execute()) {
