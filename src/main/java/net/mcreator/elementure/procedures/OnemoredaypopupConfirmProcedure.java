...
public class OnemoredaypopupConfirmProcedure {
	public static boolean execute(Entity entity) {
		...
		return (entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ElementureModVariables.PlayerVariables())).musictimer <= -7400
				...
				&& ((entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ElementureModVariables.PlayerVariables())).musicName).equals("oneMoreDay");
	}
}
