...
public class EastmycenahousesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		MycenahousepillargenProcedure.execute(world, (x + 3), (y + 1), z);
		MycenahousepillargenProcedure.execute(world, (x - 3), (y - 1), z);
		MycenahousepillargenProcedure.execute(world, (x - 2), (y - 1), z);
		MycenahousepillargenProcedure.execute(world, (x - 1), (y - 1), z);
		MycenahousepillargenProcedure.execute(world, (x - 3), (y - 1), (z - 1));
		MycenahousepillargenProcedure.execute(world, (x - 2), (y - 1), (z - 1));
		...
		if (Math.random() < 0.14) {
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_farm_house_east"));
				if (template != null) {
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_leatherworker_house_east"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos(x - 5, y, z - 5), new BlockPos(x - 5, y, z - 5), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_librarian_house_east"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos(x - 5, y, z - 5), new BlockPos(x - 5, y, z - 5), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_priest_house_east"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos(x - 5, y, z - 5), new BlockPos(x - 5, y, z - 5), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_regular_house_east"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos(x - 5, y, z - 5), new BlockPos(x - 5, y, z - 5), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_fisherman_east"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos(x - 5, y, z - 5), new BlockPos(x - 5, y, z - 5), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("elementure", "mycena_smith_house_east"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos(x - 5, y, z - 5), new BlockPos(x - 5, y, z - 5), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
