	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (StandatmithrillhallConfirmProcedure.execute(entity)) {
				...
				Minecraft.getInstance().font.draw(event.getMatrixStack(), "Stand At Mithrill Hall", posX + -198, posY + -116, -203);
				Minecraft.getInstance().font.draw(event.getMatrixStack(), "From:Demon Stone", posX + -198, posY + -108, -203);
			}
