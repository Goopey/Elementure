...
import net.mcreator.elementure.procedures.StarryvillagergathererTradingProcedure;
import net.mcreator.elementure.procedures.StarryvillagergathererParticlesProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class StarryvillagergathererEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public StarryvillagergathererEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.STARRYVILLAGERGATHERER.get(), world);
	}

	public StarryvillagergathererEntity(EntityType<StarryvillagergathererEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		StarryvillagergathererTradingProcedure.execute(world, entity, itemstack);
		return retval;
	}
