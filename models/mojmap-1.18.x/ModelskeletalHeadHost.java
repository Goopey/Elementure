...
public class ModelskeletalHeadHost<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "skeletalheadhost"), "main");
	...
	private final ModelPart spider_leg_2;
	private final ModelPart spider_leg_3;
	private final ModelPart spider_leg_4;
	private final ModelPart spider_leg_5;
	private final ModelPart bb_main;

	public ModelskeletalHeadHost(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_tilt = partdefinition.addOrReplaceChild("head_tilt", CubeListBuilder.create(),
		...
		PartDefinition head_pivot_bob = head_tilt.addOrReplaceChild("head_pivot_bob",
				CubeListBuilder.create().texOffs(32, 0)
						...
						.addBox(-3.99F, -8.01F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(-0.25F)),
		...
		PartDefinition spiderHead = partdefinition.addOrReplaceChild("spiderHead", CubeListBuilder.create()
				.texOffs(44, 54).addBox(-3.0F, -2.0F, -3.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition spider_leg_1 = partdefinition.addOrReplaceChild("spider_leg_1", CubeListBuilder.create(),
		...
		PartDefinition spider_leg_2 = partdefinition.addOrReplaceChild("spider_leg_2", CubeListBuilder.create(),
				PartPose.offset(-4.0F, 7.0F, 0.0F));

		PartDefinition cube_r2 = spider_leg_2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(44, 35).addBox(-1.0F, 0.0F, -4.0F, 2.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, -2.0F, 0.0436F, 0.3054F, 0.0F));

		PartDefinition spider_leg_3 = partdefinition.addOrReplaceChild("spider_leg_3", CubeListBuilder.create(),
				PartPose.offset(-4.0F, 2.0F, 0.0F));

		PartDefinition cube_r3 = spider_leg_3.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(44, 35).addBox(-1.0F, 0.0F, -6.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, -2.0F, -0.3927F, 0.1309F, 0.0F));

		PartDefinition spider_leg_4 = partdefinition.addOrReplaceChild("spider_leg_4", CubeListBuilder.create(),
				PartPose.offset(4.0F, 7.0F, 0.0F));
		...
		PartDefinition spider_leg_5 = partdefinition.addOrReplaceChild("spider_leg_5", CubeListBuilder.create(),
				PartPose.offset(3.0F, 12.0F, -2.0F));

		PartDefinition cube_r5 = spider_leg_5.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(44, 35).addBox(-2.0F, 5.0F, -6.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -6.0F, 0.0F, 0.1745F, -0.1745F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 48)
		...
		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 46).addBox(-2.5F, -2.0F, 0.0F, 5.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
