...
import net.mcreator.elementure.procedures.Mycenavillagertrade1Procedure;
import net.mcreator.elementure.network.MycenashroomvillagerGUI2SlotMessage;
...
public class MycenashroomvillagerGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MycenashroomvillagerGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 133, 35) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(6, 1, 0);
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 133, 62) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(10, 1, 0);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ElementureMod.PACKET_HANDLER.sendToServer(new MycenashroomvillagerGUI2SlotMessage(slotid, x, y, z, ctype, meta));
			MycenashroomvillagerGUI2SlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof MycenashroomvillagerGUI2Menu) {
