...
public class GoldenhoppercharmEffectProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (((entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				.getItem() == ElementureModItems.GOLDENHOPPERCHARM.get()
				...
				if (entity.getDeltaMovement().y() < -0.5
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.ENCHANT, (entity.getX()), (entity.getY()), (entity.getZ()),
								(int) Math.round(Math.abs(entity.getDeltaMovement().y() * 30)), 0.6, 0.6, 0.6, 0.05);
					{
						...
						for (Entity entityiterator : _entfound) {
							if (!entityiterator.getType()
								...
								entityiterator.setDeltaMovement(new Vec3((entityiterator.getX() - entity.getX()),
										(entityiterator.getDeltaMovement().y() / 4), (entityiterator.getZ() - entity.getZ())));
							}
						}
					}
				}
