...
public class UmbrasylSegmentDamageBarProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!world.getEntitiesOfClass(UmbrasylEntity.class, AABB.ofSize(new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), 128, 128, 128),
				e -> true).isEmpty()) {
			umbrasylHead = (Entity) world.getEntitiesOfClass(UmbrasylEntity.class,
					AABB.ofSize(new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), 128, 128, 128), e -> true).stream().sorted(new Object() {
