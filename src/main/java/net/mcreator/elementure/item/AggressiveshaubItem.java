...
import net.mcreator.elementure.procedures.AggressiveshaubEffectProcedure;
...
public class AggressiveshaubItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A red jellyfish. It grows pinker and kinder as it gets older."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		AggressiveshaubEffectProcedure.execute(entity);
		return retval;
	}
}
