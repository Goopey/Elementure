...
public class HeadlessDiscardedSkeletonEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public HeadlessDiscardedSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.HEADLESS_DISCARDED_SKELETON.get(), world);
	}

	public HeadlessDiscardedSkeletonEntity(EntityType<HeadlessDiscardedSkeletonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	}
