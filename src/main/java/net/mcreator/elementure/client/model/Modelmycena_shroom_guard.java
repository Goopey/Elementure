...
public class Modelmycena_shroom_guard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("elementure", "modelmycena_shroom_guard"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition SpearBone = RightArmBone.addOrReplaceChild("SpearBone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -0.5F, -7.5F, 1.0F, 1.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 13)
