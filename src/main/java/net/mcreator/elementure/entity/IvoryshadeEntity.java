...
import net.mcreator.elementure.procedures.IvoryshadeReduceDamageProcedure;
import net.mcreator.elementure.init.ElementureModItems;
import net.mcreator.elementure.init.ElementureModEntities;

public class IvoryshadeEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public IvoryshadeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.IVORYSHADE.get(), world);
	}

	public IvoryshadeEntity(EntityType<IvoryshadeEntity> type, Level world) {
		super(type, world);
		xpReward = 7;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ElementureModItems.IVORYSHARD.get()));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		IvoryshadeReduceDamageProcedure.execute(this, source.getEntity());
