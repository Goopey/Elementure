...
import net.mcreator.elementure.procedures.KassemdropsProcedure;
import net.mcreator.elementure.procedures.BigkassemAttackProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class BigkassemEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public BigkassemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.BIGKASSEM.get(), world);
	}

	public BigkassemEntity(EntityType<BigkassemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		KassemdropsProcedure.execute(this.level, this);
	}

	@Override
	public void baseTick() {
		super.baseTick();
		BigkassemAttackProcedure.execute(this);
	}
