...
public class SpacegoopsummonfamiliarProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (((entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new ElementureModVariables.PlayerVariables())).relic_inventory_familiar).getItem() == ElementureModItems.SPACEGOOP.get()) {
			if (!world.getEntitiesOfClass(CosmicslimefamiliarEntity.class,
