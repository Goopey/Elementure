...
import net.mcreator.elementure.procedures.TheninefamiliarTickUpdateProcedure;
import net.mcreator.elementure.procedures.FamiliarNegateDamageProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

import java.util.List;

public class TheninefamiliarEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public TheninefamiliarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.THENINEFAMILIAR.get(), world);
	}

	public TheninefamiliarEntity(EntityType<TheninefamiliarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void baseTick() {
		super.baseTick();
		TheninefamiliarTickUpdateProcedure.execute(this.level, this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TheninefamiliarEntity retval = ElementureModEntities.THENINEFAMILIAR.get().create(serverWorld);
