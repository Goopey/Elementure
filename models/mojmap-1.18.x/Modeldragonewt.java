...
public class Modeldragonewt<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dragonewt"), "main");
	private final ModelPart body;
	private final ModelPart tailtop;
	private final ModelPart tailmid;
	private final ModelPart tailend;
	private final ModelPart wingsbottom;
	// bottom right
	private final ModelPart wing_bottom_right;
	private final ModelPart wingrightbottom1_r;
	private final ModelPart wingrightbottom2_r;
	private final ModelPart wingrightbottom3_r;
	private final ModelPart wingrightbottom4_r;
	private final ModelPart wingrightbottom5_r;
	private final ModelPart wingrightbottom6_r;
	private final ModelPart wingrightbottom7_r;
	private final ModelPart wingrightbottom8_r;
	// bottom left
	private final ModelPart wing_bottom_left;
	private final ModelPart wingleftbottom1_r;
	private final ModelPart wingleftbottom2_r;
	private final ModelPart wingleftbottom3_r;
	private final ModelPart wingleftbottom4_r;
	private final ModelPart wingleftbottom5_r;
	private final ModelPart wingleftbottom6_r;
	private final ModelPart wingleftbottom7_r;
	private final ModelPart wingleftbottom8_r;
	// --
	private final ModelPart wingstop;
	// top right
	private final ModelPart wing_top_right;
	private final ModelPart wingrighttop1_r;
	private final ModelPart wingrighttop2_r;
	private final ModelPart wingrighttop3_r;
	private final ModelPart wingrighttop4_r;
	private final ModelPart wingrighttop5_r;
	private final ModelPart wingrighttop6_r;
	private final ModelPart wingrighttop7_r;
	private final ModelPart wingrighttop8_r;
	// top left
	private final ModelPart wing_top_left;
	private final ModelPart winglefttop1_r;
	private final ModelPart winglefttop2_r;
	private final ModelPart winglefttop3_r;
	private final ModelPart winglefttop4_r;
	private final ModelPart winglefttop5_r;
	private final ModelPart winglefttop6_r;
	private final ModelPart winglefttop7_r;
	private final ModelPart winglefttop8_r;
	// --
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(156, 26).mirror()
						.addBox(-3.0F, -1.75F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(156, 26).mirror()
						.addBox(-3.0F, -8.75F, -1.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(24, 2).addBox(-7.5F, -8.25F, -11.0F, 15.0F, 11.0F, 30.0F, new CubeDeformation(0.0F))
						.texOffs(52, 29).addBox(-7.0F, -7.75F, -13.0F, 14.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 21.25F, 3.0F));

		PartDefinition backspike_10_r1 = body.addOrReplaceChild("backspike_10_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -2.5F, -2.0F, 2.0F, 6.0F, 3.0F,
		...
		PartDefinition backspike_9_r1 = body.addOrReplaceChild("backspike_9_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.5F, -2.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -5.0F, 19.5F, -0.9599F, 0.3491F, 0.9599F));

		PartDefinition backspike_8_r1 = body.addOrReplaceChild("backspike_8_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -3.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_7_r1 = body.addOrReplaceChild("backspike_7_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.5F, -3.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -9.0F, 19.5F, -0.9599F, -0.3491F, -0.1745F));

		PartDefinition underspike_6_r1 = body.addOrReplaceChild("underspike_6_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_6_r1 = body.addOrReplaceChild("backspike_6_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition underspike_5_r1 = body.addOrReplaceChild("underspike_5_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -4.5F, -1.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_5_r1 = body.addOrReplaceChild("backspike_5_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -0.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition underspike_4_r1 = body.addOrReplaceChild("underspike_4_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition underspike_3_r1 = body.addOrReplaceChild("underspike_3_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.5F, -1.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 3.0F, 10.5F, 0.9599F, 0.4363F, 0.1745F));

		PartDefinition backspike_3_r1 = body.addOrReplaceChild("backspike_3_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.5F, -2.0F, -1.0F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -9.0F, 10.5F, -0.9599F, 0.4363F, 0.1745F));
		...
		PartDefinition backspike_12_r1 = tailtop.addOrReplaceChild("backspike_12_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-2.75F, -4.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_11_r1 = tailtop.addOrReplaceChild("backspike_11_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(0.75F, -4.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, 3.25F, 3.5F, -0.9163F, -0.48F, -0.6981F));

		PartDefinition backspike_20_r1 = tailtop.addOrReplaceChild("backspike_20_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -4.5F, -1.5F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tailmid = tailtop.addOrReplaceChild("tailmid",
				CubeListBuilder.create().texOffs(138, 0)
						.addBox(-5.5F, -4.5F, -1.0F, 11.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(138, 0)
		...
		PartDefinition backspike_21_r1 = tailmid.addOrReplaceChild("backspike_21_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -2.5F, -2.5F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_14_r1 = tailmid.addOrReplaceChild("backspike_14_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.25F, -4.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_13_r1 = tailmid.addOrReplaceChild("backspike_13_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.75F, -4.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, 3.25F, 3.5F, -0.9163F, 0.48F, 0.6981F));

		PartDefinition backspike_19_r1 = tailmid.addOrReplaceChild("backspike_19_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tailend = tailmid.addOrReplaceChild("tailend",
				CubeListBuilder.create().texOffs(116, 23)
						.addBox(-4.5F, -3.5F, -1.0F, 9.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(116, 23)
		...
		PartDefinition backspike_18_r1 = tailend.addOrReplaceChild("backspike_18_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.25F, -4.5F, -1.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_17_r1 = tailend.addOrReplaceChild("backspike_17_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.75F, -4.5F, -1.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -2.75F, 4.5F, -1.309F, -0.48F, 2.3562F));

		PartDefinition backspike_16_r1 = tailend.addOrReplaceChild("backspike_16_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.75F, -3.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backspike_15_r1 = tailend.addOrReplaceChild("backspike_15_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.25F, -3.5F, -2.0F, 2.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 3.25F, 4.5F, -1.309F, -0.48F, -0.9599F));

		PartDefinition tailbit = tailend.addOrReplaceChild("tailbit", CubeListBuilder.create().texOffs(156, 26).addBox(
				-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 15.0F));

		PartDefinition wingsbottom = partdefinition.addOrReplaceChild("wingsbottom", CubeListBuilder.create(),
		...
		PartDefinition wingleftbottom1_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom1_r", CubeListBuilder.create().texOffs(191, 255).addBox(-1.5F, 0.5F, -4.0F, 31.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition wingleftbottom2_r = wing_bottom_left.addOrReplaceChild("wingleftbottom2_r", CubeListBuilder
				.create().texOffs(190, 255).addBox(-1.5F, 0.5F, -3.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition wingleftbottom3_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom3_r", CubeListBuilder.create().texOffs(190, 250).addBox(-1.5F, 0.5F, -2.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition wingleftbottom4_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom4_r", CubeListBuilder.create().texOffs(190, 255).addBox(-1.5F, 0.5F, -1.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition wingleftbottom5_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom5_r", CubeListBuilder.create().texOffs(190, 250).addBox(-1.5F, 0.5F, 0.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition wingleftbottom6_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom6_r", CubeListBuilder.create().texOffs(192, 255).addBox(-1.5F, 0.5F, 1.0F, 30.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition wingleftbottom7_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom7_r", CubeListBuilder.create().texOffs(194, 255).addBox(-1.5F, 0.5F, 2.0F, 28.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2182F));

		PartDefinition wingleftbottom8_r = wing_bottom_left.addOrReplaceChild(
				"wingleftbottom8_r", CubeListBuilder.create().texOffs(198, 255).addBox(-1.5F, 0.5F, 3.0F, 24.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		...
		PartDefinition wingrightbottom1_r = wing_bottom_right.addOrReplaceChild("wingrightbottom1_r",
				CubeListBuilder.create().texOffs(191, 250).mirror()
						.addBox(-30.5F, 0.5F, -4.0F, 31.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition wingrightbottom2_r = wing_bottom_right.addOrReplaceChild("wingrightbottom2_r",
				CubeListBuilder.create().texOffs(190, 220).mirror()
						.addBox(-31.5F, 0.5F, -3.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition wingrightbottom3_r = wing_bottom_right.addOrReplaceChild("wingrightbottom3_r",
				CubeListBuilder.create().texOffs(190, 255).mirror()
						.addBox(-31.5F, 0.5F, -2.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition wingrightbottom4_r = wing_bottom_right.addOrReplaceChild("wingrightbottom4_r",
				CubeListBuilder.create().texOffs(190, 250).mirror()
						.addBox(-31.5F, 0.5F, -1.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition wingrightbottom5_r = wing_bottom_right.addOrReplaceChild("wingrightbottom5_r",
				CubeListBuilder.create().texOffs(190, 255).mirror()
						.addBox(-31.5F, 0.5F, 0.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition wingrightbottom6_r = wing_bottom_right.addOrReplaceChild("wingrightbottom6_r",
				CubeListBuilder.create().texOffs(192, 250).mirror()
						.addBox(-29.5F, 0.5F, 1.0F, 30.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition wingrightbottom7_r = wing_bottom_right.addOrReplaceChild("wingrightbottom7_r",
				CubeListBuilder.create().texOffs(194, 250).mirror()
						.addBox(-27.5F, 0.5F, 2.0F, 28.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition wingrightbottom8_r = wing_bottom_right.addOrReplaceChild("wingrightbottom8_r",
				CubeListBuilder.create().texOffs(198, 250).mirror()
						.addBox(-23.5F, 0.5F, 3.0F, 24.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition wingstop = partdefinition.addOrReplaceChild("wingstop", CubeListBuilder.create(),
		...
		PartDefinition winglefttop1_r = wing_top_left.addOrReplaceChild(
				"winglefttop1_r", CubeListBuilder.create().texOffs(191, 234).addBox(-1.5F, 0.0F, -4.0F, 31.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition winglefttop2_r = wing_top_left.addOrReplaceChild(
				"winglefttop2_r", CubeListBuilder.create().texOffs(190, 250).addBox(-1.5F, 0.0F, -3.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2182F));

		PartDefinition winglefttop3_r = wing_top_left.addOrReplaceChild(
				"winglefttop3_r", CubeListBuilder.create().texOffs(190, 234).addBox(-1.5F, 0.0F, -2.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition winglefttop4_r = wing_top_left.addOrReplaceChild(
				"winglefttop4_r", CubeListBuilder.create().texOffs(190, 220).addBox(-1.5F, 0.0F, -1.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition winglefttop5_r = wing_top_left.addOrReplaceChild(
				"winglefttop5_r", CubeListBuilder.create().texOffs(190, 234).addBox(-1.5F, 0.0F, 0.0F, 32.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition winglefttop6_r = wing_top_left.addOrReplaceChild(
				"winglefttop6_r", CubeListBuilder.create().texOffs(192, 234).addBox(-1.5F, 0.0F, 1.0F, 30.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition winglefttop7_r = wing_top_left.addOrReplaceChild("winglefttop7_r", CubeListBuilder.create()
				.texOffs(194, 234).addBox(-1.5F, 0.0F, 2.0F, 28.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition winglefttop8_r = wing_top_left.addOrReplaceChild(
				"winglefttop8_r", CubeListBuilder.create().texOffs(198, 234).addBox(-1.5F, 0.0F, 3.0F, 24.0F, 0.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0436F));
		...
		PartDefinition wingrighttop1_r = wing_top_right.addOrReplaceChild("wingrighttop1_r",
				CubeListBuilder.create().texOffs(191, 220).mirror()
						.addBox(-31.0F, 0.0F, -4.0F, 31.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition wingrighttop2_r = wing_top_right.addOrReplaceChild("wingrighttop2_r",
				CubeListBuilder.create().texOffs(190, 234).mirror()
						.addBox(-32.0F, 0.0F, -3.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition wingrighttop3_r = wing_top_right.addOrReplaceChild("wingrighttop3_r",
				CubeListBuilder.create().texOffs(190, 255).mirror()
						.addBox(-32.0F, 0.0F, -2.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition wingrighttop4_r = wing_top_right.addOrReplaceChild("wingrighttop4_r",
				CubeListBuilder.create().texOffs(190, 234).mirror()
						.addBox(-32.0F, 0.0F, -1.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition wingrighttop5_r = wing_top_right.addOrReplaceChild("wingrighttop5_r",
				CubeListBuilder.create().texOffs(190, 220).mirror()
						.addBox(-32.0F, 0.0F, 0.0F, 32.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition wingrighttop6_r = wing_top_right.addOrReplaceChild("wingrighttop6_r",
				CubeListBuilder.create().texOffs(192, 220).mirror()
						.addBox(-30.0F, 0.0F, 1.0F, 30.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition wingrighttop7_r = wing_top_right.addOrReplaceChild("wingrighttop7_r",
				CubeListBuilder.create().texOffs(194, 220).mirror()
						.addBox(-28.0F, 0.0F, 2.0F, 28.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition wingrighttop8_r = wing_top_right.addOrReplaceChild("wingrighttop8_r",
				CubeListBuilder.create().texOffs(198, 220).mirror()
						.addBox(-24.0F, 0.0F, 3.0F, 24.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(),
				PartPose.offset(0.0F, 18.0F, -10.0F));

		PartDefinition mouth_spike_left2_r1 = head.addOrReplaceChild("mouth_spike_left2_r1",
				CubeListBuilder.create().texOffs(99, 5).addBox(-3.0F, -1.0F, -0.5F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition mouth_spike_left_r1 = head.addOrReplaceChild("mouth_spike_left_r1",
				CubeListBuilder.create().texOffs(99, 5).addBox(-7.0F, 2.5F, -14.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition mouth_spike_right_r1 = head.addOrReplaceChild("mouth_spike_right_r1",
				CubeListBuilder.create().texOffs(99, 5).addBox(5.0F, 2.5F, -14.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.1745F, 0.0F));

		PartDefinition mouthfront_r1 = head
				.addOrReplaceChild("mouthfront_r1",
						CubeListBuilder.create().texOffs(0, 74).addBox(-3.49F, -4.0F, -6.25F, 7.0F, 6.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 3.5F, -7.5F, 0.4363F, 0.0F, 0.0F));

		PartDefinition mouth_r1 = head
				.addOrReplaceChild("mouth_r1",
						CubeListBuilder.create().texOffs(10, 8).addBox(-4.0F, -3.0F, -5.5F, 8.0F, 6.0F, 9.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition skull_rim2_r1 = head.addOrReplaceChild("skull_rim2_r1",
				CubeListBuilder.create().texOffs(0, 43).addBox(-1.35F, -2.0F, -13.0F, 2.0F, 1.0F, 22.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition skull_rim_r1 = head.addOrReplaceChild("skull_rim_r1",
				CubeListBuilder.create().texOffs(0, 43).addBox(-0.65F, -2.0F, -13.01F, 2.0F, 1.0F, 22.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.0F, -5.0F, 0.48F, 0.3054F, -0.5236F));

		PartDefinition left_eyebrow_r1 = head.addOrReplaceChild("left_eyebrow_r1",
				CubeListBuilder.create().texOffs(0, 42).addBox(-2.5F, -0.75F, -12.5F, 2.0F, 3.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_eyebrow_r1 = head.addOrReplaceChild("right_eyebrow_r1",
				CubeListBuilder.create().texOffs(0, 42).addBox(0.5F, -0.75F, -12.5F, 2.0F, 3.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, -6.0F, -1.0F, 0.5585F, 0.2182F, 0.1745F));

		PartDefinition left_eyebrow_mid_r1 = head.addOrReplaceChild("left_eyebrow_mid_r1",
				CubeListBuilder.create().texOffs(0, 34).addBox(-2.5F, -1.0F, -6.5F, 3.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_eyebrow_mid_r1 = head.addOrReplaceChild("right_eyebrow_mid_r1",
				CubeListBuilder.create().texOffs(0, 34).addBox(-0.5F, -1.0F, -6.5F, 3.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, -4.0F, -1.0F, 0.3054F, 0.3054F, 0.1745F));

		PartDefinition left_eyebrow_spike_r1 = head.addOrReplaceChild("left_eyebrow_spike_r1",
				CubeListBuilder.create().texOffs(0, 34).addBox(-2.5F, -1.6F, 1.0F, 2.0F, 3.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_eyebrow_spike_r1 = head.addOrReplaceChild("right_eyebrow_spike_r1",
				CubeListBuilder.create().texOffs(0, 34).addBox(0.5F, -1.6F, 1.0F, 2.0F, 3.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, -4.0F, -1.0F, 0.6109F, -0.3927F, 0.0F));

		PartDefinition left_eyebrow_top_r1 = head.addOrReplaceChild("left_eyebrow_top_r1",
				CubeListBuilder.create().texOffs(0, 34)
						.addBox(-11.5F, -1.25F, -2.5F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
		...
		PartDefinition eye_left_r1 = head.addOrReplaceChild("eye_left_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.5F, -0.5F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition skull_top_r1 = head.addOrReplaceChild("skull_top_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.5F, -5.0F, -15.0F, 7.0F, 2.0F, 17.0F, new CubeDeformation(0.0F)).texOffs(6, 6)
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		 ...
		 */
		this.wingsbottom.setPos(0.0F,
				(20.0F + (float) ((Math.sin(ageInTicks / 6) / 1.5) + (Math.sin(ageInTicks / 10) * 1.5))), 0.0F);
		this.wingstop.setPos(0.0F,
				(16.0F + (float) ((Math.cos(ageInTicks / 6) / 1.5) + (Math.sin(ageInTicks / 10) * 1.5))), 7.0F);
		/*
