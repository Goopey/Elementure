...
import net.mcreator.elementure.procedures.MycenashroomvillagerfarmerOpenTradesProcedure;
import net.mcreator.elementure.procedures.MycenashroomvillagerfarmerDefineTradesProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

import javax.annotation.Nullable;

public class MycenashroomvillagerfarmerEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public MycenashroomvillagerfarmerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ElementureModEntities.MYCENASHROOMVILLAGERFARMER.get(), world);
	}

	public MycenashroomvillagerfarmerEntity(EntityType<MycenashroomvillagerfarmerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		MycenashroomvillagerfarmerDefineTradesProcedure.execute(this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MycenashroomvillagerfarmerOpenTradesProcedure.execute(world, x, y, z, entity, sourceentity, itemstack);
		return retval;
	}
