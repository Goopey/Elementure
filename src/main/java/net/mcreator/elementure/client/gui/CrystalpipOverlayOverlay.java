...
import net.mcreator.elementure.procedures.CrystalpipDisplayProcedure;
...
public class CrystalpipOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (CrystalpipDisplayProcedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("elementure:textures/crystal_pip.png"));
