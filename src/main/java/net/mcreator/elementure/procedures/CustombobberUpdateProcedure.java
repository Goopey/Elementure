			...
			if ((entityiterator.getDisplayName().getString()).equals(entity.getPersistentData().getString("playerName"))) {
				if (((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getDisplayName().getString()).equals(entity.getPersistentData().getString("rodName"))) {
					if ((world.getBlockState(new BlockPos(entity.getX(), entity.getY() - 0.5, entity.getZ()))).getBlock() == Blocks.WATER
							...
							|| (world.getBlockState(new BlockPos(entity.getX(), entity.getY() - 0.5, entity.getZ()))).getBlock() == ElementureModBlocks.DUNGEONWATER.get()) {
						if (entity.getPersistentData()
								.getDouble("bobberWait") >= ((112 - EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FISHING_SPEED, (entityiterator instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) * 15)
					...
					if ((world.getBlockState(new BlockPos(entity.getX(), entity.getY() - 0.5, entity.getZ()))).getBlock() == Blocks.WATER
							...
							|| (world.getBlockState(new BlockPos(entity.getX(), entity.getY() - 0.5, entity.getZ()))).getBlock() == ElementureModBlocks.DUNGEONWATER.get()) {
						if (entity.getPersistentData()
								.getDouble("bobberWait") >= ((112 - EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FISHING_SPEED, (entityiterator instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY)) * 15)
