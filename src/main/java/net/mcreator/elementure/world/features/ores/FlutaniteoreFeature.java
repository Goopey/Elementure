...
public class FlutaniteoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("elementure:flutaniteore", FEATURE,
				new OreConfiguration(FlutaniteoreFeatureRuleTest.INSTANCE, ElementureModBlocks.FLUTANITEORE.get().defaultBlockState(), 9));
	...
	private static class FlutaniteoreFeatureRuleTest extends RuleTest {
		static final FlutaniteoreFeatureRuleTest INSTANCE = new FlutaniteoreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<FlutaniteoreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<FlutaniteoreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("elementure:flutaniteore_match"), CUSTOM_MATCH);
		}
