			...
			public void tick() {
				...
				if (this.operation == MoveControl.Operation.MOVE_TO && !MycenasporeslingeringcloudEntity.this.getNavigation().isDone()) {
					...
					float f1 = (float) (this.speedModifier
							* MycenasporeslingeringcloudEntity.this.getAttribute(Attributes.MOVEMENT_SPEED).getValue());
					...
					if (MycenasporeslingeringcloudEntity.this.isInWater()) {
						MycenasporeslingeringcloudEntity.this
								.setSpeed((float) MycenasporeslingeringcloudEntity.this.getAttribute(Attributes.MOVEMENT_SPEED).getValue());
