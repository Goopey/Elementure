...
public class FangbolaRenderer extends EntityRenderer<FangbolaEntity> {
	...
	@Override
	public void render(FangbolaEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FangbolaEntity entity) {
		return texture;
	}
}
