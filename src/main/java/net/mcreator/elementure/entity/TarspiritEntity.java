...
public class TarspiritEntity extends TamableAnimal implements IAnimatable {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canContinueToUse() {
				return TarspiritEntity.this.getMoveControl().hasWanted() && TarspiritEntity.this.getTarget() != null
						&& TarspiritEntity.this.getTarget().isAlive();
			}
