...
public class Modelshattered_obsidian_charger<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shattered_obsidian_charger"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(46, 52)
				.addBox(-3.0F, -2.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.75F)),
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-10.5F, -2.0F, 1.5F, 21.0F, 3.0F, 4.0F, new CubeDeformation(0.75F)).texOffs(0, 0)
						.addBox(-6.0F, -3.125F, -3.5F, 12.0F, 3.0F, 11.0F, new CubeDeformation(0.75F)).texOffs(0, 0)
						.addBox(-4.0F, -4.25F, 2.5F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.75F)).texOffs(0, 0)
						.addBox(-2.5F, -4.0F, -3.5F, 5.0F, 4.0F, 11.0F, new CubeDeformation(0.75F)),
		...
		PartDefinition teeth_top_2_r1 = head.addOrReplaceChild("teeth_top_2_r1",
				CubeListBuilder.create().texOffs(80, 39)
						.addBox(-6.5F, -1.985F, -5.0F, 13.0F, 2.0F, 11.0F, new CubeDeformation(0.65F)).texOffs(0, 0)
						.addBox(-6.5F, -5.01F, -5.0F, 13.0F, 3.0F, 11.0F, new CubeDeformation(0.75F)).texOffs(78, 52)
						.addBox(-7.5F, -1.99F, -4.0F, 15.0F, 2.0F, 10.0F, new CubeDeformation(0.75F)).texOffs(0, 0)
						.addBox(-7.5F, -5.0F, -4.0F, 15.0F, 3.0F, 10.0F, new CubeDeformation(0.75F)),
		...
		PartDefinition cube_r2 = btm_jaw.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.5F, 0.1206F, -3.316F, 13.0F, 2.0F, 10.0F, new CubeDeformation(0.75F)).texOffs(0, 52)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-9.0F, -36.0F, -12.0F, 18.0F, 14.0F, 24.0F, new CubeDeformation(0.75F)).texOffs(0, 0)
