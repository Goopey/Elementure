...
public class ElementureModBlocks {
	...
	public static class ClientSideHandler {
		...
		public static void clientSetup(FMLClientSetupEvent event) {
			MinistrawberrybushBlock.registerRenderLayer();
			StrawberrybushBlock.registerRenderLayer();
			BeestingberrybushBlock.registerRenderLayer();
			MinibeestingberrybushBlock.registerRenderLayer();
			PerryberrybushBlock.registerRenderLayer();
			MiniperryberrybushBlock.registerRenderLayer();
			BlueberrybushBlock.registerRenderLayer();
			MiniblueberrybushBlock.registerRenderLayer();
			MushyslimeglueBlock.registerRenderLayer();
			MaelstromleavesBlock.registerRenderLayer();
			CorruptgrassplantBlock.registerRenderLayer();
			CorruptflowerBlock.registerRenderLayer();
			CorruptleavesBlock.registerRenderLayer();
			MurkBlock.registerRenderLayer();
			AnnimatedstatueblockBlock.registerRenderLayer();
			LootedvillagerstatueBlock.registerRenderLayer();
			RottendemonheartBlock.registerRenderLayer();
			AbsorptionstarBlock.registerRenderLayer();
			FirestarBlock.registerRenderLayer();
			HastestarBlock.registerRenderLayer();
			HealthstarBlock.registerRenderLayer();
			JumpstarBlock.registerRenderLayer();
			LuckystarBlock.registerRenderLayer();
			ResistancestarBlock.registerRenderLayer();
			SaturationstarBlock.registerRenderLayer();
			SpeedstarBlock.registerRenderLayer();
			StrenghtstarBlock.registerRenderLayer();
			VisionstarBlock.registerRenderLayer();
			WaterstarBlock.registerRenderLayer();
			DreadweedBlock.registerRenderLayer();
			IcyslimeBlock.registerRenderLayer();
			BlackbarrierBlock.registerRenderLayer();
			BluebarrierBlock.registerRenderLayer();
			BrownbarrierBlock.registerRenderLayer();
			CyanbarrierBlock.registerRenderLayer();
			GraybarrierBlock.registerRenderLayer();
			GreenbarrierBlock.registerRenderLayer();
			LightbluebarrierBlock.registerRenderLayer();
			LightgraybarrierBlock.registerRenderLayer();
			LimebarrierBlock.registerRenderLayer();
			MagentabarrierBlock.registerRenderLayer();
			OrangebarrierBlock.registerRenderLayer();
			PinkbarrierBlock.registerRenderLayer();
			PurplebarrierBlock.registerRenderLayer();
			...
			Tier1harvestedwaterelementBlock.registerRenderLayer();
			Tier1harvestedfireelementBlock.registerRenderLayer();
			Tier1harvestedearthelementBlock.registerRenderLayer();
			Tier1harvestedairelementBlock.registerRenderLayer();
			Tier1harvestedlightningelementBlock.registerRenderLayer();
			CursedleavesBlock.registerRenderLayer();
			DarkbumBlock.registerRenderLayer();
			...
			MemoryheartBlock.registerRenderLayer();
			EndermemorialBlock.registerRenderLayer();
			StonememorymatrixBlock.registerRenderLayer();
			PlainsmemorialBlock.registerRenderLayer();
			IcespikesmemorialBlock.registerRenderLayer();
			SwampmemorialBlock.registerRenderLayer();
			MycenamemorialBlock.registerRenderLayer();
			MountainsmemorialBlock.registerRenderLayer();
			SnowymemorialBlock.registerRenderLayer();
			NethermemorialBlock.registerRenderLayer();
			MushroommemorialBlock.registerRenderLayer();
			OceanmemorialBlock.registerRenderLayer();
			BadlandsmemorialBlock.registerRenderLayer();
			DesertmemorialBlock.registerRenderLayer();
			JunglememorialBlock.registerRenderLayer();
			ForestmemorialBlock.registerRenderLayer();
			SavannamemorialBlock.registerRenderLayer();
			...
			NetherpressureplateBlock.registerRenderLayer();
			NetherbuttonBlock.registerRenderLayer();
			NethertrapBlock.registerRenderLayer();
			MinoskulltrophyBlock.registerRenderLayer();
			...
			WarpedforestmemorialBlock.registerRenderLayer();
			...
			GreenslimefolBlock.registerRenderLayer();
			BlueslimefolBlock.registerRenderLayer();
			PinkslimefolBlock.registerRenderLayer();
			JellyfloattendrilBlock.registerRenderLayer();
			JellyfloatdarkBlock.registerRenderLayer();
			JellyfloatlightBlock.registerRenderLayer();
			JellyfloatBlock.registerRenderLayer();
			JellyfloatslimeBlock.registerRenderLayer();
			PinkjellyblockBlock.registerRenderLayer();
			BluejellyblockBlock.registerRenderLayer();
			GreenjellyblockBlock.registerRenderLayer();
			JellyfloatlimbBlock.registerRenderLayer();
			SeafoambubbleBlock.registerRenderLayer();
			PooltileStairsBlock.registerRenderLayer();
			PooltileSlabsBlock.registerRenderLayer();
			PooltileWallsBlock.registerRenderLayer();
			...
			FluffplankdoorBlock.registerRenderLayer();
			WortashleavesBlock.registerRenderLayer();
			WortashsaplingBlock.registerRenderLayer();
			FluffsaplingBlock.registerRenderLayer();
			WortashrootsBlock.registerRenderLayer();
			BluethornsaplingBlock.registerRenderLayer();
			BluethornleavesBlock.registerRenderLayer();
			BeachstarsBlock.registerRenderLayer();
			IvoryspawnerBlock.registerRenderLayer();
			WindyshoresmemorialBlock.registerRenderLayer();
			GreenrimevineBlock.registerRenderLayer();
			GreenrimebushBlock.registerRenderLayer();
			GreenrimefanBlock.registerRenderLayer();
			CyanrimebushBlock.registerRenderLayer();
			CyanrimevineBlock.registerRenderLayer();
			CyanrimefanBlock.registerRenderLayer();
			BluerimebushBlock.registerRenderLayer();
			BluerimevineBlock.registerRenderLayer();
			BluerimefanBlock.registerRenderLayer();
			LightbluerimebushBlock.registerRenderLayer();
			LightbluerimefanBlock.registerRenderLayer();
			LightbluerimevineBlock.registerRenderLayer();
			PurplerimevineBlock.registerRenderLayer();
			PurplerimefanBlock.registerRenderLayer();
			PurplerimebushBlock.registerRenderLayer();
			MagentarimevineBlock.registerRenderLayer();
			MagentarimefanBlock.registerRenderLayer();
			MagentarimebushBlock.registerRenderLayer();
			PinkrimevineBlock.registerRenderLayer();
			PinkrimefanBlock.registerRenderLayer();
			PinkrimebushBlock.registerRenderLayer();
			BrownrimevineBlock.registerRenderLayer();
			BrownrimefanBlock.registerRenderLayer();
			BrownrimebushBlock.registerRenderLayer();
			LightgrayrimevineBlock.registerRenderLayer();
			LightgrayrimefanBlock.registerRenderLayer();
			LightgrayrimebushBlock.registerRenderLayer();
			OrangerimevineBlock.registerRenderLayer();
			OrangerimefanBlock.registerRenderLayer();
			OrangerimebushBlock.registerRenderLayer();
			BlackrimevineBlock.registerRenderLayer();
			BlackrimefanBlock.registerRenderLayer();
			BlackrimebushBlock.registerRenderLayer();
			GrayrimevineBlock.registerRenderLayer();
			GrayrimefanBlock.registerRenderLayer();
			GrayrimebushBlock.registerRenderLayer();
			LimerimevineBlock.registerRenderLayer();
			LimerimefanBlock.registerRenderLayer();
			LimerimebushBlock.registerRenderLayer();
			YellowrimevineBlock.registerRenderLayer();
			YellowrimefanBlock.registerRenderLayer();
			YellowrimebushBlock.registerRenderLayer();
			RedrimevineBlock.registerRenderLayer();
			RedrimefanBlock.registerRenderLayer();
			RedrimebushBlock.registerRenderLayer();
			WhiterimevineBlock.registerRenderLayer();
			WhiterimefanBlock.registerRenderLayer();
			WhiterimebushBlock.registerRenderLayer();
			DivingvineBlock.registerRenderLayer();
			DivingvineBearingBlock.registerRenderLayer();
			DeepbrineBlock.registerRenderLayer();
			GlasslightBlock.registerRenderLayer();
			RareglasslightBlock.registerRenderLayer();
			GlasslightbrewerBlock.registerRenderLayer();
			...
			LilypadplanksGateBlock.registerRenderLayer();
			LilypadplanksFenceBlock.registerRenderLayer();
			LilypadplanksButtonBlock.registerRenderLayer();
			LilypadplanksPressureplateBlock.registerRenderLayer();
