...
public class DragonewtEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canContinueToUse() {
				return DragonewtEntity.this.getMoveControl().hasWanted() && DragonewtEntity.this.getTarget() != null
						&& DragonewtEntity.this.getTarget().isAlive();
			}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.DRAGONEWT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
