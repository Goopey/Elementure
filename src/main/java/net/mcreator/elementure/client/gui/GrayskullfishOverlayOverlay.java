...
import net.mcreator.elementure.procedures.GrayskullchubDisplayProcedure;
...
public class GrayskullfishOverlayOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (GrayskullchubDisplayProcedure.execute(entity)) {
