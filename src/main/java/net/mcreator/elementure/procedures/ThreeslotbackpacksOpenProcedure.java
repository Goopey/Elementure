...
public class ThreeslotbackpacksOpenProcedure {
	public static void execute(Entity entity) {
		...
		for (int index0 = 0; index0 < (int) (3); index0++) {
			if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
				...
				}.getItemStack((int) inventorySlots, ((entity.getCapability(ElementureModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ElementureModVariables.PlayerVariables())).relic_inventory_bag))).copy())).getCount());
