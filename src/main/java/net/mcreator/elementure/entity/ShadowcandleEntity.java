...
import net.mcreator.elementure.procedures.ShadowcandleDropsProcedure;
import net.mcreator.elementure.procedures.ShadowcandleDebuffProcedure;
import net.mcreator.elementure.procedures.MinoskullHalloweenProcedure;
import net.mcreator.elementure.init.ElementureModEntities;

public class ShadowcandleEntity extends Monster implements IAnimatable {
	...
	public ShadowcandleEntity(EntityType<ShadowcandleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		ShadowcandleDropsProcedure.execute(this.level, this);
	}

	@Override
	public void baseTick() {
		super.baseTick();
		ShadowcandleDebuffProcedure.execute(this.level, this);
	}
	...
	public static void init() {
		SpawnPlacements.register(ElementureModEntities.SHADOWCANDLE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
