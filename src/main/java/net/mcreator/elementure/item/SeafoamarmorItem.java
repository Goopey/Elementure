...
public abstract class SeafoamarmorItem extends ArmorItem {
	public SeafoamarmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SeafoamarmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/seafoamarmor__layer_1.png";
		}
	}

	public static class Chestplate extends SeafoamarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends SeafoamarmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementure:textures/models/armor/seafoamarmor__layer_2.png";
		}
	}

	public static class Boots extends SeafoamarmorItem {
		public Boots() {
