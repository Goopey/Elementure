...
public class SoulforgeGUIScreen extends AbstractContainerScreen<SoulforgeGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("elementure:textures/screens/soulforge_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 69, this.topPos + 19, 0, 0, 256, 256, 256, 256);
