...
public class CorallabyrinthpopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (CorallabyrinthpopupConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.corallabyrinthpopup.label_coral_labyrinth"), posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), Component.translatable("gui.elementure.corallabyrinthpopup.label_byredgreen"), posX + -198, posY + -108, -203);
		}
