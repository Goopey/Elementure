...
public class OnemoredayPopupOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (OnemoredaypopupConfirmProcedure.execute(entity)) {
			...
			Minecraft.getInstance().font.draw(event.getPoseStack(), "One More Day", posX + -198, posY + -116, -203);
			Minecraft.getInstance().font.draw(event.getPoseStack(), "By:Lena Raine", posX + -198, posY + -108, -203);
		}
