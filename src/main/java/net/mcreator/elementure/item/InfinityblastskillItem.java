...
import net.mcreator.elementure.procedures.InfinityblastskillConsumeProcedure;
import net.mcreator.elementure.init.ElementureModTabs;
import net.mcreator.elementure.entity.InfinityblastskillEntity;

public class InfinityblastskillItem extends Item {
	public InfinityblastskillItem() {
