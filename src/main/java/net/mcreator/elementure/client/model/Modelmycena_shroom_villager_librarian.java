...
public class Modelmycena_shroom_villager_librarian<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("elementure", "modelmycena_shroom_villager_librarian"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 48).addBox(-1.3F, -12.455F, -1.0F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(45, 60)
						...
						.addBox(-0.05F, -8.455F, -1.01F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 0)
						.addBox(-2.8F, -7.455F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 2)
						.addBox(-1.8F, -8.455F, -2.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 0)
						.addBox(-1.8F, -4.455F, -2.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
						.addBox(1.2F, -7.455F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 4)
						.addBox(-1.8F, -7.455F, -1.51F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.3F, 12.455F, 0.0F));
		PartDefinition LensChainBone = Body.addOrReplaceChild("LensChainBone",
				CubeListBuilder.create().texOffs(58, 7).addBox(-0.22F, -1.0F, -1.5F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
