...
package net.mcreator.elementure.fluid.attributes;
...
public class DungeonwaterFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, DungeonwaterFluidAttributes::new);
	}
	...
	protected DungeonwaterFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
