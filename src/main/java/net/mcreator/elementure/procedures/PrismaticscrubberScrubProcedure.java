...
public class PrismaticscrubberScrubProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == ElementureModBlocks.NETHERSTAR_PRISMATICSPAWNER.get()
				|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == ElementureModBlocks.NETHERSTAR_PRISMATICWALL.get()) {
			...
			world.setBlock(new BlockPos(x, y, z), ElementureModBlocks.PRISMATICCRYSTALBLOCK.get().defaultBlockState(), 3);
				...
				|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.DIRT_PATH
		...
		} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.WARPED_NYLIUM
