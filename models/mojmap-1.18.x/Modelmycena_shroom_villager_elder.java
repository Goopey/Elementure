...
public class Modelmycena_shroom_villager_elder<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_shroom_villager_elder"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArmBone = partdefinition.addOrReplaceChild("LeftArmBone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.75F, -0.25F, -1.0F, 1.0F, 7.0F, 2.0F,
		...
		PartDefinition RightArmBone = partdefinition.addOrReplaceChild("RightArmBone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.25F, -0.25F, -1.0F, 1.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.75F, 12.25F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(54, 52)
						.addBox(-1.8F, -3.455F, -1.0F, 3.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(43, 60)
		...
		PartDefinition rLegBone = partdefinition.addOrReplaceChild("rLegBone", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.25F, 5.0F, -0.99F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition lLegBone = partdefinition.addOrReplaceChild("lLegBone", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-0.75F, 5.0F, -1.01F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, 13.0F, 0.0F));

		PartDefinition HeadBone = partdefinition.addOrReplaceChild("HeadBone",
				CubeListBuilder.create().texOffs(0, 54)
						.addBox(-4.5F, -1.0F, -4.5F, 9.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(16, 39)
