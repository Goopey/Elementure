...
import net.mcreator.elementure.item.model.ArachneelSpearItemModel;
import net.mcreator.elementure.item.ArachneelSpearItem;
import net.mcreator.elementure.interfaces.RendersPlayerArms;
...
public class ArachneelSpearItemRenderer extends GeoItemRenderer<ArachneelSpearItem> implements RendersPlayerArms {
	public ArachneelSpearItemRenderer() {
		super(new ArachneelSpearItemModel());
	}

	@Override
	public RenderType getRenderType(ArachneelSpearItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof ArachneelSpearItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new ArachneelSpearItemRenderer();
	...
	protected ArachneelSpearItem animatable;
	...
	@Override
	public void render(GeoModel model, ArachneelSpearItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(ArachneelSpearItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(ArachneelSpearItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(ArachneelSpearItem animatable) {
