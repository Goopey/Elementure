...
public class Modelmycena_shroom_villager_librarian<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mycena_shroom_villager_librarian"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LensChainBone = Body.addOrReplaceChild("LensChainBone",
				CubeListBuilder.create().texOffs(58, 7).addBox(-0.22F, -1.0F, -1.5F, 0.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rLegBone = partdefinition.addOrReplaceChild("rLegBone", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-0.49F, 0.0F, -0.99F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition lLegBone = partdefinition.addOrReplaceChild("lLegBone", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-0.51F, 0.0F, -0.99F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, 13.0F, 0.0F));
